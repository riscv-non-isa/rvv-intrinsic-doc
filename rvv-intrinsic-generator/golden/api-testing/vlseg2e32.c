...
void test_vlseg2e32_v_f32mf2(vfloat32mf2_t *v0, vfloat32mf2_t *v1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32mf2(v0, v1, base, vl);
}

void test_vlseg2e32_v_f32m1(vfloat32m1_t *v0, vfloat32m1_t *v1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32m1(v0, v1, base, vl);
}

void test_vlseg2e32_v_f32m2(vfloat32m2_t *v0, vfloat32m2_t *v1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32m2(v0, v1, base, vl);
}

void test_vlseg2e32_v_f32m4(vfloat32m4_t *v0, vfloat32m4_t *v1, const float32_t *base, size_t vl) {
...
void test_vlseg2e32_v_f32mf2_m(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vbool64_t mask, vfloat32mf2_t maskedoff0, vfloat32mf2_t maskedoff1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32mf2_m(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}

void test_vlseg2e32_v_f32m1_m(vfloat32m1_t *v0, vfloat32m1_t *v1, vbool32_t mask, vfloat32m1_t maskedoff0, vfloat32m1_t maskedoff1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32m1_m(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}

void test_vlseg2e32_v_f32m2_m(vfloat32m2_t *v0, vfloat32m2_t *v1, vbool16_t mask, vfloat32m2_t maskedoff0, vfloat32m2_t maskedoff1, const float32_t *base, size_t vl) {
  return vlseg2e32_v_f32m2_m(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}

void test_vlseg2e32_v_f32m4_m(vfloat32m4_t *v0, vfloat32m4_t *v1, vbool8_t mask, vfloat32m4_t maskedoff0, vfloat32m4_t maskedoff1, const float32_t *base, size_t vl) {
