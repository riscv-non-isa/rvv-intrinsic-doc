...
vfloat16mf4_t test_vle16_v_f16mf4_m(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_m(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_m(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_m(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_m(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_m(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl) {
  return vle16(mask, maskedoff, base, vl);
}
