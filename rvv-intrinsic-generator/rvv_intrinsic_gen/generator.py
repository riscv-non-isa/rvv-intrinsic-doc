...
class Generator():
  ...
  # the input name should be process by func_name(name)
  @staticmethod
...
class OverloadedDocGenerator(DocGenerator):
  ...
  def func(self, inst_info, name, return_type, **kwargs):
    ...
    if Generator.is_support_overloaded(name, **kwargs):
      name = Generator.get_overloaded_op_name(name)
...
""")
  ...
  def func(self, inst_info, name, return_type, **kwargs):
    ...
    test_file_name = f"{overloaded_func_name.split('_')[0]}.c"
    ...
    func_decl = super().func(inst_info, "test_" + name, return_type, **kwargs)
...
class Grouper(Generator):
  ...
  def func(self, inst_info, name, return_type, **kwargs):
    ...
    overloaded_func_name = Generator.get_overloaded_op_name(name)
    test_file_name = overloaded_func_name.split("_")[0]
