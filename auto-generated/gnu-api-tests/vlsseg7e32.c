...
vfloat32mf2x7_t test_vlsseg7e32_v_f32mf2x7(const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e32_v_f32mf2x7(rs1, rs2, vl);
}

vfloat32m1x7_t test_vlsseg7e32_v_f32m1x7(const float *rs1, ptrdiff_t rs2, size_t vl) {
