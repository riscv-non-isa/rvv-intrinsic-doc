...
vfloat64m1x3_t test_vlsseg3e64_v_f64m1x3(const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e64_v_f64m1x3(rs1, rs2, vl);
}

vfloat64m2x3_t test_vlsseg3e64_v_f64m2x3(const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat64m1x3_t test_vlsseg3e64_v_f64m1x3_m(vbool64_t vm, const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e64_v_f64m1x3_m(vm, rs1, rs2, vl);
}

vfloat64m2x3_t test_vlsseg3e64_v_f64m2x3_m(vbool32_t vm, const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
