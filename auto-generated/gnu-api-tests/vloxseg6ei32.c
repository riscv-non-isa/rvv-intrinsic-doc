...
vfloat16mf4x6_t test_vloxseg6ei32_v_f16mf4x6(const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16mf4x6(base, bindex, vl);
}

vfloat16mf2x6_t test_vloxseg6ei32_v_f16mf2x6(const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16mf2x6(base, bindex, vl);
}

vfloat16m1x6_t test_vloxseg6ei32_v_f16m1x6(const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16m1x6(base, bindex, vl);
}

vfloat32mf2x6_t test_vloxseg6ei32_v_f32mf2x6(const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f32mf2x6(base, bindex, vl);
}

vfloat32m1x6_t test_vloxseg6ei32_v_f32m1x6(const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f32m1x6(base, bindex, vl);
}

vfloat64m1x6_t test_vloxseg6ei32_v_f64m1x6(const float64_t *base, vuint32mf2_t bindex, size_t vl) {
...
vfloat16mf4x6_t test_vloxseg6ei32_v_f16mf4x6_m(vbool64_t mask, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16mf4x6_m(mask, base, bindex, vl);
}

vfloat16mf2x6_t test_vloxseg6ei32_v_f16mf2x6_m(vbool32_t mask, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16mf2x6_m(mask, base, bindex, vl);
}

vfloat16m1x6_t test_vloxseg6ei32_v_f16m1x6_m(vbool16_t mask, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f16m1x6_m(mask, base, bindex, vl);
}

vfloat32mf2x6_t test_vloxseg6ei32_v_f32mf2x6_m(vbool64_t mask, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f32mf2x6_m(mask, base, bindex, vl);
}

vfloat32m1x6_t test_vloxseg6ei32_v_f32m1x6_m(vbool32_t mask, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vloxseg6ei32_v_f32m1x6_m(mask, base, bindex, vl);
}

vfloat64m1x6_t test_vloxseg6ei32_v_f64m1x6_m(vbool64_t mask, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
