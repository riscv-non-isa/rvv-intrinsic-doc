...
void test_vsseg3e64_v_f64m1x3_m(vbool64_t vm, double *rs1, vfloat64m1x3_t vs3, size_t vl) {
  return __riscv_vsseg3e64_v_f64m1x3_m(vm, rs1, vs3, vl);
}

void test_vsseg3e64_v_f64m2x3_m(vbool32_t vm, double *rs1, vfloat64m2x3_t vs3, size_t vl) {
