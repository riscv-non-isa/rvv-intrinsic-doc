...
vfloat64m1x2_t test_vlsseg2e64_v_f64m1x2(const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m1x2(rs1, rs2, vl);
}

vfloat64m2x2_t test_vlsseg2e64_v_f64m2x2(const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m2x2(rs1, rs2, vl);
}

vfloat64m4x2_t test_vlsseg2e64_v_f64m4x2(const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat64m1x2_t test_vlsseg2e64_v_f64m1x2_m(vbool64_t vm, const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m1x2_m(vm, rs1, rs2, vl);
}

vfloat64m2x2_t test_vlsseg2e64_v_f64m2x2_m(vbool32_t vm, const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m2x2_m(vm, rs1, rs2, vl);
}

vfloat64m4x2_t test_vlsseg2e64_v_f64m4x2_m(vbool16_t vm, const float64_t *rs1, ptrdiff_t rs2, size_t vl) {
