...
vuint16mf4_t test_vfclass_v_u16mf4_m(vbool64_t vm, vfloat16mf4_t vs2, size_t vl) {
  return __riscv_vfclass_v_u16mf4_m(vm, vs2, vl);
}

vuint16mf2_t test_vfclass_v_u16mf2_m(vbool32_t vm, vfloat16mf2_t vs2, size_t vl) {
...
vuint32mf2_t test_vfclass_v_u32mf2_m(vbool64_t vm, vfloat32mf2_t vs2, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vfclass\.[ivxfswum.]+\s+} 30 } } */
