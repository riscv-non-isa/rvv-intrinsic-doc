...
void test_vse16_v_f16mf4_m(vbool64_t vm, float16_t *rs1, vfloat16mf4_t vs3, size_t vl) {
  return __riscv_vse16_v_f16mf4_m(vm, rs1, vs3, vl);
}

void test_vse16_v_f16mf2_m(vbool32_t vm, float16_t *rs1, vfloat16mf2_t vs3, size_t vl) {
  return __riscv_vse16_v_f16mf2_m(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m1_m(vbool16_t vm, float16_t *rs1, vfloat16m1_t vs3, size_t vl) {
  return __riscv_vse16_v_f16m1_m(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m2_m(vbool8_t vm, float16_t *rs1, vfloat16m2_t vs3, size_t vl) {
  return __riscv_vse16_v_f16m2_m(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m4_m(vbool4_t vm, float16_t *rs1, vfloat16m4_t vs3, size_t vl) {
  return __riscv_vse16_v_f16m4_m(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m8_m(vbool2_t vm, float16_t *rs1, vfloat16m8_t vs3, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vse16\.[ivxfswum.]+\s+} 36 } } */
