...
vfloat32mf2x6_t test_vlseg6e32ff_v_f32mf2x6(const float *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e32ff_v_f32mf2x6(rs1, new_vl, vl);
}

vfloat32m1x6_t test_vlseg6e32ff_v_f32m1x6(const float *rs1, size_t *new_vl, size_t vl) {
