...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4(const float32_t *rs1, size_t vl) {
  return __riscv_vlseg4e32_v_f32mf2x4(rs1, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4(const float32_t *rs1, size_t vl) {
  return __riscv_vlseg4e32_v_f32m1x4(rs1, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4(const float32_t *rs1, size_t vl) {
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_m(vbool64_t vm, const float32_t *rs1, size_t vl) {
  return __riscv_vlseg4e32_v_f32mf2x4_m(vm, rs1, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_m(vbool32_t vm, const float32_t *rs1, size_t vl) {
  return __riscv_vlseg4e32_v_f32m1x4_m(vm, rs1, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_m(vbool16_t vm, const float32_t *rs1, size_t vl) {
