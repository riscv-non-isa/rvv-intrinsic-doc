...
vfloat64m1x2_t test_vlseg2e64ff_v_f64m1x2(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e64ff_v_f64m1x2(rs1, new_vl, vl);
}

vfloat64m2x2_t test_vlseg2e64ff_v_f64m2x2(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e64ff_v_f64m2x2(rs1, new_vl, vl);
}

vfloat64m4x2_t test_vlseg2e64ff_v_f64m4x2(const double *rs1, size_t *new_vl, size_t vl) {
