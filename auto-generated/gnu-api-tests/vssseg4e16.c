...
void test_vssseg4e16_v_f16mf4x4(float16_t *base, ptrdiff_t bstride, vfloat16mf4x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16mf4x4(base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16mf2x4(float16_t *base, ptrdiff_t bstride, vfloat16mf2x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16mf2x4(base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16m1x4(float16_t *base, ptrdiff_t bstride, vfloat16m1x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16m1x4(base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16m2x4(float16_t *base, ptrdiff_t bstride, vfloat16m2x4_t v_tuple, size_t vl) {
...
void test_vssseg4e16_v_f16mf4x4_m(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16mf4x4_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16mf2x4_m(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16mf2x4_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16m1x4_m(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e16_v_f16m1x4_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg4e16_v_f16m2x4_m(vbool8_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m2x4_t v_tuple, size_t vl) {
