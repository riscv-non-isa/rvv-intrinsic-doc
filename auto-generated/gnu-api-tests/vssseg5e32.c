...
void test_vssseg5e32_v_f32mf2x5(float32_t *rs1, ptrdiff_t rs2, vfloat32mf2x5_t vs3, size_t vl) {
  return __riscv_vssseg5e32_v_f32mf2x5(rs1, rs2, vs3, vl);
}

void test_vssseg5e32_v_f32m1x5(float32_t *rs1, ptrdiff_t rs2, vfloat32m1x5_t vs3, size_t vl) {
...
void test_vssseg5e32_v_f32mf2x5_m(vbool64_t vm, float32_t *rs1, ptrdiff_t rs2, vfloat32mf2x5_t vs3, size_t vl) {
  return __riscv_vssseg5e32_v_f32mf2x5_m(vm, rs1, rs2, vs3, vl);
}

void test_vssseg5e32_v_f32m1x5_m(vbool32_t vm, float32_t *rs1, ptrdiff_t rs2, vfloat32m1x5_t vs3, size_t vl) {
