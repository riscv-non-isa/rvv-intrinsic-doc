...
vfloat16mf4x8_t test_vlseg8e16ff_v_f16mf4x8(const _Float16 *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e16ff_v_f16mf4x8(rs1, new_vl, vl);
}

vfloat16mf2x8_t test_vlseg8e16ff_v_f16mf2x8(const _Float16 *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e16ff_v_f16mf2x8(rs1, new_vl, vl);
}

vfloat16m1x8_t test_vlseg8e16ff_v_f16m1x8(const _Float16 *rs1, size_t *new_vl, size_t vl) {
...
vfloat16mf4x8_t test_vlseg8e16ff_v_f16mf4x8_m(vbool64_t vm, const _Float16 *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e16ff_v_f16mf4x8_m(vm, rs1, new_vl, vl);
}

vfloat16mf2x8_t test_vlseg8e16ff_v_f16mf2x8_m(vbool32_t vm, const _Float16 *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e16ff_v_f16mf2x8_m(vm, rs1, new_vl, vl);
}

vfloat16m1x8_t test_vlseg8e16ff_v_f16m1x8_m(vbool16_t vm, const _Float16 *rs1, size_t *new_vl, size_t vl) {
