...
vint8mf8x6_t test_vlseg6e8ff_v_i8mf8x6(const int8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_i8mf8x6(rs1, new_vl, vl);
}

vint8mf4x6_t test_vlseg6e8ff_v_i8mf4x6(const int8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_i8mf4x6(rs1, new_vl, vl);
}

vint8mf2x6_t test_vlseg6e8ff_v_i8mf2x6(const int8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_i8mf2x6(rs1, new_vl, vl);
}

vint8m1x6_t test_vlseg6e8ff_v_i8m1x6(const int8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_i8m1x6(rs1, new_vl, vl);
}

vuint8mf8x6_t test_vlseg6e8ff_v_u8mf8x6(const uint8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_u8mf8x6(rs1, new_vl, vl);
}

vuint8mf4x6_t test_vlseg6e8ff_v_u8mf4x6(const uint8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_u8mf4x6(rs1, new_vl, vl);
}

vuint8mf2x6_t test_vlseg6e8ff_v_u8mf2x6(const uint8_t *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vlseg6e8ff_v_u8mf2x6(rs1, new_vl, vl);
}

vuint8m1x6_t test_vlseg6e8ff_v_u8m1x6(const uint8_t *rs1, size_t *new_vl, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vlseg6e8ff\.[ivxfswum.]+\s+} 16 } } */
