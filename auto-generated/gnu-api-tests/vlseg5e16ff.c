...
vfloat16mf4x5_t test_vlseg5e16ff_v_f16mf4x5(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg5e16ff_v_f16mf4x5(base, new_vl, vl);
}

vfloat16mf2x5_t test_vlseg5e16ff_v_f16mf2x5(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg5e16ff_v_f16mf2x5(base, new_vl, vl);
}

vfloat16m1x5_t test_vlseg5e16ff_v_f16m1x5(const float16_t *base, size_t *new_vl, size_t vl) {
...
vfloat16mf4x5_t test_vlseg5e16ff_v_f16mf4x5_m(vbool64_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg5e16ff_v_f16mf4x5_m(mask, base, new_vl, vl);
}

vfloat16mf2x5_t test_vlseg5e16ff_v_f16mf2x5_m(vbool32_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg5e16ff_v_f16mf2x5_m(mask, base, new_vl, vl);
}

vfloat16m1x5_t test_vlseg5e16ff_v_f16m1x5_m(vbool16_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
