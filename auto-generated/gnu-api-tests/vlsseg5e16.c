...
vfloat16mf4x5_t test_vlsseg5e16_v_f16mf4x5(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg5e16_v_f16mf4x5(rs1, rs2, vl);
}

vfloat16mf2x5_t test_vlsseg5e16_v_f16mf2x5(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg5e16_v_f16mf2x5(rs1, rs2, vl);
}

vfloat16m1x5_t test_vlsseg5e16_v_f16m1x5(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat16mf4x5_t test_vlsseg5e16_v_f16mf4x5_m(vbool64_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg5e16_v_f16mf4x5_m(vm, rs1, rs2, vl);
}

vfloat16mf2x5_t test_vlsseg5e16_v_f16mf2x5_m(vbool32_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg5e16_v_f16mf2x5_m(vm, rs1, rs2, vl);
}

vfloat16m1x5_t test_vlsseg5e16_v_f16m1x5_m(vbool16_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
