...
vfloat32mf2x7_t test_vlseg7e32_v_f32mf2x7(const float32_t *rs1, size_t vl) {
  return __riscv_vlseg7e32_v_f32mf2x7(rs1, vl);
}

vfloat32m1x7_t test_vlseg7e32_v_f32m1x7(const float32_t *rs1, size_t vl) {
...
vfloat32mf2x7_t test_vlseg7e32_v_f32mf2x7_m(vbool64_t vm, const float32_t *rs1, size_t vl) {
  return __riscv_vlseg7e32_v_f32mf2x7_m(vm, rs1, vl);
}

vfloat32m1x7_t test_vlseg7e32_v_f32m1x7_m(vbool32_t vm, const float32_t *rs1, size_t vl) {
