...
vfloat16mf4x7_t test_vlsseg7e16_v_f16mf4x7(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf4x7(rs1, rs2, vl);
}

vfloat16mf2x7_t test_vlsseg7e16_v_f16mf2x7(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf2x7(rs1, rs2, vl);
}

vfloat16m1x7_t test_vlsseg7e16_v_f16m1x7(const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat16mf4x7_t test_vlsseg7e16_v_f16mf4x7_m(vbool64_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf4x7_m(vm, rs1, rs2, vl);
}

vfloat16mf2x7_t test_vlsseg7e16_v_f16mf2x7_m(vbool32_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf2x7_m(vm, rs1, rs2, vl);
}

vfloat16m1x7_t test_vlsseg7e16_v_f16m1x7_m(vbool16_t vm, const float16_t *rs1, ptrdiff_t rs2, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vlsseg7e16\.[ivxfswum.]+\s+} 18 } } */
