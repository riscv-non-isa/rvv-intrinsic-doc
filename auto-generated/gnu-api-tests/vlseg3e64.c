...
vfloat64m1x3_t test_vlseg3e64_v_f64m1x3_m(vbool64_t vm, const double *rs1, size_t vl) {
  return __riscv_vlseg3e64_v_f64m1x3_m(vm, rs1, vl);
}

vfloat64m2x3_t test_vlseg3e64_v_f64m2x3_m(vbool32_t vm, const double *rs1, size_t vl) {
