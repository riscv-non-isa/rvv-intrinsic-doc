...
vfloat64m1_t test_vle64ff_v_f64m1(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m1(rs1, new_vl, vl);
}

vfloat64m2_t test_vle64ff_v_f64m2(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m2(rs1, new_vl, vl);
}

vfloat64m4_t test_vle64ff_v_f64m4(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m4(rs1, new_vl, vl);
}

vfloat64m8_t test_vle64ff_v_f64m8(const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m8(rs1, new_vl, vl);
}

vfloat64m1_t test_vle64ff_v_f64m1_m(vbool64_t vm, const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m1_m(vm, rs1, new_vl, vl);
}

vfloat64m2_t test_vle64ff_v_f64m2_m(vbool32_t vm, const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m2_m(vm, rs1, new_vl, vl);
}

vfloat64m4_t test_vle64ff_v_f64m4_m(vbool16_t vm, const double *rs1, size_t *new_vl, size_t vl) {
  return __riscv_vle64ff_v_f64m4_m(vm, rs1, new_vl, vl);
}

vfloat64m8_t test_vle64ff_v_f64m8_m(vbool8_t vm, const double *rs1, size_t *new_vl, size_t vl) {
