...
void test_vsse16_v_f16mf4(float16_t *rs1, ptrdiff_t rs2, vfloat16mf4_t vs3,
                          size_t vl) {
  return __riscv_vsse16_v_f16mf4(rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16mf2(float16_t *rs1, ptrdiff_t rs2, vfloat16mf2_t vs3,
                          size_t vl) {
  return __riscv_vsse16_v_f16mf2(rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m1(float16_t *rs1, ptrdiff_t rs2, vfloat16m1_t vs3,
                         size_t vl) {
  return __riscv_vsse16_v_f16m1(rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m2(float16_t *rs1, ptrdiff_t rs2, vfloat16m2_t vs3,
                         size_t vl) {
  return __riscv_vsse16_v_f16m2(rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m4(float16_t *rs1, ptrdiff_t rs2, vfloat16m4_t vs3,
                         size_t vl) {
  return __riscv_vsse16_v_f16m4(rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m8(float16_t *rs1, ptrdiff_t rs2, vfloat16m8_t vs3,
                         size_t vl) {
...
void test_vsse16_v_f16mf4_m(vbool64_t vm, float16_t *rs1, ptrdiff_t rs2,
                            vfloat16mf4_t vs3, size_t vl) {
  return __riscv_vsse16_v_f16mf4_m(vm, rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16mf2_m(vbool32_t vm, float16_t *rs1, ptrdiff_t rs2,
                            vfloat16mf2_t vs3, size_t vl) {
  return __riscv_vsse16_v_f16mf2_m(vm, rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m1_m(vbool16_t vm, float16_t *rs1, ptrdiff_t rs2,
                           vfloat16m1_t vs3, size_t vl) {
  return __riscv_vsse16_v_f16m1_m(vm, rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m2_m(vbool8_t vm, float16_t *rs1, ptrdiff_t rs2,
                           vfloat16m2_t vs3, size_t vl) {
  return __riscv_vsse16_v_f16m2_m(vm, rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m4_m(vbool4_t vm, float16_t *rs1, ptrdiff_t rs2,
                           vfloat16m4_t vs3, size_t vl) {
  return __riscv_vsse16_v_f16m4_m(vm, rs1, rs2, vs3, vl);
}

void test_vsse16_v_f16m8_m(vbool2_t vm, float16_t *rs1, ptrdiff_t rs2,
