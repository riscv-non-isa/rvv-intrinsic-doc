...
void test_vsseg3e32_v_f32mf2x3(float32_t *base, vfloat32mf2x3_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg3e32_v_f32mf2x3(base, v_tuple, vl);
}

void test_vsseg3e32_v_f32m1x3(float32_t *base, vfloat32m1x3_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg3e32_v_f32m1x3(base, v_tuple, vl);
}

void test_vsseg3e32_v_f32m2x3(float32_t *base, vfloat32m2x3_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg3e32_v_f32m2x3(base, v_tuple, vl);
}

void test_vsseg3e32_v_i32mf2x3(int32_t *base, vint32mf2x3_t v_tuple,
                               size_t vl) {
