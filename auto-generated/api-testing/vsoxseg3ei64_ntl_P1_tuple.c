...
void test_vsoxseg3ei64_v_f16mf4x3_ntl_P1(float16_t *base, vuint64m1_t bindex, vfloat16mf4x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16mf4x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16mf2x3_ntl_P1(float16_t *base, vuint64m2_t bindex, vfloat16mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16mf2x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16m1x3_ntl_P1(float16_t *base, vuint64m4_t bindex, vfloat16m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16m1x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16m2x3_ntl_P1(float16_t *base, vuint64m8_t bindex, vfloat16m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16m2x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32mf2x3_ntl_P1(float32_t *base, vuint64m1_t bindex, vfloat32mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32mf2x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32m1x3_ntl_P1(float32_t *base, vuint64m2_t bindex, vfloat32m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32m1x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32m2x3_ntl_P1(float32_t *base, vuint64m4_t bindex, vfloat32m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32m2x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f64m1x3_ntl_P1(float64_t *base, vuint64m1_t bindex, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f64m1x3_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f64m2x3_ntl_P1(float64_t *base, vuint64m2_t bindex, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
...
void test_vsoxseg3ei64_v_f16mf4x3_m_ntl_P1(vbool64_t mask, float16_t *base, vuint64m1_t bindex, vfloat16mf4x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16mf4x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16mf2x3_m_ntl_P1(vbool32_t mask, float16_t *base, vuint64m2_t bindex, vfloat16mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16mf2x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16m1x3_m_ntl_P1(vbool16_t mask, float16_t *base, vuint64m4_t bindex, vfloat16m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16m1x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f16m2x3_m_ntl_P1(vbool8_t mask, float16_t *base, vuint64m8_t bindex, vfloat16m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f16m2x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32mf2x3_m_ntl_P1(vbool64_t mask, float32_t *base, vuint64m1_t bindex, vfloat32mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32mf2x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32m1x3_m_ntl_P1(vbool32_t mask, float32_t *base, vuint64m2_t bindex, vfloat32m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32m1x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f32m2x3_m_ntl_P1(vbool16_t mask, float32_t *base, vuint64m4_t bindex, vfloat32m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f32m2x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f64m1x3_m_ntl_P1(vbool64_t mask, float64_t *base, vuint64m1_t bindex, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg3ei64_v_f64m1x3_m_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsoxseg3ei64_v_f64m2x3_m_ntl_P1(vbool32_t mask, float64_t *base, vuint64m2_t bindex, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
