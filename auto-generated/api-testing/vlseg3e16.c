...
vfloat16m1x3_t test_vlseg3e16_v_f16m1x3_m(vbool16_t mask, const float16_t *base,
                                          size_t vl) {
  return __riscv_vlseg3e16_v_f16m1x3_m(mask, base, vl);
}

vfloat16m2x3_t test_vlseg3e16_v_f16m2x3_m(vbool8_t mask, const float16_t *base,
                                          size_t vl) {
