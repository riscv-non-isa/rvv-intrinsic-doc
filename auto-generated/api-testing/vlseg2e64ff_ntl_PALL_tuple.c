...
vfloat64m1x2_t test_vlseg2e64ff_v_f64m1x2_ntl_PALL(const float64_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg2e64ff_v_f64m1x2_ntl(base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x2_t test_vlseg2e64ff_v_f64m2x2_ntl_PALL(const float64_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg2e64ff_v_f64m2x2_ntl(base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m4x2_t test_vlseg2e64ff_v_f64m4x2_ntl_PALL(const float64_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat64m1x2_t test_vlseg2e64ff_v_f64m1x2_m_ntl_PALL(vbool64_t mask, const float64_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg2e64ff_v_f64m1x2_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x2_t test_vlseg2e64ff_v_f64m2x2_m_ntl_PALL(vbool32_t mask, const float64_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg2e64ff_v_f64m2x2_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m4x2_t test_vlseg2e64ff_v_f64m4x2_m_ntl_PALL(vbool16_t mask, const float64_t *base, size_t *new_vl, size_t vl, int domain) {
