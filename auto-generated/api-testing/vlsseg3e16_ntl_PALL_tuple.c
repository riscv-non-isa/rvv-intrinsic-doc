...
vfloat16mf4x3_t test_vlsseg3e16_v_f16mf4x3_ntl_PALL(const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16mf4x3_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x3_t test_vlsseg3e16_v_f16mf2x3_ntl_PALL(const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16mf2x3_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x3_t test_vlsseg3e16_v_f16m1x3_ntl_PALL(const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16m1x3_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x3_t test_vlsseg3e16_v_f16m2x3_ntl_PALL(const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat16mf4x3_t test_vlsseg3e16_v_f16mf4x3_m_ntl_PALL(vbool64_t mask, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16mf4x3_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x3_t test_vlsseg3e16_v_f16mf2x3_m_ntl_PALL(vbool32_t mask, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16mf2x3_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x3_t test_vlsseg3e16_v_f16m1x3_m_ntl_PALL(vbool16_t mask, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg3e16_v_f16m1x3_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x3_t test_vlsseg3e16_v_f16m2x3_m_ntl_PALL(vbool8_t mask, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
