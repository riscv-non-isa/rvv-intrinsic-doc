...
vfloat32mf2x8_t test_vlsseg8e32_v_f32mf2x8(const float32_t *rs1, ptrdiff_t rs2,
                                           size_t vl) {
  return __riscv_vlsseg8e32_v_f32mf2x8(rs1, rs2, vl);
}

vfloat32m1x8_t test_vlsseg8e32_v_f32m1x8(const float32_t *rs1, ptrdiff_t rs2,
                                         size_t vl) {
...
vfloat32mf2x8_t test_vlsseg8e32_v_f32mf2x8_m(vbool64_t vm, const float32_t *rs1,
                                             ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg8e32_v_f32mf2x8_m(vm, rs1, rs2, vl);
}

vfloat32m1x8_t test_vlsseg8e32_v_f32m1x8_m(vbool32_t vm, const float32_t *rs1,
                                           ptrdiff_t rs2, size_t vl) {
