...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_ntl_PALL(const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_ntl_PALL(const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_m_ntl_PALL(vbool64_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_m_ntl_PALL(vbool32_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
