...
vfloat64m1x5_t test_vlseg5e64_v_f64m1x5_ntl_S1(const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x5_t test_vlseg5e64_v_f64m1x5_m_ntl_S1(vbool64_t mask, const float64_t *base, size_t vl, int domain) {
