...
void test_vsseg4e32_v_f32mf2x4(float32_t *base, vfloat32mf2x4_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg4e32_v_f32mf2x4(base, v_tuple, vl);
}

void test_vsseg4e32_v_f32m1x4(float32_t *base, vfloat32m1x4_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg4e32_v_f32m1x4(base, v_tuple, vl);
}

void test_vsseg4e32_v_f32m2x4(float32_t *base, vfloat32m2x4_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg4e32_v_f32m2x4(base, v_tuple, vl);
}

void test_vsseg4e32_v_i32mf2x4(int32_t *base, vint32mf2x4_t v_tuple,
                               size_t vl) {
