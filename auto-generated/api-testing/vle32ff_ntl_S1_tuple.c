...
vfloat32mf2_t test_vle32ff_v_f32mf2_ntl_S1(const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32mf2_ntl(base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1_t test_vle32ff_v_f32m1_ntl_S1(const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m1_ntl(base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2_t test_vle32ff_v_f32m2_ntl_S1(const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m2_ntl(base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m4_t test_vle32ff_v_f32m4_ntl_S1(const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m4_ntl(base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m8_t test_vle32ff_v_f32m8_ntl_S1(const float32_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_m_ntl_S1(vbool64_t mask, const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32mf2_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1_t test_vle32ff_v_f32m1_m_ntl_S1(vbool32_t mask, const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m1_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2_t test_vle32ff_v_f32m2_m_ntl_S1(vbool16_t mask, const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m2_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m4_t test_vle32ff_v_f32m4_m_ntl_S1(vbool8_t mask, const float32_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle32ff_v_f32m4_m_ntl(mask, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m8_t test_vle32ff_v_f32m8_m_ntl_S1(vbool4_t mask, const float32_t *base, size_t *new_vl, size_t vl, int domain) {
