...
vfloat16mf4x4_t test_vlseg4e16_v_f16mf4x4_ntl_P1(const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16mf4x4_ntl(base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16_v_f16mf2x4_ntl_P1(const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16mf2x4_ntl(base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16_v_f16m1x4_ntl_P1(const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16m1x4_ntl(base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16_v_f16m2x4_ntl_P1(const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4x4_t test_vlseg4e16_v_f16mf4x4_m_ntl_P1(vbool64_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16mf4x4_m_ntl(mask, base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16_v_f16mf2x4_m_ntl_P1(vbool32_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16mf2x4_m_ntl(mask, base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16_v_f16m1x4_m_ntl_P1(vbool16_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e16_v_f16m1x4_m_ntl(mask, base, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16_v_f16m2x4_m_ntl_P1(vbool8_t mask, const float16_t *base, size_t vl, int domain) {
