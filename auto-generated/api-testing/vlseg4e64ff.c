...
vfloat64m1x4_t test_vlseg4e64ff_v_f64m1x4(const float64_t *rs1, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg4e64ff_v_f64m1x4(rs1, new_vl, vl);
}

vfloat64m2x4_t test_vlseg4e64ff_v_f64m2x4(const float64_t *rs1, size_t *new_vl,
                                          size_t vl) {
...
vfloat64m1x4_t test_vlseg4e64ff_v_f64m1x4_m(vbool64_t vm, const float64_t *rs1,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg4e64ff_v_f64m1x4_m(vm, rs1, new_vl, vl);
}

vfloat64m2x4_t test_vlseg4e64ff_v_f64m2x4_m(vbool32_t vm, const float64_t *rs1,
                                            size_t *new_vl, size_t vl) {
