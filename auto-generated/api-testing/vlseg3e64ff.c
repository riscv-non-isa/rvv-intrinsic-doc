...
vfloat64m1x3_t test_vlseg3e64ff_v_f64m1x3(const float64_t *rs1, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e64ff_v_f64m1x3(rs1, new_vl, vl);
}

vfloat64m2x3_t test_vlseg3e64ff_v_f64m2x3(const float64_t *rs1, size_t *new_vl,
                                          size_t vl) {
...
vfloat64m1x3_t test_vlseg3e64ff_v_f64m1x3_m(vbool64_t vm, const float64_t *rs1,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e64ff_v_f64m1x3_m(vm, rs1, new_vl, vl);
}

vfloat64m2x3_t test_vlseg3e64ff_v_f64m2x3_m(vbool32_t vm, const float64_t *rs1,
                                            size_t *new_vl, size_t vl) {
