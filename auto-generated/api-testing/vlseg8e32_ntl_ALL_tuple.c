...
vfloat32mf2x8_t test_vlseg8e32_v_f32mf2x8_ntl_ALL(const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg8e32_v_f32mf2x8_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x8_t test_vlseg8e32_v_f32m1x8_ntl_ALL(const float32_t *base, size_t vl, int domain) {
...
vfloat32mf2x8_t test_vlseg8e32_v_f32mf2x8_m_ntl_ALL(vbool64_t mask, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg8e32_v_f32mf2x8_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x8_t test_vlseg8e32_v_f32m1x8_m_ntl_ALL(vbool32_t mask, const float32_t *base, size_t vl, int domain) {
