...
vfloat32mf2_t test_vfwbdota_vv_bf16m1_f32mf2(vfloat32mf2_t vd,
  ...
  return __riscv_vfwbdota_vv_bf16m1_f32mf2(vd, vs2, vs1, 0, vl);
}
...
vfloat32mf2_t test_vfwbdota_vv_bf16m1_f32mf2_m(vbool64_t vm, vfloat32mf2_t vd,
                                               vbfloat16m8_t vs2,
                                               vbfloat16m1_t vs1, size_t vl) {
  return __riscv_vfwbdota_vv_bf16m1_f32mf2_m(vm, vd, vs2, vs1, 0, vl);
}
...
vfloat32mf2_t test_vfwbdota_vv_bf16m1_f32mf2_rm(vfloat32mf2_t vd,
                                                vbfloat16m8_t vs2,
                                                vbfloat16m1_t vs1, size_t vl) {
  return __riscv_vfwbdota_vv_bf16m1_f32mf2_rm(vd, vs2, vs1, 0, __RISCV_FRM_RNE,
                                              vl);
}
...
vfloat32mf2_t test_vfwbdota_vv_bf16m1_f32mf2_rm_m(vbool64_t vm,
                                                  ...
                                                  vbfloat16m1_t vs1,
                                                  size_t vl) {
  return __riscv_vfwbdota_vv_bf16m1_f32mf2_rm_m(vm, vd, vs2, vs1, 0,
                                                __RISCV_FRM_RNE, vl);
}
