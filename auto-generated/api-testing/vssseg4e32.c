...
void test_vssseg4e32_v_f32mf2x4(float32_t *base, ptrdiff_t bstride,
                                vfloat32mf2x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e32_v_f32mf2x4(base, bstride, v_tuple, vl);
}

void test_vssseg4e32_v_f32m1x4(float32_t *base, ptrdiff_t bstride,
                               vfloat32m1x4_t v_tuple, size_t vl) {
  return __riscv_vssseg4e32_v_f32m1x4(base, bstride, v_tuple, vl);
}

void test_vssseg4e32_v_f32m2x4(float32_t *base, ptrdiff_t bstride,
...
void test_vssseg4e32_v_f32mf2x4_m(vbool64_t mask, float32_t *base,
                                  ptrdiff_t bstride, vfloat32mf2x4_t v_tuple,
                                  size_t vl) {
  return __riscv_vssseg4e32_v_f32mf2x4_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg4e32_v_f32m1x4_m(vbool32_t mask, float32_t *base,
                                 ptrdiff_t bstride, vfloat32m1x4_t v_tuple,
                                 size_t vl) {
  return __riscv_vssseg4e32_v_f32m1x4_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg4e32_v_f32m2x4_m(vbool16_t mask, float32_t *base,
                                 ptrdiff_t bstride, vfloat32m2x4_t v_tuple,
                                 size_t vl) {
