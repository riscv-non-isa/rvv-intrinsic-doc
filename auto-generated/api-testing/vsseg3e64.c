...
void test_vsseg3e64_v_f64m1x3(float64_t *base, vfloat64m1x3_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg3e64_v_f64m1x3(base, v_tuple, vl);
}

void test_vsseg3e64_v_f64m2x3(float64_t *base, vfloat64m2x3_t v_tuple,
                              size_t vl) {
