...
vfloat32mf2x4_t test_vlseg4e32ff_v_f32mf2x4(const float32_t *rs1,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg4e32ff_v_f32mf2x4(rs1, new_vl, vl);
}

vfloat32m1x4_t test_vlseg4e32ff_v_f32m1x4(const float32_t *rs1, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg4e32ff_v_f32m1x4(rs1, new_vl, vl);
}

vfloat32m2x4_t test_vlseg4e32ff_v_f32m2x4(const float32_t *rs1, size_t *new_vl,
                                          size_t vl) {
