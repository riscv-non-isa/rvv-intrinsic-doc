...
vfloat32mf2x7_t test_vlsseg7e32_v_f32mf2x7(const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg7e32_v_f32mf2x7(base, bstride, vl);
}

vfloat32m1x7_t test_vlsseg7e32_v_f32m1x7(const float32_t *base,
                                         ptrdiff_t bstride, size_t vl) {
...
vfloat32mf2x7_t test_vlsseg7e32_v_f32mf2x7_m(vbool64_t mask,
                                             const float32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg7e32_v_f32mf2x7_m(mask, base, bstride, vl);
}

vfloat32m1x7_t test_vlsseg7e32_v_f32m1x7_m(vbool32_t mask,
                                           const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
