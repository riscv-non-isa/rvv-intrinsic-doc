...
vfloat16mf4x2_t test_vlseg2e16ff_v_f16mf4x2(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e16ff_v_f16mf4x2(base, new_vl, vl);
}

vfloat16mf2x2_t test_vlseg2e16ff_v_f16mf2x2(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e16ff_v_f16mf2x2(base, new_vl, vl);
}

vfloat16m1x2_t test_vlseg2e16ff_v_f16m1x2(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e16ff_v_f16m1x2(base, new_vl, vl);
}

vfloat16m2x2_t test_vlseg2e16ff_v_f16m2x2(const float16_t *base, size_t *new_vl, size_t vl) {
  return __riscv_vlseg2e16ff_v_f16m2x2(base, new_vl, vl);
}

vfloat16m4x2_t test_vlseg2e16ff_v_f16m4x2(const float16_t *base, size_t *new_vl, size_t vl) {
