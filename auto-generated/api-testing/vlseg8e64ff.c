...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8(const float64_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg8e64ff_v_f64m1x8(base, new_vl, vl);
}

vint64m1x8_t test_vlseg8e64ff_v_i64m1x8(const int64_t *base, size_t *new_vl,
                                        size_t vl) {
  return __riscv_vlseg8e64ff_v_i64m1x8(base, new_vl, vl);
}

vuint64m1x8_t test_vlseg8e64ff_v_u64m1x8(const uint64_t *base, size_t *new_vl,
                                         size_t vl) {
  return __riscv_vlseg8e64ff_v_u64m1x8(base, new_vl, vl);
}

vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_m(vbool64_t mask,
