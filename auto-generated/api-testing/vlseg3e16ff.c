...
vfloat16mf4x3_t test_vlseg3e16ff_v_f16mf4x3(const float16_t *base,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e16ff_v_f16mf4x3(base, new_vl, vl);
}

vfloat16mf2x3_t test_vlseg3e16ff_v_f16mf2x3(const float16_t *base,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e16ff_v_f16mf2x3(base, new_vl, vl);
}

vfloat16m1x3_t test_vlseg3e16ff_v_f16m1x3(const float16_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e16ff_v_f16m1x3(base, new_vl, vl);
}

vfloat16m2x3_t test_vlseg3e16ff_v_f16m2x3(const float16_t *base, size_t *new_vl,
                                          size_t vl) {
...
vfloat16m2x3_t test_vlseg3e16ff_v_f16m2x3_m(vbool8_t mask,
                                            const float16_t *base,
                                            size_t *new_vl, size_t vl) {
