...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6(const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32mf2x6(base, bstride, vl);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6(const float32_t *base,
                                         ptrdiff_t bstride, size_t vl) {
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_m(vbool64_t mask,
                                             const float32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32mf2x6_m(mask, base, bstride, vl);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_m(vbool32_t mask,
                                           const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
