...
vfloat16mf4x4_t test_vluxseg4ei64_v_f16mf4x4_ntl_S1(const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16mf4x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x4_t test_vluxseg4ei64_v_f16mf2x4_ntl_S1(const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16mf2x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x4_t test_vluxseg4ei64_v_f16m1x4_ntl_S1(const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16m1x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x4_t test_vluxseg4ei64_v_f16m2x4_ntl_S1(const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16m2x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32mf2x4_t test_vluxseg4ei64_v_f32mf2x4_ntl_S1(const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32mf2x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vluxseg4ei64_v_f32m1x4_ntl_S1(const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32m1x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vluxseg4ei64_v_f32m2x4_ntl_S1(const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32m2x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat64m1x4_t test_vluxseg4ei64_v_f64m1x4_ntl_S1(const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f64m1x4_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat64m2x4_t test_vluxseg4ei64_v_f64m2x4_ntl_S1(const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
...
vfloat16mf4x4_t test_vluxseg4ei64_v_f16mf4x4_m_ntl_S1(vbool64_t mask, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16mf4x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x4_t test_vluxseg4ei64_v_f16mf2x4_m_ntl_S1(vbool32_t mask, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16mf2x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x4_t test_vluxseg4ei64_v_f16m1x4_m_ntl_S1(vbool16_t mask, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16m1x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x4_t test_vluxseg4ei64_v_f16m2x4_m_ntl_S1(vbool8_t mask, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f16m2x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32mf2x4_t test_vluxseg4ei64_v_f32mf2x4_m_ntl_S1(vbool64_t mask, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32mf2x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vluxseg4ei64_v_f32m1x4_m_ntl_S1(vbool32_t mask, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32m1x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vluxseg4ei64_v_f32m2x4_m_ntl_S1(vbool16_t mask, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f32m2x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat64m1x4_t test_vluxseg4ei64_v_f64m1x4_m_ntl_S1(vbool64_t mask, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei64_v_f64m1x4_m_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat64m2x4_t test_vluxseg4ei64_v_f64m2x4_m_ntl_S1(vbool32_t mask, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
