...
vfloat64m1x7_t test_vlseg7e64_v_f64m1x7_ntl_ALL(const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x7_t test_vlseg7e64_v_f64m1x7_m_ntl_ALL(vbool64_t mask, const float64_t *base, size_t vl, int domain) {
