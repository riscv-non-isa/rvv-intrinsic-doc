...
vfloat32mf2_t test_vle32_v_f32mf2_ntl_ALL(const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32mf2_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vle32_v_f32m1_ntl_ALL(const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m1_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vle32_v_f32m2_ntl_ALL(const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m2_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vle32_v_f32m4_ntl_ALL(const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m4_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vle32_v_f32m8_ntl_ALL(const float32_t *base, size_t vl, int domain) {
...
vfloat32mf2_t test_vle32_v_f32mf2_m_ntl_ALL(vbool64_t mask, const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32mf2_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vle32_v_f32m1_m_ntl_ALL(vbool32_t mask, const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m1_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vle32_v_f32m2_m_ntl_ALL(vbool16_t mask, const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m2_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vle32_v_f32m4_m_ntl_ALL(vbool8_t mask, const float32_t *base, size_t vl, int domain) {
  return __riscv_vle32_v_f32m4_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vle32_v_f32m8_m_ntl_ALL(vbool4_t mask, const float32_t *base, size_t vl, int domain) {
