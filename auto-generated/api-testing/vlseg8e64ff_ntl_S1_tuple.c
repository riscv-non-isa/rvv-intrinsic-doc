...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_ntl_S1(const float64_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_m_ntl_S1(vbool64_t mask, const float64_t *base, size_t *new_vl, size_t vl, int domain) {
