...
void test_vsse16_v_f16mf4_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16mf4_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16mf2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16mf2_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m1_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m1_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m2_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m4_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m4_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m4_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m8_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m8_t value, size_t vl, int domain) {
...
void test_vsse16_v_f16mf4_m_ntl_P1(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16mf4_m_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16mf2_m_ntl_P1(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16mf2_m_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m1_m_ntl_P1(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m1_m_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m2_m_ntl_P1(vbool8_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m2_m_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m4_m_ntl_P1(vbool4_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m4_t value, size_t vl, int domain) {
  return __riscv_vsse16_v_f16m4_m_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsse16_v_f16m8_m_ntl_P1(vbool2_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m8_t value, size_t vl, int domain) {
