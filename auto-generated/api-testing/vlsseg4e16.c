...
vfloat16mf4x4_t test_vlsseg4e16_v_f16mf4x4(const float16_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e16_v_f16mf4x4(base, bstride, vl);
}

vfloat16mf2x4_t test_vlsseg4e16_v_f16mf2x4(const float16_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e16_v_f16mf2x4(base, bstride, vl);
}

vfloat16m1x4_t test_vlsseg4e16_v_f16m1x4(const float16_t *base,
                                         ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e16_v_f16m1x4(base, bstride, vl);
}

vfloat16m2x4_t test_vlsseg4e16_v_f16m2x4(const float16_t *base,
                                         ptrdiff_t bstride, size_t vl) {
...
vfloat16m1x4_t test_vlsseg4e16_v_f16m1x4_m(vbool16_t mask,
                                           const float16_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e16_v_f16m1x4_m(mask, base, bstride, vl);
}

vfloat16m2x4_t test_vlsseg4e16_v_f16m2x4_m(vbool8_t mask, const float16_t *base,
                                           ptrdiff_t bstride, size_t vl) {
