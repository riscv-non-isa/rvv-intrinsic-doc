...
vfloat64m1x4_t test_vlseg4e64_v_f64m1x4_ntl_PALL(const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e64_v_f64m1x4_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlseg4e64_v_f64m2x4_ntl_PALL(const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x4_t test_vlseg4e64_v_f64m1x4_m_ntl_PALL(vbool64_t mask, const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg4e64_v_f64m1x4_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlseg4e64_v_f64m2x4_m_ntl_PALL(vbool32_t mask, const float64_t *base, size_t vl, int domain) {
