...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_ntl_ALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_ntl_ALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_ntl_ALL(const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_m_ntl_ALL(vbool64_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_m_ntl_ALL(vbool32_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_m_ntl_ALL(vbool16_t mask, const float16_t *base, size_t vl, int domain) {
