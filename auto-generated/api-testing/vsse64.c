...
void test_vsse64_v_f64m1_m(vbool64_t mask, float64_t *base, ptrdiff_t bstride,
                           vfloat64m1_t value, size_t vl) {
  return __riscv_vsse64_v_f64m1_m(mask, base, bstride, value, vl);
}

void test_vsse64_v_f64m2_m(vbool32_t mask, float64_t *base, ptrdiff_t bstride,
                           vfloat64m2_t value, size_t vl) {
  return __riscv_vsse64_v_f64m2_m(mask, base, bstride, value, vl);
}

void test_vsse64_v_f64m4_m(vbool16_t mask, float64_t *base, ptrdiff_t bstride,
                           vfloat64m4_t value, size_t vl) {
  return __riscv_vsse64_v_f64m4_m(mask, base, bstride, value, vl);
}

void test_vsse64_v_f64m8_m(vbool8_t mask, float64_t *base, ptrdiff_t bstride,
