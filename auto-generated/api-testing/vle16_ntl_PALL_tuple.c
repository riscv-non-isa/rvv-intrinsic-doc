...
vfloat16mf4_t test_vle16_v_f16mf4_ntl_PALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2_t test_vle16_v_f16mf2_ntl_PALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1_t test_vle16_v_f16m1_ntl_PALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2_t test_vle16_v_f16m2_ntl_PALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m4_t test_vle16_v_f16m4_ntl_PALL(const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m8_t test_vle16_v_f16m8_ntl_PALL(const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16_v_f16mf4_m_ntl_PALL(vbool64_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2_t test_vle16_v_f16mf2_m_ntl_PALL(vbool32_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1_t test_vle16_v_f16m1_m_ntl_PALL(vbool16_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2_t test_vle16_v_f16m2_m_ntl_PALL(vbool8_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m4_t test_vle16_v_f16m4_m_ntl_PALL(vbool4_t mask, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m8_t test_vle16_v_f16m8_m_ntl_PALL(vbool2_t mask, const float16_t *base, size_t vl, int domain) {
