...
vuint8mf2_t test_vid_v_u8mf2(size_t vl) { return __riscv_vid_v_u8mf2(vl); }

vuint8m1_t test_vid_v_u8m1(size_t vl) { return __riscv_vid_v_u8m1(vl); }

vuint8m2_t test_vid_v_u8m2(size_t vl) { return __riscv_vid_v_u8m2(vl); }

vuint8m4_t test_vid_v_u8m4(size_t vl) { return __riscv_vid_v_u8m4(vl); }

vuint8m8_t test_vid_v_u8m8(size_t vl) { return __riscv_vid_v_u8m8(vl); }

vuint16mf4_t test_vid_v_u16mf4(size_t vl) { return __riscv_vid_v_u16mf4(vl); }

vuint16mf2_t test_vid_v_u16mf2(size_t vl) { return __riscv_vid_v_u16mf2(vl); }

vuint16m1_t test_vid_v_u16m1(size_t vl) { return __riscv_vid_v_u16m1(vl); }

vuint16m2_t test_vid_v_u16m2(size_t vl) { return __riscv_vid_v_u16m2(vl); }

vuint16m4_t test_vid_v_u16m4(size_t vl) { return __riscv_vid_v_u16m4(vl); }

vuint16m8_t test_vid_v_u16m8(size_t vl) { return __riscv_vid_v_u16m8(vl); }

vuint32mf2_t test_vid_v_u32mf2(size_t vl) { return __riscv_vid_v_u32mf2(vl); }

vuint32m1_t test_vid_v_u32m1(size_t vl) { return __riscv_vid_v_u32m1(vl); }

vuint32m2_t test_vid_v_u32m2(size_t vl) { return __riscv_vid_v_u32m2(vl); }

vuint32m4_t test_vid_v_u32m4(size_t vl) { return __riscv_vid_v_u32m4(vl); }

vuint32m8_t test_vid_v_u32m8(size_t vl) { return __riscv_vid_v_u32m8(vl); }

vuint64m1_t test_vid_v_u64m1(size_t vl) { return __riscv_vid_v_u64m1(vl); }

vuint64m2_t test_vid_v_u64m2(size_t vl) { return __riscv_vid_v_u64m2(vl); }

vuint64m4_t test_vid_v_u64m4(size_t vl) { return __riscv_vid_v_u64m4(vl); }

vuint64m8_t test_vid_v_u64m8(size_t vl) { return __riscv_vid_v_u64m8(vl); }
