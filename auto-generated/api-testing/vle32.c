...
vfloat32mf2_t test_vle32_v_f32mf2_m(vbool64_t vm, const float32_t *rs1,
                                    size_t vl) {
  return __riscv_vle32_v_f32mf2_m(vm, rs1, vl);
}

vfloat32m1_t test_vle32_v_f32m1_m(vbool32_t vm, const float32_t *rs1,
                                  size_t vl) {
  return __riscv_vle32_v_f32m1_m(vm, rs1, vl);
}

vfloat32m2_t test_vle32_v_f32m2_m(vbool16_t vm, const float32_t *rs1,
                                  size_t vl) {
  return __riscv_vle32_v_f32m2_m(vm, rs1, vl);
}

vfloat32m4_t test_vle32_v_f32m4_m(vbool8_t vm, const float32_t *rs1,
                                  size_t vl) {
  return __riscv_vle32_v_f32m4_m(vm, rs1, vl);
}

vfloat32m8_t test_vle32_v_f32m8_m(vbool4_t vm, const float32_t *rs1,
                                  size_t vl) {
