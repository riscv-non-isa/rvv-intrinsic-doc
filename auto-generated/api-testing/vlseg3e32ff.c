...
vfloat32mf2x3_t test_vlseg3e32ff_v_f32mf2x3(const float32_t *rs1,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e32ff_v_f32mf2x3(rs1, new_vl, vl);
}

vfloat32m1x3_t test_vlseg3e32ff_v_f32m1x3(const float32_t *rs1, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e32ff_v_f32m1x3(rs1, new_vl, vl);
}

vfloat32m2x3_t test_vlseg3e32ff_v_f32m2x3(const float32_t *rs1, size_t *new_vl,
                                          size_t vl) {
...
vfloat32mf2x3_t test_vlseg3e32ff_v_f32mf2x3_m(vbool64_t vm,
                                              const float32_t *rs1,
                                              size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e32ff_v_f32mf2x3_m(vm, rs1, new_vl, vl);
}

vfloat32m1x3_t test_vlseg3e32ff_v_f32m1x3_m(vbool32_t vm, const float32_t *rs1,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e32ff_v_f32m1x3_m(vm, rs1, new_vl, vl);
}

vfloat32m2x3_t test_vlseg3e32ff_v_f32m2x3_m(vbool16_t vm, const float32_t *rs1,
                                            size_t *new_vl, size_t vl) {
