...
void test_vsseg5e16_v_f16mf4x5_ntl_ALL(float16_t *base, vfloat16mf4x5_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg5e16_v_f16mf4x5_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg5e16_v_f16mf2x5_ntl_ALL(float16_t *base, vfloat16mf2x5_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg5e16_v_f16mf2x5_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg5e16_v_f16m1x5_ntl_ALL(float16_t *base, vfloat16m1x5_t v_tuple, size_t vl, int domain) {
...
void test_vsseg5e16_v_f16mf4x5_m_ntl_ALL(vbool64_t mask, float16_t *base, vfloat16mf4x5_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg5e16_v_f16mf4x5_m_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg5e16_v_f16mf2x5_m_ntl_ALL(vbool32_t mask, float16_t *base, vfloat16mf2x5_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg5e16_v_f16mf2x5_m_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg5e16_v_f16m1x5_m_ntl_ALL(vbool16_t mask, float16_t *base, vfloat16m1x5_t v_tuple, size_t vl, int domain) {
