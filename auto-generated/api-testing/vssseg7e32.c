...
void test_vssseg7e32_v_f32mf2x7(float32_t *base, ptrdiff_t bstride,
                                vfloat32mf2x7_t v_tuple, size_t vl) {
  return __riscv_vssseg7e32_v_f32mf2x7(base, bstride, v_tuple, vl);
}

void test_vssseg7e32_v_f32m1x7(float32_t *base, ptrdiff_t bstride,
...
void test_vssseg7e32_v_f32mf2x7_m(vbool64_t mask, float32_t *base,
                                  ptrdiff_t bstride, vfloat32mf2x7_t v_tuple,
                                  size_t vl) {
  return __riscv_vssseg7e32_v_f32mf2x7_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg7e32_v_f32m1x7_m(vbool32_t mask, float32_t *base,
                                 ptrdiff_t bstride, vfloat32m1x7_t v_tuple,
                                 size_t vl) {
