...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3(const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg3e32_v_f32mf2x3(base, bstride, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3(const float32_t *base,
                                         ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg3e32_v_f32m1x3(base, bstride, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3(const float32_t *base,
                                         ptrdiff_t bstride, size_t vl) {
...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3_m(vbool64_t mask,
                                             const float32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg3e32_v_f32mf2x3_m(mask, base, bstride, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3_m(vbool32_t mask,
                                           const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg3e32_v_f32m1x3_m(mask, base, bstride, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3_m(vbool16_t mask,
                                           const float32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
