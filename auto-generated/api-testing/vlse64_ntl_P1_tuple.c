...
vfloat64m1_t test_vlse64_v_f64m1_ntl_P1(const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m1_ntl(base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vlse64_v_f64m2_ntl_P1(const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m2_ntl(base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vlse64_v_f64m4_ntl_P1(const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m4_ntl(base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vlse64_v_f64m8_ntl_P1(const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat64m1_t test_vlse64_v_f64m1_m_ntl_P1(vbool64_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m1_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vlse64_v_f64m2_m_ntl_P1(vbool32_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m2_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vlse64_v_f64m4_m_ntl_P1(vbool16_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse64_v_f64m4_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vlse64_v_f64m8_m_ntl_P1(vbool8_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
