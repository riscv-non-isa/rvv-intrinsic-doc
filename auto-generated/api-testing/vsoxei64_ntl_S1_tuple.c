...
void test_vsoxei64_v_f16mf4_ntl_S1(float16_t *base, vuint64m1_t bindex, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16mf4_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16mf2_ntl_S1(float16_t *base, vuint64m2_t bindex, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16mf2_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16m1_ntl_S1(float16_t *base, vuint64m4_t bindex, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16m1_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16m2_ntl_S1(float16_t *base, vuint64m8_t bindex, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16m2_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32mf2_ntl_S1(float32_t *base, vuint64m1_t bindex, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32mf2_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m1_ntl_S1(float32_t *base, vuint64m2_t bindex, vfloat32m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m1_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m2_ntl_S1(float32_t *base, vuint64m4_t bindex, vfloat32m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m2_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m4_ntl_S1(float32_t *base, vuint64m8_t bindex, vfloat32m4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m4_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m1_ntl_S1(float64_t *base, vuint64m1_t bindex, vfloat64m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m1_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m2_ntl_S1(float64_t *base, vuint64m2_t bindex, vfloat64m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m2_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m4_ntl_S1(float64_t *base, vuint64m4_t bindex, vfloat64m4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m4_ntl(base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m8_ntl_S1(float64_t *base, vuint64m8_t bindex, vfloat64m8_t value, size_t vl, int domain) {
...
void test_vsoxei64_v_f16mf4_m_ntl_S1(vbool64_t mask, float16_t *base, vuint64m1_t bindex, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16mf4_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16mf2_m_ntl_S1(vbool32_t mask, float16_t *base, vuint64m2_t bindex, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16mf2_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16m1_m_ntl_S1(vbool16_t mask, float16_t *base, vuint64m4_t bindex, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16m1_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f16m2_m_ntl_S1(vbool8_t mask, float16_t *base, vuint64m8_t bindex, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f16m2_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32mf2_m_ntl_S1(vbool64_t mask, float32_t *base, vuint64m1_t bindex, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32mf2_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m1_m_ntl_S1(vbool32_t mask, float32_t *base, vuint64m2_t bindex, vfloat32m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m1_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m2_m_ntl_S1(vbool16_t mask, float32_t *base, vuint64m4_t bindex, vfloat32m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m2_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f32m4_m_ntl_S1(vbool8_t mask, float32_t *base, vuint64m8_t bindex, vfloat32m4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f32m4_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m1_m_ntl_S1(vbool64_t mask, float64_t *base, vuint64m1_t bindex, vfloat64m1_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m1_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m2_m_ntl_S1(vbool32_t mask, float64_t *base, vuint64m2_t bindex, vfloat64m2_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m2_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m4_m_ntl_S1(vbool16_t mask, float64_t *base, vuint64m4_t bindex, vfloat64m4_t value, size_t vl, int domain) {
  return __riscv_vsoxei64_v_f64m4_m_ntl(mask, base, bindex, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsoxei64_v_f64m8_m_ntl_S1(vbool8_t mask, float64_t *base, vuint64m8_t bindex, vfloat64m8_t value, size_t vl, int domain) {
