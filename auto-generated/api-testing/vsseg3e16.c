...
void test_vsseg3e16_v_f16mf4x3_m(vbool64_t vm, float16_t *rs1,
                                 vfloat16mf4x3_t vs3, size_t vl) {
  return __riscv_vsseg3e16_v_f16mf4x3_m(vm, rs1, vs3, vl);
}

void test_vsseg3e16_v_f16mf2x3_m(vbool32_t vm, float16_t *rs1,
                                 vfloat16mf2x3_t vs3, size_t vl) {
  return __riscv_vsseg3e16_v_f16mf2x3_m(vm, rs1, vs3, vl);
}

void test_vsseg3e16_v_f16m1x3_m(vbool16_t vm, float16_t *rs1,
                                vfloat16m1x3_t vs3, size_t vl) {
  return __riscv_vsseg3e16_v_f16m1x3_m(vm, rs1, vs3, vl);
}

void test_vsseg3e16_v_f16m2x3_m(vbool8_t vm, float16_t *rs1, vfloat16m2x3_t vs3,
                                size_t vl) {
