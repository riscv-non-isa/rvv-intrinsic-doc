...
vfloat32mf2_t test_vle32ff_v_f32mf2(const float32_t *base, size_t *new_vl,
                                    size_t vl) {
  return __riscv_vle32ff_v_f32mf2(base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1(const float32_t *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle32ff_v_f32m1(base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2(const float32_t *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle32ff_v_f32m2(base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4(const float32_t *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle32ff_v_f32m4(base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8(const float32_t *base, size_t *new_vl,
                                  size_t vl) {
