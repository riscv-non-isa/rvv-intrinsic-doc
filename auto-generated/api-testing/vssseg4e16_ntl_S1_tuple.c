...
void test_vssseg4e16_v_f16mf4x4_ntl_S1(float16_t *base, ptrdiff_t bstride, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16mf4x4_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16mf2x4_ntl_S1(float16_t *base, ptrdiff_t bstride, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16mf2x4_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16m1x4_ntl_S1(float16_t *base, ptrdiff_t bstride, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16m1x4_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16m2x4_ntl_S1(float16_t *base, ptrdiff_t bstride, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
...
void test_vssseg4e16_v_f16mf4x4_m_ntl_S1(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16mf4x4_m_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16mf2x4_m_ntl_S1(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16mf2x4_m_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16m1x4_m_ntl_S1(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e16_v_f16m1x4_m_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg4e16_v_f16m2x4_m_ntl_S1(vbool8_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
