...
vfloat64m1_t test_vfwmacc_vf_f64m1(vfloat64m1_t vd, float32_t vs1,
                                   vfloat32mf2_t vs2, size_t vl) {
...
vfloat64m2_t test_vfwmacc_vf_f64m2(vfloat64m2_t vd, float32_t vs1,
                                   vfloat32m1_t vs2, size_t vl) {
...
vfloat64m4_t test_vfwmacc_vf_f64m4(vfloat64m4_t vd, float32_t vs1,
                                   vfloat32m2_t vs2, size_t vl) {
...
vfloat64m1_t test_vfwmacc_vf_f64m1_rm(vfloat64m1_t vd, float32_t vs1,
                                      vfloat32mf2_t vs2, size_t vl) {
...
vfloat64m2_t test_vfwmacc_vf_f64m2_rm(vfloat64m2_t vd, float32_t vs1,
                                      vfloat32m1_t vs2, size_t vl) {
...
vfloat64m4_t test_vfwmacc_vf_f64m4_rm(vfloat64m4_t vd, float32_t vs1,
                                      vfloat32m2_t vs2, size_t vl) {
...
vfloat64m8_t test_vfwmacc_vf_f64m8_rm(vfloat64m8_t vd, float32_t vs1,
                                      vfloat32m4_t vs2, size_t vl) {
  return __riscv_vfwmacc_vf_f64m8_rm(vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32mf2_t test_vfwmacc_vv_f32mf2_rm_m(vbool64_t mask, vfloat32mf2_t vd,
                                          vfloat16mf4_t vs1, vfloat16mf4_t vs2,
                                          size_t vl) {
  return __riscv_vfwmacc_vv_f32mf2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE,
                                        vl);
}

vfloat32mf2_t test_vfwmacc_vf_f32mf2_rm_m(vbool64_t mask, vfloat32mf2_t vd,
                                          float16_t vs1, vfloat16mf4_t vs2,
                                          size_t vl) {
  return __riscv_vfwmacc_vf_f32mf2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE,
                                        vl);
}

vfloat32m1_t test_vfwmacc_vv_f32m1_rm_m(vbool32_t mask, vfloat32m1_t vd,
                                        vfloat16mf2_t vs1, vfloat16mf2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f32m1_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m1_t test_vfwmacc_vf_f32m1_rm_m(vbool32_t mask, vfloat32m1_t vd,
                                        float16_t vs1, vfloat16mf2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f32m1_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfwmacc_vv_f32m2_rm_m(vbool16_t mask, vfloat32m2_t vd,
                                        vfloat16m1_t vs1, vfloat16m1_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f32m2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfwmacc_vf_f32m2_rm_m(vbool16_t mask, vfloat32m2_t vd,
                                        float16_t vs1, vfloat16m1_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f32m2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfwmacc_vv_f32m4_rm_m(vbool8_t mask, vfloat32m4_t vd,
                                        vfloat16m2_t vs1, vfloat16m2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f32m4_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfwmacc_vf_f32m4_rm_m(vbool8_t mask, vfloat32m4_t vd,
                                        float16_t vs1, vfloat16m2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f32m4_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfwmacc_vv_f32m8_rm_m(vbool4_t mask, vfloat32m8_t vd,
                                        vfloat16m4_t vs1, vfloat16m4_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f32m8_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfwmacc_vf_f32m8_rm_m(vbool4_t mask, vfloat32m8_t vd,
                                        float16_t vs1, vfloat16m4_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f32m8_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m1_t test_vfwmacc_vv_f64m1_rm_m(vbool64_t mask, vfloat64m1_t vd,
                                        vfloat32mf2_t vs1, vfloat32mf2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f64m1_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m1_t test_vfwmacc_vf_f64m1_rm_m(vbool64_t mask, vfloat64m1_t vd,
                                        float32_t vs1, vfloat32mf2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f64m1_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m2_t test_vfwmacc_vv_f64m2_rm_m(vbool32_t mask, vfloat64m2_t vd,
                                        vfloat32m1_t vs1, vfloat32m1_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f64m2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m2_t test_vfwmacc_vf_f64m2_rm_m(vbool32_t mask, vfloat64m2_t vd,
                                        float32_t vs1, vfloat32m1_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f64m2_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m4_t test_vfwmacc_vv_f64m4_rm_m(vbool16_t mask, vfloat64m4_t vd,
                                        vfloat32m2_t vs1, vfloat32m2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f64m4_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m4_t test_vfwmacc_vf_f64m4_rm_m(vbool16_t mask, vfloat64m4_t vd,
                                        float32_t vs1, vfloat32m2_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vf_f64m4_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m8_t test_vfwmacc_vv_f64m8_rm_m(vbool8_t mask, vfloat64m8_t vd,
                                        vfloat32m4_t vs1, vfloat32m4_t vs2,
                                        size_t vl) {
  return __riscv_vfwmacc_vv_f64m8_rm_m(mask, vd, vs1, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m8_t test_vfwmacc_vf_f64m8_rm_m(vbool8_t mask, vfloat64m8_t vd,
                                        float32_t vs1, vfloat32m4_t vs2,
                                        size_t vl) {
