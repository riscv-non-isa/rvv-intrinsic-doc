...
void test_vsse32_v_f32mf2(float32_t *base, ptrdiff_t bstride,
...
void test_vsse32_v_f32mf2_m(vbool64_t mask, float32_t *base, ptrdiff_t bstride,
                            vfloat32mf2_t value, size_t vl) {
  return __riscv_vsse32_v_f32mf2_m(mask, base, bstride, value, vl);
}

void test_vsse32_v_f32m1_m(vbool32_t mask, float32_t *base, ptrdiff_t bstride,
                           vfloat32m1_t value, size_t vl) {
  return __riscv_vsse32_v_f32m1_m(mask, base, bstride, value, vl);
}

void test_vsse32_v_f32m2_m(vbool16_t mask, float32_t *base, ptrdiff_t bstride,
                           vfloat32m2_t value, size_t vl) {
  return __riscv_vsse32_v_f32m2_m(mask, base, bstride, value, vl);
}

void test_vsse32_v_f32m4_m(vbool8_t mask, float32_t *base, ptrdiff_t bstride,
                           vfloat32m4_t value, size_t vl) {
  return __riscv_vsse32_v_f32m4_m(mask, base, bstride, value, vl);
}

void test_vsse32_v_f32m8_m(vbool4_t mask, float32_t *base, ptrdiff_t bstride,
