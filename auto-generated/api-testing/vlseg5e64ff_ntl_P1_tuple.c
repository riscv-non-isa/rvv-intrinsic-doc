...
vfloat64m1x5_t test_vlseg5e64ff_v_f64m1x5_ntl_P1(const float64_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat64m1x5_t test_vlseg5e64ff_v_f64m1x5_m_ntl_P1(vbool64_t mask, const float64_t *base, size_t *new_vl, size_t vl, int domain) {
