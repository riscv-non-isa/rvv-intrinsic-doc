...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_tu(vfloat16mf4x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf4x6_tu(vd, rs1, rs2, vl);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_tu(vfloat16mf2x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf2x6_tu(vd, rs1, rs2, vl);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_tu(vfloat16m1x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_tum(vbool64_t vm, vfloat16mf4x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf4x6_tum(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_tum(vbool32_t vm, vfloat16mf2x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf2x6_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_tum(vbool16_t vm, vfloat16m1x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_tumu(vbool64_t vm, vfloat16mf4x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf4x6_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_tumu(vbool32_t vm, vfloat16mf2x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf2x6_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_tumu(vbool16_t vm, vfloat16m1x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_mu(vbool64_t vm, vfloat16mf4x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf4x6_mu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_mu(vbool32_t vm, vfloat16mf2x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg6e16_v_f16mf2x6_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_mu(vbool16_t vm, vfloat16m1x6_t vd, const _Float16 *rs1, ptrdiff_t rs2, size_t vl) {
