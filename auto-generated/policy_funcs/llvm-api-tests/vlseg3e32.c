...
void test_vlseg3e32_v_f32mf2_ta(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vfloat32mf2_t *v2, const float *base, size_t vl) {
  return vlseg3e32_v_f32mf2_ta(v0, v1, v2, base, vl);
}

void test_vlseg3e32_v_f32m1_ta(vfloat32m1_t *v0, vfloat32m1_t *v1, vfloat32m1_t *v2, const float *base, size_t vl) {
  return vlseg3e32_v_f32m1_ta(v0, v1, v2, base, vl);
}

void test_vlseg3e32_v_f32m2_ta(vfloat32m2_t *v0, vfloat32m2_t *v1, vfloat32m2_t *v2, const float *base, size_t vl) {
...
void test_vlseg3e32_v_f32mf2_tama(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vfloat32mf2_t *v2, vbool64_t mask, const float *base, size_t vl) {
  return vlseg3e32_v_f32mf2_tama(v0, v1, v2, mask, base, vl);
}

void test_vlseg3e32_v_f32m1_tama(vfloat32m1_t *v0, vfloat32m1_t *v1, vfloat32m1_t *v2, vbool32_t mask, const float *base, size_t vl) {
  return vlseg3e32_v_f32m1_tama(v0, v1, v2, mask, base, vl);
}

void test_vlseg3e32_v_f32m2_tama(vfloat32m2_t *v0, vfloat32m2_t *v1, vfloat32m2_t *v2, vbool16_t mask, const float *base, size_t vl) {
