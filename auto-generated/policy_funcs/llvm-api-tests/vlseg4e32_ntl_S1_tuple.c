...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tu_ntl_S1(vfloat32mf2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32mf2x4_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tu_ntl_S1(vfloat32m1x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32m1x4_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tu_ntl_S1(vfloat32m2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tum_ntl_S1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32mf2x4_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tum_ntl_S1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32m1x4_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tum_ntl_S1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tumu_ntl_S1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32mf2x4_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tumu_ntl_S1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32m1x4_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tumu_ntl_S1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_mu_ntl_S1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32mf2x4_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_mu_ntl_S1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
  return __riscv_vlseg4e32_v_f32m1x4_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_mu_ntl_S1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float *base, size_t vl, int domain) {
