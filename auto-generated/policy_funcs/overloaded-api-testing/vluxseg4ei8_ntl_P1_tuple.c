...
vfloat16mf4x4_t test_vluxseg4ei8_v_f16mf4x4_tu_ntl_P1(vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vluxseg4ei8_v_f16mf2x4_tu_ntl_P1(vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vluxseg4ei8_v_f16m1x4_tu_ntl_P1(vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vluxseg4ei8_v_f16m2x4_tu_ntl_P1(vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint8m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x4_t test_vluxseg4ei8_v_f32mf2x4_tu_ntl_P1(vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x4_t test_vluxseg4ei8_v_f32m1x4_tu_ntl_P1(vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x4_t test_vluxseg4ei8_v_f32m2x4_tu_ntl_P1(vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x4_t test_vluxseg4ei8_v_f64m1x4_tu_ntl_P1(vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x4_t test_vluxseg4ei8_v_f64m2x4_tu_ntl_P1(vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4x4_t test_vluxseg4ei8_v_f16mf4x4_tum_ntl_P1(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vluxseg4ei8_v_f16mf2x4_tum_ntl_P1(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vluxseg4ei8_v_f16m1x4_tum_ntl_P1(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vluxseg4ei8_v_f16m2x4_tum_ntl_P1(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint8m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x4_t test_vluxseg4ei8_v_f32mf2x4_tum_ntl_P1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x4_t test_vluxseg4ei8_v_f32m1x4_tum_ntl_P1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x4_t test_vluxseg4ei8_v_f32m2x4_tum_ntl_P1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x4_t test_vluxseg4ei8_v_f64m1x4_tum_ntl_P1(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x4_t test_vluxseg4ei8_v_f64m2x4_tum_ntl_P1(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4x4_t test_vluxseg4ei8_v_f16mf4x4_tumu_ntl_P1(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vluxseg4ei8_v_f16mf2x4_tumu_ntl_P1(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vluxseg4ei8_v_f16m1x4_tumu_ntl_P1(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vluxseg4ei8_v_f16m2x4_tumu_ntl_P1(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint8m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x4_t test_vluxseg4ei8_v_f32mf2x4_tumu_ntl_P1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x4_t test_vluxseg4ei8_v_f32m1x4_tumu_ntl_P1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x4_t test_vluxseg4ei8_v_f32m2x4_tumu_ntl_P1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x4_t test_vluxseg4ei8_v_f64m1x4_tumu_ntl_P1(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x4_t test_vluxseg4ei8_v_f64m2x4_tumu_ntl_P1(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4x4_t test_vluxseg4ei8_v_f16mf4x4_mu_ntl_P1(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x4_t test_vluxseg4ei8_v_f16mf2x4_mu_ntl_P1(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x4_t test_vluxseg4ei8_v_f16m1x4_mu_ntl_P1(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x4_t test_vluxseg4ei8_v_f16m2x4_mu_ntl_P1(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint8m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x4_t test_vluxseg4ei8_v_f32mf2x4_mu_ntl_P1(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x4_t test_vluxseg4ei8_v_f32m1x4_mu_ntl_P1(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x4_t test_vluxseg4ei8_v_f32m2x4_mu_ntl_P1(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint8mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x4_t test_vluxseg4ei8_v_f64m1x4_mu_ntl_P1(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint8mf8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x4_t test_vluxseg4ei8_v_f64m2x4_mu_ntl_P1(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint8mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei8_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
