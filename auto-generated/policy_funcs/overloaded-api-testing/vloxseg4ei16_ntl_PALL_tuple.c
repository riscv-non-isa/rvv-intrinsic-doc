...
vfloat16mf4x4_t test_vloxseg4ei16_v_f16mf4x4_tu_ntl_PALL(vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vloxseg4ei16_v_f16mf2x4_tu_ntl_PALL(vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4_tu_ntl_PALL(vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4_tu_ntl_PALL(vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4_tu_ntl_PALL(vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4_tu_ntl_PALL(vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4_tu_ntl_PALL(vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4_tu_ntl_PALL(vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4_tu_ntl_PALL(vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
vfloat16mf4x4_t test_vloxseg4ei16_v_f16mf4x4_tum_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vloxseg4ei16_v_f16mf2x4_tum_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4_tum_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4_tum_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4_tum_ntl_PALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4_tum_ntl_PALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4_tum_ntl_PALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4_tum_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4_tum_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
vfloat16mf4x4_t test_vloxseg4ei16_v_f16mf4x4_tumu_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vloxseg4ei16_v_f16mf2x4_tumu_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4_tumu_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4_tumu_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4_tumu_ntl_PALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4_tumu_ntl_PALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4_tumu_ntl_PALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4_tumu_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4_tumu_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
vfloat16mf4x4_t test_vloxseg4ei16_v_f16mf4x4_mu_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vloxseg4ei16_v_f16mf2x4_mu_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4_mu_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4_mu_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4_mu_ntl_PALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4_mu_ntl_PALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4_mu_ntl_PALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4_mu_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4_mu_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg4ei16_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
