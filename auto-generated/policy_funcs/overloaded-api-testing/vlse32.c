...
vfloat32mf2_t test_vlse32_v_f32mf2_tu(vfloat32mf2_t vd, const float32_t *rs1,
                                      ptrdiff_t rs2, size_t vl) {
  return __riscv_vlse32_tu(vd, rs1, rs2, vl);
}

vfloat32m1_t test_vlse32_v_f32m1_tu(vfloat32m1_t vd, const float32_t *rs1,
                                    ptrdiff_t rs2, size_t vl) {
  return __riscv_vlse32_tu(vd, rs1, rs2, vl);
}

vfloat32m2_t test_vlse32_v_f32m2_tu(vfloat32m2_t vd, const float32_t *rs1,
                                    ptrdiff_t rs2, size_t vl) {
  return __riscv_vlse32_tu(vd, rs1, rs2, vl);
}

vfloat32m4_t test_vlse32_v_f32m4_tu(vfloat32m4_t vd, const float32_t *rs1,
                                    ptrdiff_t rs2, size_t vl) {
  return __riscv_vlse32_tu(vd, rs1, rs2, vl);
}

vfloat32m8_t test_vlse32_v_f32m8_tu(vfloat32m8_t vd, const float32_t *rs1,
                                    ptrdiff_t rs2, size_t vl) {
  return __riscv_vlse32_tu(vd, rs1, rs2, vl);
}
