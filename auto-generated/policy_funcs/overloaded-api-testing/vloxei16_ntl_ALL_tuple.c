...
vfloat16mf4_t test_vloxei16_v_f16mf4_tu_ntl_ALL(vfloat16mf4_t maskedoff, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vloxei16_v_f16mf2_tu_ntl_ALL(vfloat16mf2_t maskedoff, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vloxei16_v_f16m1_tu_ntl_ALL(vfloat16m1_t maskedoff, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vloxei16_v_f16m2_tu_ntl_ALL(vfloat16m2_t maskedoff, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vloxei16_v_f16m4_tu_ntl_ALL(vfloat16m4_t maskedoff, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vloxei16_v_f16m8_tu_ntl_ALL(vfloat16m8_t maskedoff, const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2_t test_vloxei16_v_f32mf2_tu_ntl_ALL(vfloat32mf2_t maskedoff, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vloxei16_v_f32m1_tu_ntl_ALL(vfloat32m1_t maskedoff, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vloxei16_v_f32m2_tu_ntl_ALL(vfloat32m2_t maskedoff, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vloxei16_v_f32m4_tu_ntl_ALL(vfloat32m4_t maskedoff, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vloxei16_v_f32m8_tu_ntl_ALL(vfloat32m8_t maskedoff, const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1_t test_vloxei16_v_f64m1_tu_ntl_ALL(vfloat64m1_t maskedoff, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2_t test_vloxei16_v_f64m2_tu_ntl_ALL(vfloat64m2_t maskedoff, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4_t test_vloxei16_v_f64m4_tu_ntl_ALL(vfloat64m4_t maskedoff, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m8_t test_vloxei16_v_f64m8_tu_ntl_ALL(vfloat64m8_t maskedoff, const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4_t test_vloxei16_v_f16mf4_tum_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vloxei16_v_f16mf2_tum_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vloxei16_v_f16m1_tum_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vloxei16_v_f16m2_tum_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vloxei16_v_f16m4_tum_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vloxei16_v_f16m8_tum_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2_t test_vloxei16_v_f32mf2_tum_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vloxei16_v_f32m1_tum_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vloxei16_v_f32m2_tum_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vloxei16_v_f32m4_tum_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vloxei16_v_f32m8_tum_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1_t test_vloxei16_v_f64m1_tum_ntl_ALL(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2_t test_vloxei16_v_f64m2_tum_ntl_ALL(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4_t test_vloxei16_v_f64m4_tum_ntl_ALL(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m8_t test_vloxei16_v_f64m8_tum_ntl_ALL(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4_t test_vloxei16_v_f16mf4_tumu_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vloxei16_v_f16mf2_tumu_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vloxei16_v_f16m1_tumu_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vloxei16_v_f16m2_tumu_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vloxei16_v_f16m4_tumu_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vloxei16_v_f16m8_tumu_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2_t test_vloxei16_v_f32mf2_tumu_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vloxei16_v_f32m1_tumu_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vloxei16_v_f32m2_tumu_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vloxei16_v_f32m4_tumu_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vloxei16_v_f32m8_tumu_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1_t test_vloxei16_v_f64m1_tumu_ntl_ALL(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2_t test_vloxei16_v_f64m2_tumu_ntl_ALL(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4_t test_vloxei16_v_f64m4_tumu_ntl_ALL(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m8_t test_vloxei16_v_f64m8_tumu_ntl_ALL(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4_t test_vloxei16_v_f16mf4_mu_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vloxei16_v_f16mf2_mu_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vloxei16_v_f16m1_mu_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vloxei16_v_f16m2_mu_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vloxei16_v_f16m4_mu_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vloxei16_v_f16m8_mu_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2_t test_vloxei16_v_f32mf2_mu_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vloxei16_v_f32m1_mu_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vloxei16_v_f32m2_mu_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vloxei16_v_f32m4_mu_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vloxei16_v_f32m8_mu_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1_t test_vloxei16_v_f64m1_mu_ntl_ALL(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2_t test_vloxei16_v_f64m2_mu_ntl_ALL(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4_t test_vloxei16_v_f64m4_mu_ntl_ALL(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m8_t test_vloxei16_v_f64m8_mu_ntl_ALL(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei16_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_ALL);
}
