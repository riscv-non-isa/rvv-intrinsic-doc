...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tu(vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tu(maskedoff_tuple, base, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tu(vfloat32m1x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tu(maskedoff_tuple, base, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tu(vfloat32m2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tu(maskedoff_tuple, base, vl);
}
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tum(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tum(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tum(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tum(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tum(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tum(mask, maskedoff_tuple, base, vl);
}
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_tumu(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_tumu(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_tumu(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_tumu(mask, maskedoff_tuple, base, vl);
}
...
vfloat32mf2x4_t test_vlseg4e32_v_f32mf2x4_mu(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_mu(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x4_t test_vlseg4e32_v_f32m1x4_mu(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_mu(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x4_t test_vlseg4e32_v_f32m2x4_mu(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg4e32_mu(mask, maskedoff_tuple, base, vl);
}
