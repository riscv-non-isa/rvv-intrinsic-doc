...
vfloat16mf4_t test_vle16ff_v_f16mf4_tu(vfloat16mf4_t vd, const float16_t *rs1,
                                       size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_tu(vfloat16mf2_t vd, const float16_t *rs1,
                                       size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}

vfloat16m1_t test_vle16ff_v_f16m1_tu(vfloat16m1_t vd, const float16_t *rs1,
                                     size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}

vfloat16m2_t test_vle16ff_v_f16m2_tu(vfloat16m2_t vd, const float16_t *rs1,
                                     size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}

vfloat16m4_t test_vle16ff_v_f16m4_tu(vfloat16m4_t vd, const float16_t *rs1,
                                     size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}

vfloat16m8_t test_vle16ff_v_f16m8_tu(vfloat16m8_t vd, const float16_t *rs1,
                                     size_t *new_vl, size_t vl) {
  return __riscv_vle16ff_tu(vd, rs1, new_vl, vl);
}
