...
vfloat16mf4_t test_vloxei64_v_f16mf4_tu_ntl_P1(vfloat16mf4_t maskedoff, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vloxei64_v_f16mf2_tu_ntl_P1(vfloat16mf2_t maskedoff, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vloxei64_v_f16m1_tu_ntl_P1(vfloat16m1_t maskedoff, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vloxei64_v_f16m2_tu_ntl_P1(vfloat16m2_t maskedoff, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vloxei64_v_f32mf2_tu_ntl_P1(vfloat32mf2_t maskedoff, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vloxei64_v_f32m1_tu_ntl_P1(vfloat32m1_t maskedoff, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vloxei64_v_f32m2_tu_ntl_P1(vfloat32m2_t maskedoff, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vloxei64_v_f32m4_tu_ntl_P1(vfloat32m4_t maskedoff, const float32_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vloxei64_v_f64m1_tu_ntl_P1(vfloat64m1_t maskedoff, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vloxei64_v_f64m2_tu_ntl_P1(vfloat64m2_t maskedoff, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vloxei64_v_f64m4_tu_ntl_P1(vfloat64m4_t maskedoff, const float64_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vloxei64_v_f64m8_tu_ntl_P1(vfloat64m8_t maskedoff, const float64_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tu_ntl(maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4_t test_vloxei64_v_f16mf4_tum_ntl_P1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vloxei64_v_f16mf2_tum_ntl_P1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vloxei64_v_f16m1_tum_ntl_P1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vloxei64_v_f16m2_tum_ntl_P1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vloxei64_v_f32mf2_tum_ntl_P1(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vloxei64_v_f32m1_tum_ntl_P1(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vloxei64_v_f32m2_tum_ntl_P1(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vloxei64_v_f32m4_tum_ntl_P1(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vloxei64_v_f64m1_tum_ntl_P1(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vloxei64_v_f64m2_tum_ntl_P1(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vloxei64_v_f64m4_tum_ntl_P1(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vloxei64_v_f64m8_tum_ntl_P1(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tum_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4_t test_vloxei64_v_f16mf4_tumu_ntl_P1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vloxei64_v_f16mf2_tumu_ntl_P1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vloxei64_v_f16m1_tumu_ntl_P1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vloxei64_v_f16m2_tumu_ntl_P1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vloxei64_v_f32mf2_tumu_ntl_P1(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vloxei64_v_f32m1_tumu_ntl_P1(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vloxei64_v_f32m2_tumu_ntl_P1(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vloxei64_v_f32m4_tumu_ntl_P1(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vloxei64_v_f64m1_tumu_ntl_P1(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vloxei64_v_f64m2_tumu_ntl_P1(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vloxei64_v_f64m4_tumu_ntl_P1(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vloxei64_v_f64m8_tumu_ntl_P1(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_tumu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4_t test_vloxei64_v_f16mf4_mu_ntl_P1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vloxei64_v_f16mf2_mu_ntl_P1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vloxei64_v_f16m1_mu_ntl_P1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vloxei64_v_f16m2_mu_ntl_P1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vloxei64_v_f32mf2_mu_ntl_P1(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vloxei64_v_f32m1_mu_ntl_P1(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vloxei64_v_f32m2_mu_ntl_P1(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vloxei64_v_f32m4_mu_ntl_P1(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vloxei64_v_f64m1_mu_ntl_P1(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vloxei64_v_f64m2_mu_ntl_P1(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vloxei64_v_f64m4_mu_ntl_P1(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vloxei64_v_f64m8_mu_ntl_P1(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxei64_mu_ntl(mask, maskedoff, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
