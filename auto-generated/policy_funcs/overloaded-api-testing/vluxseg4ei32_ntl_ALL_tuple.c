...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tu_ntl_ALL(vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tu_ntl_ALL(vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tu_ntl_ALL(vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tu_ntl_ALL(vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tu_ntl_ALL(vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tu_ntl_ALL(vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tu_ntl_ALL(vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tu_ntl_ALL(vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tu_ntl_ALL(vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tu_ntl(maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tum_ntl_ALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tum_ntl_ALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tum_ntl_ALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tum_ntl_ALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tum_ntl_ALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tum_ntl_ALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tum_ntl_ALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tum_ntl_ALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tum_ntl_ALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tum_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tumu_ntl_ALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tumu_ntl_ALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tumu_ntl_ALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tumu_ntl_ALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tumu_ntl_ALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tumu_ntl_ALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tumu_ntl_ALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tumu_ntl_ALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tumu_ntl_ALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_tumu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_mu_ntl_ALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_mu_ntl_ALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_mu_ntl_ALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_mu_ntl_ALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_mu_ntl_ALL(vbool64_t mask, vfloat32mf2x4_t maskedoff_tuple, const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_mu_ntl_ALL(vbool32_t mask, vfloat32m1x4_t maskedoff_tuple, const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_mu_ntl_ALL(vbool16_t mask, vfloat32m2x4_t maskedoff_tuple, const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_mu_ntl_ALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_mu_ntl_ALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg4ei32_mu_ntl(mask, maskedoff_tuple, base, bindex, vl, __RISCV_NTLH_ALL);
}
