...
vfloat16mf4_t test_vluxei32_v_f16mf4_tum(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vluxei32_v_f16mf2_tum(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vluxei32_v_f16m1_tum(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vluxei32_v_f16m2_tum(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vluxei32_v_f16m4_tum(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vluxei32_v_f32mf2_tum(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vluxei32_v_f32m1_tum(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vluxei32_v_f32m2_tum(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vluxei32_v_f32m4_tum(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vluxei32_v_f32m8_tum(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vluxei32_v_f64m1_tum(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vluxei32_v_f64m2_tum(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vluxei32_v_f64m4_tum(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vluxei32_v_f64m8_tum(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_tum(mask, maskedoff, base, bindex, vl);
}
...
vfloat16mf4_t test_vluxei32_v_f16mf4_mu(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vluxei32_v_f16mf2_mu(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vluxei32_v_f16m1_mu(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vluxei32_v_f16m2_mu(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vluxei32_v_f16m4_mu(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vluxei32_v_f32mf2_mu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vluxei32_v_f32m1_mu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vluxei32_v_f32m2_mu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vluxei32_v_f32m4_mu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vluxei32_v_f32m8_mu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vluxei32_v_f64m1_mu(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vluxei32_v_f64m2_mu(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vluxei32_v_f64m4_mu(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vluxei32_v_f64m8_mu(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return __riscv_vluxei32_mu(mask, maskedoff, base, bindex, vl);
}
