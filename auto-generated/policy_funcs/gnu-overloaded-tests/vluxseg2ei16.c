...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_tu(vfloat16mf4x2_t vd, const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_tu(vfloat16mf2x2_t vd, const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_tu(vfloat16m1x2_t vd, const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_tu(vfloat16m2x2_t vd, const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_tu(vfloat16m4x2_t vd, const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_tu(vfloat32mf2x2_t vd, const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_tu(vfloat32m1x2_t vd, const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_tu(vfloat32m2x2_t vd, const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_tu(vfloat32m4x2_t vd, const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_tu(vfloat64m1x2_t vd, const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_tu(vfloat64m2x2_t vd, const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_tu(vfloat64m4x2_t vd, const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tu(vd, rs1, rs2, vl);
}
...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_tum(vbool64_t vm, vfloat16mf4x2_t vd, const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_tum(vbool32_t vm, vfloat16mf2x2_t vd, const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_tum(vbool16_t vm, vfloat16m1x2_t vd, const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_tum(vbool8_t vm, vfloat16m2x2_t vd, const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_tum(vbool4_t vm, vfloat16m4x2_t vd, const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_tum(vbool64_t vm, vfloat32mf2x2_t vd, const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_tum(vbool32_t vm, vfloat32m1x2_t vd, const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_tum(vbool16_t vm, vfloat32m2x2_t vd, const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_tum(vbool8_t vm, vfloat32m4x2_t vd, const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_tum(vbool64_t vm, vfloat64m1x2_t vd, const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_tum(vbool32_t vm, vfloat64m2x2_t vd, const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_tum(vbool16_t vm, vfloat64m4x2_t vd, const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tum(vm, vd, rs1, rs2, vl);
}
...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_tumu(vbool64_t vm, vfloat16mf4x2_t vd, const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_tumu(vbool32_t vm, vfloat16mf2x2_t vd, const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_tumu(vbool16_t vm, vfloat16m1x2_t vd, const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_tumu(vbool8_t vm, vfloat16m2x2_t vd, const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_tumu(vbool4_t vm, vfloat16m4x2_t vd, const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_tumu(vbool64_t vm, vfloat32mf2x2_t vd, const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_tumu(vbool32_t vm, vfloat32m1x2_t vd, const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_tumu(vbool16_t vm, vfloat32m2x2_t vd, const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_tumu(vbool8_t vm, vfloat32m4x2_t vd, const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_tumu(vbool64_t vm, vfloat64m1x2_t vd, const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_tumu(vbool32_t vm, vfloat64m2x2_t vd, const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_tumu(vbool16_t vm, vfloat64m4x2_t vd, const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_tumu(vm, vd, rs1, rs2, vl);
}
...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_mu(vbool64_t vm, vfloat16mf4x2_t vd, const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_mu(vbool32_t vm, vfloat16mf2x2_t vd, const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_mu(vbool16_t vm, vfloat16m1x2_t vd, const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_mu(vbool8_t vm, vfloat16m2x2_t vd, const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_mu(vbool4_t vm, vfloat16m4x2_t vd, const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_mu(vbool64_t vm, vfloat32mf2x2_t vd, const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_mu(vbool32_t vm, vfloat32m1x2_t vd, const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_mu(vbool16_t vm, vfloat32m2x2_t vd, const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_mu(vbool8_t vm, vfloat32m4x2_t vd, const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_mu(vbool64_t vm, vfloat64m1x2_t vd, const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_mu(vbool32_t vm, vfloat64m2x2_t vd, const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_mu(vbool16_t vm, vfloat64m4x2_t vd, const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxseg2ei16_mu(vm, vd, rs1, rs2, vl);
}
