...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tu(vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tu(maskedoff_tuple, base, vl);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tu(vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tu(maskedoff_tuple, base, vl);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tu(vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tu(maskedoff_tuple, base, vl);
}
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tum(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tum(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tum(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tum(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tum(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tum(mask, maskedoff_tuple, base, vl);
}
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tumu(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tumu(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tumu(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_tumu(mask, maskedoff_tuple, base, vl);
}
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_mu(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_mu(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_mu(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_mu(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_mu(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg6e16_mu(mask, maskedoff_tuple, base, vl);
}
