...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3_tu(vfloat32mf2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tu(vd, rs1, rs2, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3_tu(vfloat32m1x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tu(vd, rs1, rs2, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3_tu(vfloat32m2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tu(vd, rs1, rs2, vl);
}
...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3_tum(vbool64_t vm, vfloat32mf2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3_tum(vbool32_t vm, vfloat32m1x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3_tum(vbool16_t vm, vfloat32m2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tum(vm, vd, rs1, rs2, vl);
}
...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3_tumu(vbool64_t vm, vfloat32mf2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3_tumu(vbool32_t vm, vfloat32m1x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3_tumu(vbool16_t vm, vfloat32m2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_tumu(vm, vd, rs1, rs2, vl);
}
...
vfloat32mf2x3_t test_vlsseg3e32_v_f32mf2x3_mu(vbool64_t vm, vfloat32mf2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x3_t test_vlsseg3e32_v_f32m1x3_mu(vbool32_t vm, vfloat32m1x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x3_t test_vlsseg3e32_v_f32m2x3_mu(vbool16_t vm, vfloat32m2x3_t vd, const float *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg3e32_mu(vm, vd, rs1, rs2, vl);
}
