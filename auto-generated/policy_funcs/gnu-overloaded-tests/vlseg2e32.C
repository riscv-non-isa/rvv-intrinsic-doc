...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tu(vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tu(maskedoff_tuple, base, vl);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tu(vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tu(maskedoff_tuple, base, vl);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tu(vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tu(maskedoff_tuple, base, vl);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tu(vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tu(maskedoff_tuple, base, vl);
}
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tum(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tum(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tum(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tum(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tum(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tum(mask, maskedoff_tuple, base, vl);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tum(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tum(mask, maskedoff_tuple, base, vl);
}
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tumu(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tumu(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tumu(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tumu(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_tumu(mask, maskedoff_tuple, base, vl);
}
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_mu(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_mu(mask, maskedoff_tuple, base, vl);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_mu(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_mu(mask, maskedoff_tuple, base, vl);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_mu(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_mu(mask, maskedoff_tuple, base, vl);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_mu(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl) {
  return __riscv_vlseg2e32_mu(mask, maskedoff_tuple, base, vl);
}
