...
vfloat16mf4x3_t test_vlseg3e16_v_f16mf4x3_tu(vfloat16mf4x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tu(maskedoff_tuple, base, vl);
}

vfloat16mf2x3_t test_vlseg3e16_v_f16mf2x3_tu(vfloat16mf2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tu(maskedoff_tuple, base, vl);
}

vfloat16m1x3_t test_vlseg3e16_v_f16m1x3_tu(vfloat16m1x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tu(maskedoff_tuple, base, vl);
}

vfloat16m2x3_t test_vlseg3e16_v_f16m2x3_tu(vfloat16m2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tu(maskedoff_tuple, base, vl);
}
...
vfloat16mf4x3_t test_vlseg3e16_v_f16mf4x3_tum(vbool64_t mask, vfloat16mf4x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tum(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x3_t test_vlseg3e16_v_f16mf2x3_tum(vbool32_t mask, vfloat16mf2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tum(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x3_t test_vlseg3e16_v_f16m1x3_tum(vbool16_t mask, vfloat16m1x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tum(mask, maskedoff_tuple, base, vl);
}

vfloat16m2x3_t test_vlseg3e16_v_f16m2x3_tum(vbool8_t mask, vfloat16m2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tum(mask, maskedoff_tuple, base, vl);
}
...
vfloat16mf4x3_t test_vlseg3e16_v_f16mf4x3_tumu(vbool64_t mask, vfloat16mf4x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x3_t test_vlseg3e16_v_f16mf2x3_tumu(vbool32_t mask, vfloat16mf2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x3_t test_vlseg3e16_v_f16m1x3_tumu(vbool16_t mask, vfloat16m1x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tumu(mask, maskedoff_tuple, base, vl);
}

vfloat16m2x3_t test_vlseg3e16_v_f16m2x3_tumu(vbool8_t mask, vfloat16m2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_tumu(mask, maskedoff_tuple, base, vl);
}
...
vfloat16mf4x3_t test_vlseg3e16_v_f16mf4x3_mu(vbool64_t mask, vfloat16mf4x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_mu(mask, maskedoff_tuple, base, vl);
}

vfloat16mf2x3_t test_vlseg3e16_v_f16mf2x3_mu(vbool32_t mask, vfloat16mf2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_mu(mask, maskedoff_tuple, base, vl);
}

vfloat16m1x3_t test_vlseg3e16_v_f16m1x3_mu(vbool16_t mask, vfloat16m1x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_mu(mask, maskedoff_tuple, base, vl);
}

vfloat16m2x3_t test_vlseg3e16_v_f16m2x3_mu(vbool8_t mask, vfloat16m2x3_t maskedoff_tuple, const float16_t *base, size_t vl) {
  return __riscv_vlseg3e16_mu(mask, maskedoff_tuple, base, vl);
}
