...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tu(vfloat16mf4x4_t vd, const float16_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tu(vfloat16mf2x4_t vd, const float16_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tu(vfloat16m1x4_t vd, const float16_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tu(vfloat16m2x4_t vd, const float16_t *rs1, vuint32m4_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tu(vfloat32mf2x4_t vd, const float32_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tu(vfloat32m1x4_t vd, const float32_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tu(vfloat32m2x4_t vd, const float32_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tu(vfloat64m1x4_t vd, const float64_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tu(vfloat64m2x4_t vd, const float64_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tu(vd, rs1, rs2, vl);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tum(vbool64_t vm, vfloat16mf4x4_t vd, const float16_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tum(vbool32_t vm, vfloat16mf2x4_t vd, const float16_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tum(vbool16_t vm, vfloat16m1x4_t vd, const float16_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tum(vbool8_t vm, vfloat16m2x4_t vd, const float16_t *rs1, vuint32m4_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tum(vbool64_t vm, vfloat32mf2x4_t vd, const float32_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tum(vbool32_t vm, vfloat32m1x4_t vd, const float32_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tum(vbool16_t vm, vfloat32m2x4_t vd, const float32_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tum(vbool64_t vm, vfloat64m1x4_t vd, const float64_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tum(vbool32_t vm, vfloat64m2x4_t vd, const float64_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tum(vm, vd, rs1, rs2, vl);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_tumu(vbool64_t vm, vfloat16mf4x4_t vd, const float16_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_tumu(vbool32_t vm, vfloat16mf2x4_t vd, const float16_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_tumu(vbool16_t vm, vfloat16m1x4_t vd, const float16_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_tumu(vbool8_t vm, vfloat16m2x4_t vd, const float16_t *rs1, vuint32m4_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_tumu(vbool64_t vm, vfloat32mf2x4_t vd, const float32_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_tumu(vbool32_t vm, vfloat32m1x4_t vd, const float32_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_tumu(vbool16_t vm, vfloat32m2x4_t vd, const float32_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_tumu(vbool64_t vm, vfloat64m1x4_t vd, const float64_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_tumu(vbool32_t vm, vfloat64m2x4_t vd, const float64_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_tumu(vm, vd, rs1, rs2, vl);
}
...
vfloat16mf4x4_t test_vluxseg4ei32_v_f16mf4x4_mu(vbool64_t vm, vfloat16mf4x4_t vd, const float16_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat16mf2x4_t test_vluxseg4ei32_v_f16mf2x4_mu(vbool32_t vm, vfloat16mf2x4_t vd, const float16_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m1x4_t test_vluxseg4ei32_v_f16m1x4_mu(vbool16_t vm, vfloat16m1x4_t vd, const float16_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat16m2x4_t test_vluxseg4ei32_v_f16m2x4_mu(vbool8_t vm, vfloat16m2x4_t vd, const float16_t *rs1, vuint32m4_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vluxseg4ei32_v_f32mf2x4_mu(vbool64_t vm, vfloat32mf2x4_t vd, const float32_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m1x4_t test_vluxseg4ei32_v_f32m1x4_mu(vbool32_t vm, vfloat32m1x4_t vd, const float32_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat32m2x4_t test_vluxseg4ei32_v_f32m2x4_mu(vbool16_t vm, vfloat32m2x4_t vd, const float32_t *rs1, vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m1x4_t test_vluxseg4ei32_v_f64m1x4_mu(vbool64_t vm, vfloat64m1x4_t vd, const float64_t *rs1, vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vluxseg4ei32_v_f64m2x4_mu(vbool32_t vm, vfloat64m2x4_t vd, const float64_t *rs1, vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg4ei32_mu(vm, vd, rs1, rs2, vl);
}
