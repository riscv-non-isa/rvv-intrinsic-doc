...
vfloat16mf4_t test_vle16_v_f16mf4_tu_ntl_ALL(vfloat16mf4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_tu_ntl(maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vle16_v_f16mf2_tu_ntl_ALL(vfloat16mf2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_tu_ntl(maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vle16_v_f16m1_tu_ntl_ALL(vfloat16m1_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_tu_ntl(maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vle16_v_f16m2_tu_ntl_ALL(vfloat16m2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_tu_ntl(maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vle16_v_f16m4_tu_ntl_ALL(vfloat16m4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_tu_ntl(maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vle16_v_f16m8_tu_ntl_ALL(vfloat16m8_t maskedoff, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tum_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_tum_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vle16_v_f16mf2_tum_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_tum_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vle16_v_f16m1_tum_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_tum_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vle16_v_f16m2_tum_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_tum_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vle16_v_f16m4_tum_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_tum_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vle16_v_f16m8_tum_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tumu_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_tumu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vle16_v_f16mf2_tumu_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_tumu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vle16_v_f16m1_tumu_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_tumu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vle16_v_f16m2_tumu_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_tumu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vle16_v_f16m4_tumu_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_tumu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vle16_v_f16m8_tumu_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16_v_f16mf4_mu_ntl_ALL(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf4_mu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2_t test_vle16_v_f16mf2_mu_ntl_ALL(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16mf2_mu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1_t test_vle16_v_f16m1_mu_ntl_ALL(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m1_mu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m2_t test_vle16_v_f16m2_mu_ntl_ALL(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m2_mu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m4_t test_vle16_v_f16m4_mu_ntl_ALL(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl, int domain) {
  return __riscv_vle16_v_f16m4_mu_ntl(mask, maskedoff, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m8_t test_vle16_v_f16m8_mu_ntl_ALL(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl, int domain) {
