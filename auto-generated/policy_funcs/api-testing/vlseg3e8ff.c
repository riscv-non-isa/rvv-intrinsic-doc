...
vint8mf8x3_t test_vlseg3e8ff_v_i8mf8x3_tum(vbool64_t mask,
                                           ...
                                           const int8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf8x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint8mf4x3_t test_vlseg3e8ff_v_i8mf4x3_tum(vbool32_t mask,
                                           ...
                                           const int8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf4x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint8mf2x3_t test_vlseg3e8ff_v_i8mf2x3_tum(vbool16_t mask,
                                           ...
                                           const int8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf2x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint8m1x3_t test_vlseg3e8ff_v_i8m1x3_tum(vbool8_t mask,
                                         ...
                                         const int8_t *base, size_t *new_vl,
                                         size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m1x3_tum(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vint8m2x3_t test_vlseg3e8ff_v_i8m2x3_tum(vbool4_t mask,
                                         ...
                                         const int8_t *base, size_t *new_vl,
                                         size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m2x3_tum(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vuint8mf8x3_t test_vlseg3e8ff_v_u8mf8x3_tum(vbool64_t mask,
                                            ...
                                            const uint8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf8x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint8mf4x3_t test_vlseg3e8ff_v_u8mf4x3_tum(vbool32_t mask,
                                            ...
                                            const uint8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf4x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint8mf2x3_t test_vlseg3e8ff_v_u8mf2x3_tum(vbool16_t mask,
                                            ...
                                            const uint8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf2x3_tum(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint8m1x3_t test_vlseg3e8ff_v_u8m1x3_tum(vbool8_t mask,
                                          ...
                                          const uint8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m1x3_tum(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vuint8m2x3_t test_vlseg3e8ff_v_u8m2x3_tum(vbool4_t mask,
                                          ...
                                          const uint8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m2x3_tum(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vint8mf8x3_t test_vlseg3e8ff_v_i8mf8x3_tumu(vbool64_t mask,
                                            ...
                                            const int8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf8x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vint8mf4x3_t test_vlseg3e8ff_v_i8mf4x3_tumu(vbool32_t mask,
                                            ...
                                            const int8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf4x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vint8mf2x3_t test_vlseg3e8ff_v_i8mf2x3_tumu(vbool16_t mask,
                                            ...
                                            const int8_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf2x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vint8m1x3_t test_vlseg3e8ff_v_i8m1x3_tumu(vbool8_t mask,
                                          ...
                                          const int8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m1x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint8m2x3_t test_vlseg3e8ff_v_i8m2x3_tumu(vbool4_t mask,
                                          ...
                                          const int8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m2x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint8mf8x3_t test_vlseg3e8ff_v_u8mf8x3_tumu(vbool64_t mask,
  ...
  return __riscv_vlseg3e8ff_v_u8mf8x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vuint8mf4x3_t test_vlseg3e8ff_v_u8mf4x3_tumu(vbool32_t mask,
                                             ...
                                             const uint8_t *base,
                                             size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf4x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vuint8mf2x3_t test_vlseg3e8ff_v_u8mf2x3_tumu(vbool16_t mask,
                                             ...
                                             const uint8_t *base,
                                             size_t *new_vl, size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf2x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vuint8m1x3_t test_vlseg3e8ff_v_u8m1x3_tumu(vbool8_t mask,
                                           ...
                                           const uint8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m1x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint8m2x3_t test_vlseg3e8ff_v_u8m2x3_tumu(vbool4_t mask,
                                           ...
                                           const uint8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m2x3_tumu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint8mf8x3_t test_vlseg3e8ff_v_i8mf8x3_mu(vbool64_t mask,
                                          ...
                                          const int8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf8x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vint8mf4x3_t test_vlseg3e8ff_v_i8mf4x3_mu(vbool32_t mask,
                                          ...
                                          const int8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf4x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vint8mf2x3_t test_vlseg3e8ff_v_i8mf2x3_mu(vbool16_t mask,
                                          ...
                                          const int8_t *base, size_t *new_vl,
                                          size_t vl) {
  return __riscv_vlseg3e8ff_v_i8mf2x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vint8m1x3_t test_vlseg3e8ff_v_i8m1x3_mu(vbool8_t mask,
                                        ...
                                        const int8_t *base, size_t *new_vl,
                                        size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m1x3_mu(mask, maskedoff_tuple, base, new_vl,
                                        vl);
}
...
vint8m2x3_t test_vlseg3e8ff_v_i8m2x3_mu(vbool4_t mask,
                                        ...
                                        const int8_t *base, size_t *new_vl,
                                        size_t vl) {
  return __riscv_vlseg3e8ff_v_i8m2x3_mu(mask, maskedoff_tuple, base, new_vl,
                                        vl);
}
...
vuint8mf8x3_t test_vlseg3e8ff_v_u8mf8x3_mu(vbool64_t mask,
                                           ...
                                           const uint8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf8x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vuint8mf4x3_t test_vlseg3e8ff_v_u8mf4x3_mu(vbool32_t mask,
                                           ...
                                           const uint8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf4x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vuint8mf2x3_t test_vlseg3e8ff_v_u8mf2x3_mu(vbool16_t mask,
                                           ...
                                           const uint8_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg3e8ff_v_u8mf2x3_mu(mask, maskedoff_tuple, base, new_vl,
                                         vl);
}
...
vuint8m1x3_t test_vlseg3e8ff_v_u8m1x3_mu(vbool8_t mask,
                                         ...
                                         const uint8_t *base, size_t *new_vl,
                                         size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m1x3_mu(mask, maskedoff_tuple, base, new_vl,
                                        vl);
}
...
vuint8m2x3_t test_vlseg3e8ff_v_u8m2x3_mu(vbool4_t mask,
                                         ...
                                         const uint8_t *base, size_t *new_vl,
                                         size_t vl) {
  return __riscv_vlseg3e8ff_v_u8m2x3_mu(mask, maskedoff_tuple, base, new_vl,
                                        vl);
}
