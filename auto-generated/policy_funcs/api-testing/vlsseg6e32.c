...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_tum(vbool64_t mask,
                                               ...
                                               const float32_t *base,
                                               ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32mf2x6_tum(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_tum(vbool32_t mask,
                                             ...
                                             const float32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32m1x6_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vint32mf2x6_t test_vlsseg6e32_v_i32mf2x6_tum(vbool64_t mask,
                                             ...
                                             const int32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32mf2x6_tum(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vint32m1x6_t test_vlsseg6e32_v_i32m1x6_tum(vbool32_t mask,
                                           ...
                                           const int32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32m1x6_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vuint32mf2x6_t test_vlsseg6e32_v_u32mf2x6_tum(vbool64_t mask,
                                              ...
                                              const uint32_t *base,
                                              ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32mf2x6_tum(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vuint32m1x6_t test_vlsseg6e32_v_u32m1x6_tum(vbool32_t mask,
                                            ...
                                            const uint32_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32m1x6_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_tumu(vbool64_t mask,
                                                ...
                                                const float32_t *base,
                                                ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32mf2x6_tumu(mask, maskedoff_tuple, base,
                                            bstride, vl);
}
...
vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_tumu(vbool32_t mask,
                                              ...
                                              const float32_t *base,
                                              ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32m1x6_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vint32mf2x6_t test_vlsseg6e32_v_i32mf2x6_tumu(vbool64_t mask,
                                              ...
                                              const int32_t *base,
                                              ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32mf2x6_tumu(mask, maskedoff_tuple, base,
                                            bstride, vl);
}
...
vint32m1x6_t test_vlsseg6e32_v_i32m1x6_tumu(vbool32_t mask,
                                            ...
                                            const int32_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32m1x6_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vuint32mf2x6_t test_vlsseg6e32_v_u32mf2x6_tumu(vbool64_t mask,
                                               ...
                                               const uint32_t *base,
                                               ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32mf2x6_tumu(mask, maskedoff_tuple, base,
                                            bstride, vl);
}
...
vuint32m1x6_t test_vlsseg6e32_v_u32m1x6_tumu(vbool32_t mask,
                                             ...
                                             const uint32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32m1x6_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_mu(vbool64_t mask,
                                              ...
                                              const float32_t *base,
                                              ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32mf2x6_mu(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_mu(vbool32_t mask,
                                            ...
                                            const float32_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_f32m1x6_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
...
vint32mf2x6_t test_vlsseg6e32_v_i32mf2x6_mu(vbool64_t mask,
                                            ...
                                            const int32_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32mf2x6_mu(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vint32m1x6_t test_vlsseg6e32_v_i32m1x6_mu(vbool32_t mask,
                                          ...
                                          const int32_t *base,
                                          ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_i32m1x6_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
...
vuint32mf2x6_t test_vlsseg6e32_v_u32mf2x6_mu(vbool64_t mask,
                                             ...
                                             const uint32_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32mf2x6_mu(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vuint32m1x6_t test_vlsseg6e32_v_u32m1x6_mu(vbool32_t mask,
                                           ...
                                           const uint32_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg6e32_v_u32m1x6_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
