...
vfloat64m1x2_t test_vlseg2e64_v_f64m1x2_tu(vfloat64m1x2_t vd,
                                           const float64_t *rs1, size_t vl) {
  return __riscv_vlseg2e64_v_f64m1x2_tu(vd, rs1, vl);
}

vfloat64m2x2_t test_vlseg2e64_v_f64m2x2_tu(vfloat64m2x2_t vd,
                                           const float64_t *rs1, size_t vl) {
  return __riscv_vlseg2e64_v_f64m2x2_tu(vd, rs1, vl);
}

vfloat64m4x2_t test_vlseg2e64_v_f64m4x2_tu(vfloat64m4x2_t vd,
                                           const float64_t *rs1, size_t vl) {
