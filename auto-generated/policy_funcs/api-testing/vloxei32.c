...
vfloat16mf4_t test_vloxei32_v_f16mf4_tu(vfloat16mf4_t vd, const float16_t *rs1,
                                        vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f16mf4_tu(vd, rs1, rs2, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tu(vfloat16mf2_t vd, const float16_t *rs1,
                                        vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f16mf2_tu(vd, rs1, rs2, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tu(vfloat16m1_t vd, const float16_t *rs1,
                                      vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f16m1_tu(vd, rs1, rs2, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tu(vfloat16m2_t vd, const float16_t *rs1,
                                      vuint32m4_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f16m2_tu(vd, rs1, rs2, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tu(vfloat16m4_t vd, const float16_t *rs1,
                                      vuint32m8_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f16m4_tu(vd, rs1, rs2, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tu(vfloat32mf2_t vd, const float32_t *rs1,
                                        vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f32mf2_tu(vd, rs1, rs2, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tu(vfloat32m1_t vd, const float32_t *rs1,
                                      vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f32m1_tu(vd, rs1, rs2, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tu(vfloat32m2_t vd, const float32_t *rs1,
                                      vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f32m2_tu(vd, rs1, rs2, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tu(vfloat32m4_t vd, const float32_t *rs1,
                                      vuint32m4_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f32m4_tu(vd, rs1, rs2, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tu(vfloat32m8_t vd, const float32_t *rs1,
                                      vuint32m8_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f32m8_tu(vd, rs1, rs2, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tu(vfloat64m1_t vd, const float64_t *rs1,
                                      vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f64m1_tu(vd, rs1, rs2, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tu(vfloat64m2_t vd, const float64_t *rs1,
                                      vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f64m2_tu(vd, rs1, rs2, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tu(vfloat64m4_t vd, const float64_t *rs1,
                                      vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxei32_v_f64m4_tu(vd, rs1, rs2, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tu(vfloat64m8_t vd, const float64_t *rs1,
                                      vuint32m4_t rs2, size_t vl) {
