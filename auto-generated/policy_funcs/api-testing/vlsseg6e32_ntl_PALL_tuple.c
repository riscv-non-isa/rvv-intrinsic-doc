...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_tu_ntl_PALL(vfloat32mf2x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_tu_ntl_PALL(vfloat32m1x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_tum_ntl_PALL(vbool64_t mask, vfloat32mf2x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_tum_ntl_PALL(vbool32_t mask, vfloat32m1x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_tumu_ntl_PALL(vbool64_t mask, vfloat32mf2x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_tumu_ntl_PALL(vbool32_t mask, vfloat32m1x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2x6_t test_vlsseg6e32_v_f32mf2x6_mu_ntl_PALL(vbool64_t mask, vfloat32mf2x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e32_v_f32mf2x6_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x6_t test_vlsseg6e32_v_f32m1x6_mu_ntl_PALL(vbool32_t mask, vfloat32m1x6_t maskedoff_tuple, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
