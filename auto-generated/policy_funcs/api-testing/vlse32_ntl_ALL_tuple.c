...
vfloat32mf2_t test_vlse32_v_f32mf2_tu_ntl_ALL(vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32mf2_tu_ntl(maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vlse32_v_f32m1_tu_ntl_ALL(vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m1_tu_ntl(maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vlse32_v_f32m2_tu_ntl_ALL(vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m2_tu_ntl(maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vlse32_v_f32m4_tu_ntl_ALL(vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m4_tu_ntl(maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vlse32_v_f32m8_tu_ntl_ALL(vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2_t test_vlse32_v_f32mf2_tum_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32mf2_tum_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vlse32_v_f32m1_tum_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m1_tum_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vlse32_v_f32m2_tum_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m2_tum_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vlse32_v_f32m4_tum_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m4_tum_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vlse32_v_f32m8_tum_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2_t test_vlse32_v_f32mf2_tumu_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32mf2_tumu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vlse32_v_f32m1_tumu_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m1_tumu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vlse32_v_f32m2_tumu_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m2_tumu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vlse32_v_f32m4_tumu_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m4_tumu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vlse32_v_f32m8_tumu_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat32mf2_t test_vlse32_v_f32mf2_mu_ntl_ALL(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32mf2_mu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m1_t test_vlse32_v_f32m1_mu_ntl_ALL(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m1_mu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m2_t test_vlse32_v_f32m2_mu_ntl_ALL(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m2_mu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m4_t test_vlse32_v_f32m4_mu_ntl_ALL(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlse32_v_f32m4_mu_ntl(mask, maskedoff, base, bstride, vl, __RISCV_NTLH_ALL);
}

vfloat32m8_t test_vlse32_v_f32m8_mu_ntl_ALL(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl, int domain) {
