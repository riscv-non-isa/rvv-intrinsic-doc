...
vfloat64m1x3_t test_vlseg3e64_v_f64m1x3_tu_ntl_ALL(vfloat64m1x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg3e64_v_f64m1x3_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x3_t test_vlseg3e64_v_f64m2x3_tu_ntl_ALL(vfloat64m2x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x3_t test_vlseg3e64_v_f64m1x3_tum_ntl_ALL(vbool64_t mask, vfloat64m1x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg3e64_v_f64m1x3_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x3_t test_vlseg3e64_v_f64m2x3_tum_ntl_ALL(vbool32_t mask, vfloat64m2x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x3_t test_vlseg3e64_v_f64m1x3_tumu_ntl_ALL(vbool64_t mask, vfloat64m1x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg3e64_v_f64m1x3_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x3_t test_vlseg3e64_v_f64m2x3_tumu_ntl_ALL(vbool32_t mask, vfloat64m2x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
...
vfloat64m1x3_t test_vlseg3e64_v_f64m1x3_mu_ntl_ALL(vbool64_t mask, vfloat64m1x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
  return __riscv_vlseg3e64_v_f64m1x3_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x3_t test_vlseg3e64_v_f64m2x3_mu_ntl_ALL(vbool32_t mask, vfloat64m2x3_t maskedoff_tuple, const float64_t *base, size_t vl, int domain) {
