...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_tum(vbool64_t mask,
                                              ...
                                              const float64_t *base,
                                              size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_f64m1x8_tum(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vint64m1x8_t test_vlseg8e64ff_v_i64m1x8_tum(vbool64_t mask,
                                            ...
                                            const int64_t *base, size_t *new_vl,
                                            size_t vl) {
  return __riscv_vlseg8e64ff_v_i64m1x8_tum(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vuint64m1x8_t test_vlseg8e64ff_v_u64m1x8_tum(vbool64_t mask,
                                             ...
                                             const uint64_t *base,
                                             size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_u64m1x8_tum(mask, maskedoff_tuple, base, new_vl,
                                           vl);
}
...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_tumu(vbool64_t mask,
                                               ...
                                               const float64_t *base,
                                               size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_f64m1x8_tumu(mask, maskedoff_tuple, base, new_vl,
                                            vl);
}
...
vint64m1x8_t test_vlseg8e64ff_v_i64m1x8_tumu(vbool64_t mask,
                                             ...
                                             const int64_t *base,
                                             size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_i64m1x8_tumu(mask, maskedoff_tuple, base, new_vl,
                                            vl);
}
...
vuint64m1x8_t test_vlseg8e64ff_v_u64m1x8_tumu(vbool64_t mask,
                                              ...
                                              const uint64_t *base,
                                              size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_u64m1x8_tumu(mask, maskedoff_tuple, base, new_vl,
                                            vl);
}
...
vfloat64m1x8_t test_vlseg8e64ff_v_f64m1x8_mu(vbool64_t mask,
                                             ...
                                             const float64_t *base,
                                             size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_f64m1x8_mu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vint64m1x8_t test_vlseg8e64ff_v_i64m1x8_mu(vbool64_t mask,
                                           ...
                                           const int64_t *base, size_t *new_vl,
                                           size_t vl) {
  return __riscv_vlseg8e64ff_v_i64m1x8_mu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
...
vuint64m1x8_t test_vlseg8e64ff_v_u64m1x8_mu(vbool64_t mask,
                                            ...
                                            const uint64_t *base,
                                            size_t *new_vl, size_t vl) {
  return __riscv_vlseg8e64ff_v_u64m1x8_mu(mask, maskedoff_tuple, base, new_vl,
                                          vl);
}
