...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tu_ntl_PALL(vfloat64m1x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg4e64_v_f64m1x4_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tu_ntl_PALL(vfloat64m2x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tum_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg4e64_v_f64m1x4_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tum_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tumu_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg4e64_v_f64m1x4_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tumu_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_mu_ntl_PALL(vbool64_t mask, vfloat64m1x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg4e64_v_f64m1x4_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_mu_ntl_PALL(vbool32_t mask, vfloat64m2x4_t maskedoff_tuple, const float64_t *base, ptrdiff_t bstride, size_t vl, int domain) {
