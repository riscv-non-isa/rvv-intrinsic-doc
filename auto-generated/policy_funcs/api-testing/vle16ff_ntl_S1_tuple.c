...
vfloat16mf4_t test_vle16ff_v_f16mf4_tu_ntl_S1(vfloat16mf4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf4_tu_ntl(maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_tu_ntl_S1(vfloat16mf2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf2_tu_ntl(maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1_t test_vle16ff_v_f16m1_tu_ntl_S1(vfloat16m1_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m1_tu_ntl(maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2_t test_vle16ff_v_f16m2_tu_ntl_S1(vfloat16m2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m2_tu_ntl(maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4_t test_vle16ff_v_f16m4_tu_ntl_S1(vfloat16m4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m4_tu_ntl(maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m8_t test_vle16ff_v_f16m8_tu_ntl_S1(vfloat16m8_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16ff_v_f16mf4_tum_ntl_S1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf4_tum_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_tum_ntl_S1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf2_tum_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1_t test_vle16ff_v_f16m1_tum_ntl_S1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m1_tum_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2_t test_vle16ff_v_f16m2_tum_ntl_S1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m2_tum_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4_t test_vle16ff_v_f16m4_tum_ntl_S1(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m4_tum_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m8_t test_vle16ff_v_f16m8_tum_ntl_S1(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16ff_v_f16mf4_tumu_ntl_S1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf4_tumu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_tumu_ntl_S1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf2_tumu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1_t test_vle16ff_v_f16m1_tumu_ntl_S1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m1_tumu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2_t test_vle16ff_v_f16m2_tumu_ntl_S1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m2_tumu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4_t test_vle16ff_v_f16m4_tumu_ntl_S1(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m4_tumu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m8_t test_vle16ff_v_f16m8_tumu_ntl_S1(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4_t test_vle16ff_v_f16mf4_mu_ntl_S1(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf4_mu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_mu_ntl_S1(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16mf2_mu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1_t test_vle16ff_v_f16m1_mu_ntl_S1(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m1_mu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2_t test_vle16ff_v_f16m2_mu_ntl_S1(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m2_mu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4_t test_vle16ff_v_f16m4_mu_ntl_S1(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vle16ff_v_f16m4_mu_ntl(mask, maskedoff, base, new_vl, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m8_t test_vle16ff_v_f16m8_mu_ntl_S1(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
