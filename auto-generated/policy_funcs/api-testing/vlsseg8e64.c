...
vfloat64m1x8_t test_vlsseg8e64_v_f64m1x8_tum(vbool64_t mask,
                                             ...
                                             const float64_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_f64m1x8_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vint64m1x8_t test_vlsseg8e64_v_i64m1x8_tum(vbool64_t mask,
                                           ...
                                           const int64_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_i64m1x8_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vuint64m1x8_t test_vlsseg8e64_v_u64m1x8_tum(vbool64_t mask,
                                            ...
                                            const uint64_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_u64m1x8_tum(mask, maskedoff_tuple, base, bstride,
                                          vl);
}
...
vfloat64m1x8_t test_vlsseg8e64_v_f64m1x8_tumu(vbool64_t mask,
                                              ...
                                              const float64_t *base,
                                              ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_f64m1x8_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vint64m1x8_t test_vlsseg8e64_v_i64m1x8_tumu(vbool64_t mask,
                                            ...
                                            const int64_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_i64m1x8_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vuint64m1x8_t test_vlsseg8e64_v_u64m1x8_tumu(vbool64_t mask,
                                             ...
                                             const uint64_t *base,
                                             ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_u64m1x8_tumu(mask, maskedoff_tuple, base, bstride,
                                           vl);
}
...
vfloat64m1x8_t test_vlsseg8e64_v_f64m1x8_mu(vbool64_t mask,
                                            ...
                                            const float64_t *base,
                                            ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_f64m1x8_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
...
vint64m1x8_t test_vlsseg8e64_v_i64m1x8_mu(vbool64_t mask,
                                          ...
                                          const int64_t *base,
                                          ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_i64m1x8_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
...
vuint64m1x8_t test_vlsseg8e64_v_u64m1x8_mu(vbool64_t mask,
                                           ...
                                           const uint64_t *base,
                                           ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg8e64_v_u64m1x8_mu(mask, maskedoff_tuple, base, bstride,
                                         vl);
}
