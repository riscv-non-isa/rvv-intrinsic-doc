...
vfloat16mf4x4_t test_vlseg4e16ff_v_f16mf4x4_tu_ntl_PALL(vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf4x4_tu_ntl(maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16ff_v_f16mf2x4_tu_ntl_PALL(vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf2x4_tu_ntl(maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16ff_v_f16m1x4_tu_ntl_PALL(vfloat16m1x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16m1x4_tu_ntl(maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16ff_v_f16m2x4_tu_ntl_PALL(vfloat16m2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4x4_t test_vlseg4e16ff_v_f16mf4x4_tum_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf4x4_tum_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16ff_v_f16mf2x4_tum_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf2x4_tum_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16ff_v_f16m1x4_tum_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16m1x4_tum_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16ff_v_f16m2x4_tum_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4x4_t test_vlseg4e16ff_v_f16mf4x4_tumu_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf4x4_tumu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16ff_v_f16mf2x4_tumu_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf2x4_tumu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16ff_v_f16m1x4_tumu_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16m1x4_tumu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16ff_v_f16m2x4_tumu_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
...
vfloat16mf4x4_t test_vlseg4e16ff_v_f16mf4x4_mu_ntl_PALL(vbool64_t mask, vfloat16mf4x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf4x4_mu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x4_t test_vlseg4e16ff_v_f16mf2x4_mu_ntl_PALL(vbool32_t mask, vfloat16mf2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16mf2x4_mu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x4_t test_vlseg4e16ff_v_f16m1x4_mu_ntl_PALL(vbool16_t mask, vfloat16m1x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
  return __riscv_vlseg4e16ff_v_f16m1x4_mu_ntl(mask, maskedoff_tuple, base, new_vl, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m2x4_t test_vlseg4e16ff_v_f16m2x4_mu_ntl_PALL(vbool8_t mask, vfloat16m2x4_t maskedoff_tuple, const float16_t *base, size_t *new_vl, size_t vl, int domain) {
