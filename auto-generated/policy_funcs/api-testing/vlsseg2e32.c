...
vfloat32m1x2_t test_vlsseg2e32_v_f32m1x2_tu(vfloat32m1x2_t vd,
                                            const float32_t *rs1, ptrdiff_t rs2,
                                            size_t vl) {
  return __riscv_vlsseg2e32_v_f32m1x2_tu(vd, rs1, rs2, vl);
}

vfloat32m2x2_t test_vlsseg2e32_v_f32m2x2_tu(vfloat32m2x2_t vd,
                                            const float32_t *rs1, ptrdiff_t rs2,
                                            size_t vl) {
  return __riscv_vlsseg2e32_v_f32m2x2_tu(vd, rs1, rs2, vl);
}

vfloat32m4x2_t test_vlsseg2e32_v_f32m4x2_tu(vfloat32m4x2_t vd,
                                            const float32_t *rs1, ptrdiff_t rs2,
                                            size_t vl) {
