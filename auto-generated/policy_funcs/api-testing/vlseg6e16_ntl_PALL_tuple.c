...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tu_ntl_PALL(vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tu_ntl_PALL(vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tu_ntl_PALL(vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tum_ntl_PALL(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tum_ntl_PALL(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tum_ntl_PALL(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_tumu_ntl_PALL(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_tumu_ntl_PALL(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_tumu_ntl_PALL(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
...
vfloat16mf4x6_t test_vlseg6e16_v_f16mf4x6_mu_ntl_PALL(vbool64_t mask, vfloat16mf4x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf4x6_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlseg6e16_v_f16mf2x6_mu_ntl_PALL(vbool32_t mask, vfloat16mf2x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
  return __riscv_vlseg6e16_v_f16mf2x6_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlseg6e16_v_f16m1x6_mu_ntl_PALL(vbool16_t mask, vfloat16m1x6_t maskedoff_tuple, const float16_t *base, size_t vl, int domain) {
