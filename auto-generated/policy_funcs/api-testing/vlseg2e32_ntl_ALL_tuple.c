...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tu_ntl_ALL(vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32mf2x2_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tu_ntl_ALL(vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m1x2_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tu_ntl_ALL(vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m2x2_tu_ntl(maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tu_ntl_ALL(vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tum_ntl_ALL(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32mf2x2_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tum_ntl_ALL(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m1x2_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tum_ntl_ALL(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m2x2_tum_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tum_ntl_ALL(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_tumu_ntl_ALL(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32mf2x2_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_tumu_ntl_ALL(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m1x2_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_tumu_ntl_ALL(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m2x2_tumu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_tumu_ntl_ALL(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
...
vfloat32mf2x2_t test_vlseg2e32_v_f32mf2x2_mu_ntl_ALL(vbool64_t mask, vfloat32mf2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32mf2x2_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vlseg2e32_v_f32m1x2_mu_ntl_ALL(vbool32_t mask, vfloat32m1x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m1x2_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vlseg2e32_v_f32m2x2_mu_ntl_ALL(vbool16_t mask, vfloat32m2x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
  return __riscv_vlseg2e32_v_f32m2x2_mu_ntl(mask, maskedoff_tuple, base, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vlseg2e32_v_f32m4x2_mu_ntl_ALL(vbool8_t mask, vfloat32m4x2_t maskedoff_tuple, const float32_t *base, size_t vl, int domain) {
