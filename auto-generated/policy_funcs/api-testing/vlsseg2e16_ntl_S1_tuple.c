...
vfloat16mf4x2_t test_vlsseg2e16_v_f16mf4x2_tu_ntl_S1(vfloat16mf4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf4x2_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x2_t test_vlsseg2e16_v_f16mf2x2_tu_ntl_S1(vfloat16mf2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf2x2_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x2_t test_vlsseg2e16_v_f16m1x2_tu_ntl_S1(vfloat16m1x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m1x2_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x2_t test_vlsseg2e16_v_f16m2x2_tu_ntl_S1(vfloat16m2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m2x2_tu_ntl(maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4x2_t test_vlsseg2e16_v_f16m4x2_tu_ntl_S1(vfloat16m4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat16mf4x2_t test_vlsseg2e16_v_f16mf4x2_tum_ntl_S1(vbool64_t mask, vfloat16mf4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf4x2_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x2_t test_vlsseg2e16_v_f16mf2x2_tum_ntl_S1(vbool32_t mask, vfloat16mf2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf2x2_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x2_t test_vlsseg2e16_v_f16m1x2_tum_ntl_S1(vbool16_t mask, vfloat16m1x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m1x2_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x2_t test_vlsseg2e16_v_f16m2x2_tum_ntl_S1(vbool8_t mask, vfloat16m2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m2x2_tum_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4x2_t test_vlsseg2e16_v_f16m4x2_tum_ntl_S1(vbool4_t mask, vfloat16m4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat16mf4x2_t test_vlsseg2e16_v_f16mf4x2_tumu_ntl_S1(vbool64_t mask, vfloat16mf4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf4x2_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x2_t test_vlsseg2e16_v_f16mf2x2_tumu_ntl_S1(vbool32_t mask, vfloat16mf2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf2x2_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x2_t test_vlsseg2e16_v_f16m1x2_tumu_ntl_S1(vbool16_t mask, vfloat16m1x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m1x2_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x2_t test_vlsseg2e16_v_f16m2x2_tumu_ntl_S1(vbool8_t mask, vfloat16m2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m2x2_tumu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4x2_t test_vlsseg2e16_v_f16m4x2_tumu_ntl_S1(vbool4_t mask, vfloat16m4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat16mf4x2_t test_vlsseg2e16_v_f16mf4x2_mu_ntl_S1(vbool64_t mask, vfloat16mf4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf4x2_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16mf2x2_t test_vlsseg2e16_v_f16mf2x2_mu_ntl_S1(vbool32_t mask, vfloat16mf2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16mf2x2_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m1x2_t test_vlsseg2e16_v_f16m1x2_mu_ntl_S1(vbool16_t mask, vfloat16m1x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m1x2_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m2x2_t test_vlsseg2e16_v_f16m2x2_mu_ntl_S1(vbool8_t mask, vfloat16m2x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg2e16_v_f16m2x2_mu_ntl(mask, maskedoff_tuple, base, bstride, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

vfloat16m4x2_t test_vlsseg2e16_v_f16m4x2_mu_ntl_S1(vbool4_t mask, vfloat16m4x2_t maskedoff_tuple, const float16_t *base, ptrdiff_t bstride, size_t vl, int domain) {
