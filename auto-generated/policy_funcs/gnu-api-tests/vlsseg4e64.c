...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tu(vfloat64m1x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg4e64_v_f64m1x4_tu(vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tu(vfloat64m2x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tum(vbool64_t vm, vfloat64m1x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg4e64_v_f64m1x4_tum(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tum(vbool32_t vm, vfloat64m2x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_tumu(vbool64_t vm, vfloat64m1x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg4e64_v_f64m1x4_tumu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_tumu(vbool32_t vm, vfloat64m2x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
...
vfloat64m1x4_t test_vlsseg4e64_v_f64m1x4_mu(vbool64_t vm, vfloat64m1x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
  return __riscv_vlsseg4e64_v_f64m1x4_mu(vm, vd, rs1, rs2, vl);
}

vfloat64m2x4_t test_vlsseg4e64_v_f64m2x4_mu(vbool32_t vm, vfloat64m2x4_t vd, const double *rs1, ptrdiff_t rs2, size_t vl) {
