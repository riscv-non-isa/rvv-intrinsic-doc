...
vfloat16mf4_t test_vlse16_v_f16mf4_tum(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse16_v_f16mf4_tum(mask, maskedoff, base, bstride, vl);
}

vfloat16mf2_t test_vlse16_v_f16mf2_tum(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse16_v_f16mf2_tum(mask, maskedoff, base, bstride, vl);
}

vfloat16m1_t test_vlse16_v_f16m1_tum(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse16_v_f16m1_tum(mask, maskedoff, base, bstride, vl);
}

vfloat16m2_t test_vlse16_v_f16m2_tum(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse16_v_f16m2_tum(mask, maskedoff, base, bstride, vl);
}

vfloat16m4_t test_vlse16_v_f16m4_tum(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse16_v_f16m4_tum(mask, maskedoff, base, bstride, vl);
}

vfloat16m8_t test_vlse16_v_f16m8_tum(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, ptrdiff_t bstride, size_t vl) {
...
/* { dg-final { scan-assembler-times {vsetvli\s+zero,\s*[a-x0-9]+,\s*e[0-9]+,\s*m[f]?[1248],\s*t[au],\s*m[au]\s+vlse16\.[,\sa-x0-9()]+} 72 } } */
