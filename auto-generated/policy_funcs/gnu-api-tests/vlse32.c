...
vfloat32mf2_t test_vlse32_v_f32mf2_tum(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32mf2_tum(mask, maskedoff, base, bstride, vl);
}

vfloat32m1_t test_vlse32_v_f32m1_tum(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m1_tum(mask, maskedoff, base, bstride, vl);
}

vfloat32m2_t test_vlse32_v_f32m2_tum(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m2_tum(mask, maskedoff, base, bstride, vl);
}

vfloat32m4_t test_vlse32_v_f32m4_tum(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m4_tum(mask, maskedoff, base, bstride, vl);
}

vfloat32m8_t test_vlse32_v_f32m8_tum(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
...
vfloat32mf2_t test_vlse32_v_f32mf2_mu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32mf2_mu(mask, maskedoff, base, bstride, vl);
}

vfloat32m1_t test_vlse32_v_f32m1_mu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m1_mu(mask, maskedoff, base, bstride, vl);
}

vfloat32m2_t test_vlse32_v_f32m2_mu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m2_mu(mask, maskedoff, base, bstride, vl);
}

vfloat32m4_t test_vlse32_v_f32m4_mu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse32_v_f32m4_mu(mask, maskedoff, base, bstride, vl);
}

vfloat32m8_t test_vlse32_v_f32m8_mu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, ptrdiff_t bstride, size_t vl) {
...
/* { dg-final { scan-assembler-times {vsetvli\s+zero,\s*[a-x0-9]+,\s*e[0-9]+,\s*m[f]?[1248],\s*t[au],\s*m[au]\s+vlse32\.[,\sa-x0-9()]+} 60 } } */
