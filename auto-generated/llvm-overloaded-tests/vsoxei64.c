...
void test_vsoxei64_v_f16mf4(_Float16 *base, vuint64m1_t bindex,
                            vfloat16mf4_t value, size_t vl) {
  return __riscv_vsoxei64(base, bindex, value, vl);
}

void test_vsoxei64_v_f16mf2(_Float16 *base, vuint64m2_t bindex,
                            vfloat16mf2_t value, size_t vl) {
  return __riscv_vsoxei64(base, bindex, value, vl);
}

void test_vsoxei64_v_f16m1(_Float16 *base, vuint64m4_t bindex,
                           vfloat16m1_t value, size_t vl) {
  return __riscv_vsoxei64(base, bindex, value, vl);
}

void test_vsoxei64_v_f16m2(_Float16 *base, vuint64m8_t bindex,
...
void test_vsoxei64_v_f16mf4_m(vbool64_t mask, _Float16 *base,
                              vuint64m1_t bindex, vfloat16mf4_t value,
                              size_t vl) {
  return __riscv_vsoxei64(mask, base, bindex, value, vl);
}

void test_vsoxei64_v_f16mf2_m(vbool32_t mask, _Float16 *base,
                              vuint64m2_t bindex, vfloat16mf2_t value,
                              size_t vl) {
  return __riscv_vsoxei64(mask, base, bindex, value, vl);
}

void test_vsoxei64_v_f16m1_m(vbool16_t mask, _Float16 *base, vuint64m4_t bindex,
                             vfloat16m1_t value, size_t vl) {
  return __riscv_vsoxei64(mask, base, bindex, value, vl);
}

void test_vsoxei64_v_f16m2_m(vbool8_t mask, _Float16 *base, vuint64m8_t bindex,
                             vfloat16m2_t value, size_t vl) {
  return __riscv_vsoxei64(mask, base, bindex, value, vl);
}
