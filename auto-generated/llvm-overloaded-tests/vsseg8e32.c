...
void test_vsseg8e32_v_f32mf2x8(float *base, vfloat32mf2x8_t v_tuple,
                               size_t vl) {
...
void test_vsseg8e32_v_f32mf2x8_m(vbool64_t mask, float *base,
                                 vfloat32mf2x8_t v_tuple, size_t vl) {
  return __riscv_vsseg8e32(mask, base, v_tuple, vl);
}

void test_vsseg8e32_v_f32m1x8_m(vbool32_t mask, float *base,
