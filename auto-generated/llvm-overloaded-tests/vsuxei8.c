...
void test_vsuxei8_v_f16mf4(_Float16 *base, vuint8mf8_t bindex,
                           vfloat16mf4_t value, size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}

void test_vsuxei8_v_f16mf2(_Float16 *base, vuint8mf4_t bindex,
                           vfloat16mf2_t value, size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}

void test_vsuxei8_v_f16m1(_Float16 *base, vuint8mf2_t bindex,
                          vfloat16m1_t value, size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}

void test_vsuxei8_v_f16m2(_Float16 *base, vuint8m1_t bindex, vfloat16m2_t value,
                          size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}

void test_vsuxei8_v_f16m4(_Float16 *base, vuint8m2_t bindex, vfloat16m4_t value,
                          size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}

void test_vsuxei8_v_f16m8(_Float16 *base, vuint8m4_t bindex, vfloat16m8_t value,
                          size_t vl) {
  return __riscv_vsuxei8(base, bindex, value, vl);
}
...
void test_vsuxei8_v_f16mf4_m(vbool64_t mask, _Float16 *base, vuint8mf8_t bindex,
                             vfloat16mf4_t value, size_t vl) {
  return __riscv_vsuxei8(mask, base, bindex, value, vl);
}

void test_vsuxei8_v_f16mf2_m(vbool32_t mask, _Float16 *base, vuint8mf4_t bindex,
                             vfloat16mf2_t value, size_t vl) {
  return __riscv_vsuxei8(mask, base, bindex, value, vl);
}

void test_vsuxei8_v_f16m1_m(vbool16_t mask, _Float16 *base, vuint8mf2_t bindex,
                            vfloat16m1_t value, size_t vl) {
  return __riscv_vsuxei8(mask, base, bindex, value, vl);
}

void test_vsuxei8_v_f16m2_m(vbool8_t mask, _Float16 *base, vuint8m1_t bindex,
                            vfloat16m2_t value, size_t vl) {
  return __riscv_vsuxei8(mask, base, bindex, value, vl);
}

void test_vsuxei8_v_f16m4_m(vbool4_t mask, _Float16 *base, vuint8m2_t bindex,
                            vfloat16m4_t value, size_t vl) {
  return __riscv_vsuxei8(mask, base, bindex, value, vl);
}

void test_vsuxei8_v_f16m8_m(vbool2_t mask, _Float16 *base, vuint8m4_t bindex,
