...
vbool8_t test_vmflt_vf_f16m2_b8_m(vbool8_t mask, vfloat16m2_t op1, _Float16 op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool4_t test_vmflt_vf_f16m4_b4_m(vbool4_t mask, vfloat16m4_t op1, _Float16 op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool2_t test_vmflt_vf_f16m8_b2_m(vbool2_t mask, vfloat16m8_t op1, _Float16 op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool32_t test_vmflt_vf_f32m1_b32_m(vbool32_t mask, vfloat32m1_t op1, float op2,
                                    size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool16_t test_vmflt_vf_f32m2_b16_m(vbool16_t mask, vfloat32m2_t op1, float op2,
                                    size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool8_t test_vmflt_vf_f32m4_b8_m(vbool8_t mask, vfloat32m4_t op1, float op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool4_t test_vmflt_vf_f32m8_b4_m(vbool4_t mask, vfloat32m8_t op1, float op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
...
vbool8_t test_vmflt_vf_f64m8_b8_m(vbool8_t mask, vfloat64m8_t op1, double op2,
                                  size_t vl) {
  return __riscv_vmflt(mask, op1, op2, vl);
}
