...
vfloat32mf2_t test_vfqwbdota_alt_vv_f8e4m3m1_f32mf2_rm(vfloat32mf2_t vd,
                                                       ...
                                                       vuint8m1_t vs1,
                                                       size_t ci, size_t vl) {
  return __riscv_vfqwbdota_alt_f8e4m3_f32(vd, vs2, vs1, ci, __RISCV_FRM_RNE,
                                          vl);
}
...
vfloat32mf2_t test_vfqwbdota_alt_vv_f8e5m2m1_f32mf2_rm(vfloat32mf2_t vd,
                                                       ...
                                                       vuint8m1_t vs1,
                                                       size_t ci, size_t vl) {
  return __riscv_vfqwbdota_alt_f8e5m2_f32(vd, vs2, vs1, ci, __RISCV_FRM_RNE,
                                          vl);
}
...
vfloat32mf2_t test_vfqwbdota_alt_vv_f8e4m3m1_f32mf2_rm_m(vbool64_t vm,
                                                         ...
                                                         vuint8m1_t vs1,
                                                         size_t ci, size_t vl) {
  return __riscv_vfqwbdota_alt_f8e4m3_f32(vm, vd, vs2, vs1, ci, __RISCV_FRM_RNE,
                                          vl);
}
...
vfloat32mf2_t test_vfqwbdota_alt_vv_f8e5m2m1_f32mf2_rm_m(vbool64_t vm,
                                                         ...
                                                         vuint8m1_t vs1,
                                                         size_t ci, size_t vl) {
  return __riscv_vfqwbdota_alt_f8e5m2_f32(vm, vd, vs2, vs1, ci, __RISCV_FRM_RNE,
                                          vl);
}
