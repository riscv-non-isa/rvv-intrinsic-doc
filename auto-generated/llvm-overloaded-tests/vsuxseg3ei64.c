...
void test_vsuxseg3ei64_v_f16mf4x3(_Float16 *base, vuint64m1_t bindex,
                                  vfloat16mf4x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16mf2x3(_Float16 *base, vuint64m2_t bindex,
                                  vfloat16mf2x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16m1x3(_Float16 *base, vuint64m4_t bindex,
                                 vfloat16m1x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16m2x3(_Float16 *base, vuint64m8_t bindex,
                                 vfloat16m2x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32mf2x3(float *base, vuint64m1_t bindex,
                                  vfloat32mf2x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32m1x3(float *base, vuint64m2_t bindex,
                                 vfloat32m1x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32m2x3(float *base, vuint64m4_t bindex,
                                 vfloat32m2x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f64m1x3(double *base, vuint64m1_t bindex,
                                 vfloat64m1x3_t v_tuple, size_t vl) {
  return __riscv_vsuxseg3ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f64m2x3(double *base, vuint64m2_t bindex,
...
void test_vsuxseg3ei64_v_f16mf4x3_m(vbool64_t mask, _Float16 *base,
                                    vuint64m1_t bindex, vfloat16mf4x3_t v_tuple,
                                    size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16mf2x3_m(vbool32_t mask, _Float16 *base,
                                    vuint64m2_t bindex, vfloat16mf2x3_t v_tuple,
                                    size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16m1x3_m(vbool16_t mask, _Float16 *base,
                                   vuint64m4_t bindex, vfloat16m1x3_t v_tuple,
                                   size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f16m2x3_m(vbool8_t mask, _Float16 *base,
                                   vuint64m8_t bindex, vfloat16m2x3_t v_tuple,
                                   size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32mf2x3_m(vbool64_t mask, float *base,
                                    vuint64m1_t bindex, vfloat32mf2x3_t v_tuple,
                                    size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32m1x3_m(vbool32_t mask, float *base,
                                   vuint64m2_t bindex, vfloat32m1x3_t v_tuple,
                                   size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f32m2x3_m(vbool16_t mask, float *base,
                                   vuint64m4_t bindex, vfloat32m2x3_t v_tuple,
                                   size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f64m1x3_m(vbool64_t mask, double *base,
                                   vuint64m1_t bindex, vfloat64m1x3_t v_tuple,
                                   size_t vl) {
  return __riscv_vsuxseg3ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg3ei64_v_f64m2x3_m(vbool32_t mask, double *base,
