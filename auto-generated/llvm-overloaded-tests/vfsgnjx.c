...
vfloat16mf4_t test_vfsgnjx_vf_f16mf4(vfloat16mf4_t op1, _Float16 op2,
                                     size_t vl) {
  return __riscv_vfsgnjx(op1, op2, vl);
}
...
vfloat16mf2_t test_vfsgnjx_vf_f16mf2(vfloat16mf2_t op1, _Float16 op2,
                                     size_t vl) {
  return __riscv_vfsgnjx(op1, op2, vl);
}
...
vfloat32m4_t test_vfsgnjx_vf_f32m4_m(vbool8_t mask, vfloat32m4_t op1, float op2,
                                     size_t vl) {
  return __riscv_vfsgnjx(mask, op1, op2, vl);
}
...
vfloat32m8_t test_vfsgnjx_vf_f32m8_m(vbool4_t mask, vfloat32m8_t op1, float op2,
                                     size_t vl) {
  return __riscv_vfsgnjx(mask, op1, op2, vl);
}
