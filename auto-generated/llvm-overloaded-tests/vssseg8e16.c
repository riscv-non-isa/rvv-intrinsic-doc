...
void test_vssseg8e16_v_f16mf4x8(_Float16 *base, ptrdiff_t bstride,
                                vfloat16mf4x8_t v_tuple, size_t vl) {
  return __riscv_vssseg8e16(base, bstride, v_tuple, vl);
}

void test_vssseg8e16_v_f16mf2x8(_Float16 *base, ptrdiff_t bstride,
                                vfloat16mf2x8_t v_tuple, size_t vl) {
  return __riscv_vssseg8e16(base, bstride, v_tuple, vl);
}

void test_vssseg8e16_v_f16m1x8(_Float16 *base, ptrdiff_t bstride,
...
void test_vssseg8e16_v_f16mf4x8_m(vbool64_t mask, _Float16 *base,
                                  ptrdiff_t bstride, vfloat16mf4x8_t v_tuple,
                                  size_t vl) {
  return __riscv_vssseg8e16(mask, base, bstride, v_tuple, vl);
}

void test_vssseg8e16_v_f16mf2x8_m(vbool32_t mask, _Float16 *base,
                                  ptrdiff_t bstride, vfloat16mf2x8_t v_tuple,
                                  size_t vl) {
  return __riscv_vssseg8e16(mask, base, bstride, v_tuple, vl);
}

void test_vssseg8e16_v_f16m1x8_m(vbool16_t mask, _Float16 *base,
