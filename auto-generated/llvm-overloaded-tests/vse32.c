...
void test_vse32_v_f32mf2_m(vbool64_t mask, float *base, vfloat32mf2_t value,
                           size_t vl) {
  return __riscv_vse32(mask, base, value, vl);
}

void test_vse32_v_f32m1_m(vbool32_t mask, float *base, vfloat32m1_t value,
                          size_t vl) {
  return __riscv_vse32(mask, base, value, vl);
}

void test_vse32_v_f32m2_m(vbool16_t mask, float *base, vfloat32m2_t value,
                          size_t vl) {
  return __riscv_vse32(mask, base, value, vl);
}

void test_vse32_v_f32m4_m(vbool8_t mask, float *base, vfloat32m4_t value,
                          size_t vl) {
  return __riscv_vse32(mask, base, value, vl);
}

void test_vse32_v_f32m8_m(vbool4_t mask, float *base, vfloat32m8_t value,
                          size_t vl) {
  return __riscv_vse32(mask, base, value, vl);
}
