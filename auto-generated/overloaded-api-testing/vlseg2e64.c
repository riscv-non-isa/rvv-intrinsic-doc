...
void test_vlseg2e64_v_f64m1_m(vfloat64m1_t *v0, vfloat64m1_t *v1, vbool64_t mask, vfloat64m1_t maskedoff0, vfloat64m1_t maskedoff1, const float64_t *base, size_t vl) {
  return vlseg2e64(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}

void test_vlseg2e64_v_f64m2_m(vfloat64m2_t *v0, vfloat64m2_t *v1, vbool32_t mask, vfloat64m2_t maskedoff0, vfloat64m2_t maskedoff1, const float64_t *base, size_t vl) {
  return vlseg2e64(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}

void test_vlseg2e64_v_f64m4_m(vfloat64m4_t *v0, vfloat64m4_t *v1, vbool16_t mask, vfloat64m4_t maskedoff0, vfloat64m4_t maskedoff1, const float64_t *base, size_t vl) {
  return vlseg2e64(v0, v1, mask, maskedoff0, maskedoff1, base, vl);
}
