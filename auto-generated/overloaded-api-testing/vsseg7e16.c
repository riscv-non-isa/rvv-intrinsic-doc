...
void test_vsseg7e16_v_f16mf4x7(float16_t *base, vfloat16mf4x7_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg7e16(base, v_tuple, vl);
}

void test_vsseg7e16_v_f16mf2x7(float16_t *base, vfloat16mf2x7_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg7e16(base, v_tuple, vl);
}

void test_vsseg7e16_v_f16m1x7(float16_t *base, vfloat16m1x7_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg7e16(base, v_tuple, vl);
}
...
void test_vsseg7e16_v_f16mf4x7_m(vbool64_t mask, float16_t *base,
                                 vfloat16mf4x7_t v_tuple, size_t vl) {
  return __riscv_vsseg7e16(mask, base, v_tuple, vl);
}

void test_vsseg7e16_v_f16mf2x7_m(vbool32_t mask, float16_t *base,
                                 vfloat16mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsseg7e16(mask, base, v_tuple, vl);
}

void test_vsseg7e16_v_f16m1x7_m(vbool16_t mask, float16_t *base,
