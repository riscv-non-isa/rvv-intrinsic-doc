...
void test_vssseg2e16_v_f16mf4x2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16mf4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16mf2x2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16mf2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m1x2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m1x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m2x2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m4x2_ntl_P1(float16_t *base, ptrdiff_t bstride, vfloat16m4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
void test_vssseg2e16_v_f16mf4x2_m_ntl_P1(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16mf2x2_m_ntl_P1(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m1x2_m_ntl_P1(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m2x2_m_ntl_P1(vbool8_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vssseg2e16_v_f16m4x2_m_ntl_P1(vbool4_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg2e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
