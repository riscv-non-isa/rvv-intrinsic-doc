...
void test_vse16_v_f16mf4_ntl_PALL(float16_t *base, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16mf2_ntl_PALL(float16_t *base, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m1_ntl_PALL(float16_t *base, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m2_ntl_PALL(float16_t *base, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m4_ntl_PALL(float16_t *base, vfloat16m4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m8_ntl_PALL(float16_t *base, vfloat16m8_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vse16_v_f16mf4_m_ntl_PALL(vbool64_t mask, float16_t *base, vfloat16mf4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16mf2_m_ntl_PALL(vbool32_t mask, float16_t *base, vfloat16mf2_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m1_m_ntl_PALL(vbool16_t mask, float16_t *base, vfloat16m1_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m2_m_ntl_PALL(vbool8_t mask, float16_t *base, vfloat16m2_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m4_m_ntl_PALL(vbool4_t mask, float16_t *base, vfloat16m4_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vse16_v_f16m8_m_ntl_PALL(vbool2_t mask, float16_t *base, vfloat16m8_t value, size_t vl, int domain) {
  return __riscv_vse16_ntl(mask, base, value, vl, __RISCV_NTLH_ALL_PRIVATE);
}
