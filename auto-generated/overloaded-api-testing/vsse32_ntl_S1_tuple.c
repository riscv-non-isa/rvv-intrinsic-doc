...
void test_vsse32_v_f32mf2_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m1_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32m1_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m2_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32m2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m4_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32m4_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m8_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32m8_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
...
void test_vsse32_v_f32mf2_m_ntl_S1(vbool64_t mask, float32_t *base, ptrdiff_t bstride, vfloat32mf2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m1_m_ntl_S1(vbool32_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m1_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m2_m_ntl_S1(vbool16_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m2_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m4_m_ntl_S1(vbool8_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m4_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsse32_v_f32m8_m_ntl_S1(vbool4_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m8_t value, size_t vl, int domain) {
  return __riscv_vsse32_ntl(mask, base, bstride, value, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
