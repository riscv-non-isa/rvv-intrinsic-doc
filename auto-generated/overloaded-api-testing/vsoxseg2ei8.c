...
void test_vsoxseg2ei8_v_f16mf4x2(float16_t *rs1, vuint8mf8_t vs2,
                                 vfloat16mf4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16mf2x2(float16_t *rs1, vuint8mf4_t vs2,
                                 vfloat16mf2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m1x2(float16_t *rs1, vuint8mf2_t vs2,
                                vfloat16m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m2x2(float16_t *rs1, vuint8m1_t vs2,
                                vfloat16m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m4x2(float16_t *rs1, vuint8m2_t vs2,
                                vfloat16m4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32mf2x2(float32_t *rs1, vuint8mf8_t vs2,
                                 vfloat32mf2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m1x2(float32_t *rs1, vuint8mf4_t vs2,
                                vfloat32m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m2x2(float32_t *rs1, vuint8mf2_t vs2,
                                vfloat32m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m4x2(float32_t *rs1, vuint8m1_t vs2,
                                vfloat32m4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m1x2(float64_t *rs1, vuint8mf8_t vs2,
                                vfloat64m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m2x2(float64_t *rs1, vuint8mf4_t vs2,
                                vfloat64m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m4x2(float64_t *rs1, vuint8mf2_t vs2,
...
void test_vsoxseg2ei8_v_f16mf4x2_m(vbool64_t vm, float16_t *rs1,
                                   vuint8mf8_t vs2, vfloat16mf4x2_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16mf2x2_m(vbool32_t vm, float16_t *rs1,
                                   vuint8mf4_t vs2, vfloat16mf2x2_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m1x2_m(vbool16_t vm, float16_t *rs1, vuint8mf2_t vs2,
                                  vfloat16m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m2x2_m(vbool8_t vm, float16_t *rs1, vuint8m1_t vs2,
                                  vfloat16m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f16m4x2_m(vbool4_t vm, float16_t *rs1, vuint8m2_t vs2,
                                  vfloat16m4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32mf2x2_m(vbool64_t vm, float32_t *rs1,
                                   vuint8mf8_t vs2, vfloat32mf2x2_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m1x2_m(vbool32_t vm, float32_t *rs1, vuint8mf4_t vs2,
                                  vfloat32m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m2x2_m(vbool16_t vm, float32_t *rs1, vuint8mf2_t vs2,
                                  vfloat32m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f32m4x2_m(vbool8_t vm, float32_t *rs1, vuint8m1_t vs2,
                                  vfloat32m4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m1x2_m(vbool64_t vm, float64_t *rs1, vuint8mf8_t vs2,
                                  vfloat64m1x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m2x2_m(vbool32_t vm, float64_t *rs1, vuint8mf4_t vs2,
                                  vfloat64m2x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg2ei8_v_f64m4x2_m(vbool16_t vm, float64_t *rs1, vuint8mf2_t vs2,
                                  vfloat64m4x2_t vs3, size_t vl) {
  return __riscv_vsoxseg2ei8(vm, rs1, vs2, vs3, vl);
}
