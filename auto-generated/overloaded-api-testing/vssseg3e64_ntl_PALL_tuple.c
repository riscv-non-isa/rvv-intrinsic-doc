...
void test_vssseg3e64_v_f64m1x3_ntl_PALL(float64_t *base, ptrdiff_t bstride, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg3e64_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg3e64_v_f64m2x3_ntl_PALL(float64_t *base, ptrdiff_t bstride, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg3e64_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vssseg3e64_v_f64m1x3_m_ntl_PALL(vbool64_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg3e64_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg3e64_v_f64m2x3_m_ntl_PALL(vbool32_t mask, float64_t *base, ptrdiff_t bstride, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg3e64_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
