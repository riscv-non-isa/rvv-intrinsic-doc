...
vfloat16mf4x5_t test_vluxseg5ei32_v_f16mf4x5(const float16_t *rs1,
                                             vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}

vfloat16mf2x5_t test_vluxseg5ei32_v_f16mf2x5(const float16_t *rs1,
                                             vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}

vfloat16m1x5_t test_vluxseg5ei32_v_f16m1x5(const float16_t *rs1,
                                           vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}

vfloat32mf2x5_t test_vluxseg5ei32_v_f32mf2x5(const float32_t *rs1,
                                             vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}

vfloat32m1x5_t test_vluxseg5ei32_v_f32m1x5(const float32_t *rs1,
                                           vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}

vfloat64m1x5_t test_vluxseg5ei32_v_f64m1x5(const float64_t *rs1,
                                           vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(rs1, rs2, vl);
}
...
vfloat16m1x5_t test_vluxseg5ei32_v_f16m1x5_m(vbool16_t vm, const float16_t *rs1,
                                             vuint32m2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(vm, rs1, rs2, vl);
}

vfloat32mf2x5_t test_vluxseg5ei32_v_f32mf2x5_m(vbool64_t vm,
                                               const float32_t *rs1,
                                               vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(vm, rs1, rs2, vl);
}

vfloat32m1x5_t test_vluxseg5ei32_v_f32m1x5_m(vbool32_t vm, const float32_t *rs1,
                                             vuint32m1_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(vm, rs1, rs2, vl);
}

vfloat64m1x5_t test_vluxseg5ei32_v_f64m1x5_m(vbool64_t vm, const float64_t *rs1,
                                             vuint32mf2_t rs2, size_t vl) {
  return __riscv_vluxseg5ei32(vm, rs1, rs2, vl);
}
