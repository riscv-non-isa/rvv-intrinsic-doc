...
void test_vsseg7e16_v_f16mf4x7_ntl_P1(float16_t *base, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg7e16_v_f16mf2x7_ntl_P1(float16_t *base, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg7e16_v_f16m1x7_ntl_P1(float16_t *base, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
void test_vsseg7e16_v_f16mf4x7_m_ntl_P1(vbool64_t mask, float16_t *base, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg7e16_v_f16mf2x7_m_ntl_P1(vbool32_t mask, float16_t *base, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg7e16_v_f16m1x7_m_ntl_P1(vbool16_t mask, float16_t *base, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e16_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
