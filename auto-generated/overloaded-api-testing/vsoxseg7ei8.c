...
void test_vsoxseg7ei8_v_f16mf4x7(float16_t *rs1, vuint8mf8_t vs2,
                                 vfloat16mf4x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f16mf2x7(float16_t *rs1, vuint8mf4_t vs2,
                                 vfloat16mf2x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f16m1x7(float16_t *rs1, vuint8mf2_t vs2,
                                vfloat16m1x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f32mf2x7(float32_t *rs1, vuint8mf8_t vs2,
                                 vfloat32mf2x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f32m1x7(float32_t *rs1, vuint8mf4_t vs2,
                                vfloat32m1x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f64m1x7(float64_t *rs1, vuint8mf8_t vs2,
...
void test_vsoxseg7ei8_v_f16mf4x7_m(vbool64_t vm, float16_t *rs1,
                                   vuint8mf8_t vs2, vfloat16mf4x7_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f16mf2x7_m(vbool32_t vm, float16_t *rs1,
                                   vuint8mf4_t vs2, vfloat16mf2x7_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f16m1x7_m(vbool16_t vm, float16_t *rs1, vuint8mf2_t vs2,
                                  vfloat16m1x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f32mf2x7_m(vbool64_t vm, float32_t *rs1,
                                   vuint8mf8_t vs2, vfloat32mf2x7_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f32m1x7_m(vbool32_t vm, float32_t *rs1, vuint8mf4_t vs2,
                                  vfloat32m1x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg7ei8_v_f64m1x7_m(vbool64_t vm, float64_t *rs1, vuint8mf8_t vs2,
                                  vfloat64m1x7_t vs3, size_t vl) {
  return __riscv_vsoxseg7ei8(vm, rs1, vs2, vs3, vl);
}
