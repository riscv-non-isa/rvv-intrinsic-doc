...
vfloat16mf4x2_t test_vloxseg2ei32_v_f16mf4x2_ntl_P1(const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x2_t test_vloxseg2ei32_v_f16mf2x2_ntl_P1(const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x2_t test_vloxseg2ei32_v_f16m1x2_ntl_P1(const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x2_t test_vloxseg2ei32_v_f16m2x2_ntl_P1(const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m4x2_t test_vloxseg2ei32_v_f16m4x2_ntl_P1(const float16_t *base, vuint32m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x2_t test_vloxseg2ei32_v_f32mf2x2_ntl_P1(const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x2_t test_vloxseg2ei32_v_f32m1x2_ntl_P1(const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x2_t test_vloxseg2ei32_v_f32m2x2_ntl_P1(const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4x2_t test_vloxseg2ei32_v_f32m4x2_ntl_P1(const float32_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x2_t test_vloxseg2ei32_v_f64m1x2_ntl_P1(const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x2_t test_vloxseg2ei32_v_f64m2x2_ntl_P1(const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4x2_t test_vloxseg2ei32_v_f64m4x2_ntl_P1(const float64_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4x2_t test_vloxseg2ei32_v_f16mf4x2_m_ntl_P1(vbool64_t mask, const float16_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x2_t test_vloxseg2ei32_v_f16mf2x2_m_ntl_P1(vbool32_t mask, const float16_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x2_t test_vloxseg2ei32_v_f16m1x2_m_ntl_P1(vbool16_t mask, const float16_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x2_t test_vloxseg2ei32_v_f16m2x2_m_ntl_P1(vbool8_t mask, const float16_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m4x2_t test_vloxseg2ei32_v_f16m4x2_m_ntl_P1(vbool4_t mask, const float16_t *base, vuint32m8_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x2_t test_vloxseg2ei32_v_f32mf2x2_m_ntl_P1(vbool64_t mask, const float32_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x2_t test_vloxseg2ei32_v_f32m1x2_m_ntl_P1(vbool32_t mask, const float32_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x2_t test_vloxseg2ei32_v_f32m2x2_m_ntl_P1(vbool16_t mask, const float32_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4x2_t test_vloxseg2ei32_v_f32m4x2_m_ntl_P1(vbool8_t mask, const float32_t *base, vuint32m4_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x2_t test_vloxseg2ei32_v_f64m1x2_m_ntl_P1(vbool64_t mask, const float64_t *base, vuint32mf2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x2_t test_vloxseg2ei32_v_f64m2x2_m_ntl_P1(vbool32_t mask, const float64_t *base, vuint32m1_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4x2_t test_vloxseg2ei32_v_f64m4x2_m_ntl_P1(vbool16_t mask, const float64_t *base, vuint32m2_t bindex, size_t vl, int domain) {
  return __riscv_vloxseg2ei32_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
