...
void test_vssseg6e32_v_f32mf2x6_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32mf2x6_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg6e32_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg6e32_v_f32m1x6_ntl_S1(float32_t *base, ptrdiff_t bstride, vfloat32m1x6_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg6e32_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
...
void test_vssseg6e32_v_f32mf2x6_m_ntl_S1(vbool64_t mask, float32_t *base, ptrdiff_t bstride, vfloat32mf2x6_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg6e32_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vssseg6e32_v_f32m1x6_m_ntl_S1(vbool32_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m1x6_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg6e32_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
