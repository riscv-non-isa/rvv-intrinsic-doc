...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_ntl_ALL(const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_ntl_ALL(const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_ntl_ALL(const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_ntl_ALL(const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_ntl_ALL(const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_ntl_ALL(const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_ntl_ALL(const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_ntl_ALL(const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_ntl_ALL(const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_ntl_ALL(const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_ntl_ALL(const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_ntl_ALL(const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL);
}
...
vfloat16mf4x2_t test_vluxseg2ei16_v_f16mf4x2_m_ntl_ALL(vbool64_t mask, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x2_t test_vluxseg2ei16_v_f16mf2x2_m_ntl_ALL(vbool32_t mask, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x2_t test_vluxseg2ei16_v_f16m1x2_m_ntl_ALL(vbool16_t mask, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m2x2_t test_vluxseg2ei16_v_f16m2x2_m_ntl_ALL(vbool8_t mask, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat16m4x2_t test_vluxseg2ei16_v_f16m4x2_m_ntl_ALL(vbool4_t mask, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32mf2x2_t test_vluxseg2ei16_v_f32mf2x2_m_ntl_ALL(vbool64_t mask, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m1x2_t test_vluxseg2ei16_v_f32m1x2_m_ntl_ALL(vbool32_t mask, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m2x2_t test_vluxseg2ei16_v_f32m2x2_m_ntl_ALL(vbool16_t mask, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat32m4x2_t test_vluxseg2ei16_v_f32m4x2_m_ntl_ALL(vbool8_t mask, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m1x2_t test_vluxseg2ei16_v_f64m1x2_m_ntl_ALL(vbool64_t mask, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m2x2_t test_vluxseg2ei16_v_f64m2x2_m_ntl_ALL(vbool32_t mask, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}

vfloat64m4x2_t test_vluxseg2ei16_v_f64m4x2_m_ntl_ALL(vbool16_t mask, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg2ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL);
}
