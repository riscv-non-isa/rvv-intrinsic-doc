...
void test_vsseg3e64_v_f64m1x3_ntl_P1(float64_t *base, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e64_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg3e64_v_f64m2x3_ntl_P1(float64_t *base, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e64_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
void test_vsseg3e64_v_f64m1x3_m_ntl_P1(vbool64_t mask, float64_t *base, vfloat64m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e64_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsseg3e64_v_f64m2x3_m_ntl_P1(vbool32_t mask, float64_t *base, vfloat64m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e64_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
