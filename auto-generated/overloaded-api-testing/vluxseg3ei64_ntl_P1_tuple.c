...
vfloat16mf4x3_t test_vluxseg3ei64_v_f16mf4x3_ntl_P1(const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x3_t test_vluxseg3ei64_v_f16mf2x3_ntl_P1(const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x3_t test_vluxseg3ei64_v_f16m1x3_ntl_P1(const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x3_t test_vluxseg3ei64_v_f16m2x3_ntl_P1(const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x3_t test_vluxseg3ei64_v_f32mf2x3_ntl_P1(const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x3_t test_vluxseg3ei64_v_f32m1x3_ntl_P1(const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x3_t test_vluxseg3ei64_v_f32m2x3_ntl_P1(const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x3_t test_vluxseg3ei64_v_f64m1x3_ntl_P1(const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x3_t test_vluxseg3ei64_v_f64m2x3_ntl_P1(const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4x3_t test_vluxseg3ei64_v_f16mf4x3_m_ntl_P1(vbool64_t mask, const float16_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2x3_t test_vluxseg3ei64_v_f16mf2x3_m_ntl_P1(vbool32_t mask, const float16_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1x3_t test_vluxseg3ei64_v_f16m1x3_m_ntl_P1(vbool16_t mask, const float16_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2x3_t test_vluxseg3ei64_v_f16m2x3_m_ntl_P1(vbool8_t mask, const float16_t *base, vuint64m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2x3_t test_vluxseg3ei64_v_f32mf2x3_m_ntl_P1(vbool64_t mask, const float32_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1x3_t test_vluxseg3ei64_v_f32m1x3_m_ntl_P1(vbool32_t mask, const float32_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2x3_t test_vluxseg3ei64_v_f32m2x3_m_ntl_P1(vbool16_t mask, const float32_t *base, vuint64m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1x3_t test_vluxseg3ei64_v_f64m1x3_m_ntl_P1(vbool64_t mask, const float64_t *base, vuint64m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2x3_t test_vluxseg3ei64_v_f64m2x3_m_ntl_P1(vbool32_t mask, const float64_t *base, vuint64m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg3ei64_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
