...
void test_vssseg3e64_v_f64m1x3(float64_t *base, ptrdiff_t bstride,
                               vfloat64m1x3_t v_tuple, size_t vl) {
  return __riscv_vssseg3e64(base, bstride, v_tuple, vl);
}

void test_vssseg3e64_v_f64m2x3(float64_t *base, ptrdiff_t bstride,
...
void test_vssseg3e64_v_f64m1x3_m(vbool64_t mask, float64_t *base,
                                 ptrdiff_t bstride, vfloat64m1x3_t v_tuple,
                                 size_t vl) {
  return __riscv_vssseg3e64(mask, base, bstride, v_tuple, vl);
}

void test_vssseg3e64_v_f64m2x3_m(vbool32_t mask, float64_t *base,
