...
void test_vssseg3e64_v_f64m1x3(float64_t *rs1, ptrdiff_t rs2,
                               vfloat64m1x3_t vs3, size_t vl) {
  return __riscv_vssseg3e64(rs1, rs2, vs3, vl);
}

void test_vssseg3e64_v_f64m2x3(float64_t *rs1, ptrdiff_t rs2,
...
void test_vssseg3e64_v_f64m1x3_m(vbool64_t vm, float64_t *rs1, ptrdiff_t rs2,
                                 vfloat64m1x3_t vs3, size_t vl) {
  return __riscv_vssseg3e64(vm, rs1, rs2, vs3, vl);
}

void test_vssseg3e64_v_f64m2x3_m(vbool32_t vm, float64_t *rs1, ptrdiff_t rs2,
                                 vfloat64m2x3_t vs3, size_t vl) {
  return __riscv_vssseg3e64(vm, rs1, rs2, vs3, vl);
}
