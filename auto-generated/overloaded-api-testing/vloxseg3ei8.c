...
vfloat16mf4x3_t test_vloxseg3ei8_v_f16mf4x3(const float16_t *base,
                                            vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat16mf2x3_t test_vloxseg3ei8_v_f16mf2x3(const float16_t *base,
                                            vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat16m1x3_t test_vloxseg3ei8_v_f16m1x3(const float16_t *base,
                                          vuint8mf2_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat16m2x3_t test_vloxseg3ei8_v_f16m2x3(const float16_t *base,
                                          vuint8m1_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat32mf2x3_t test_vloxseg3ei8_v_f32mf2x3(const float32_t *base,
                                            vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat32m1x3_t test_vloxseg3ei8_v_f32m1x3(const float32_t *base,
                                          vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat32m2x3_t test_vloxseg3ei8_v_f32m2x3(const float32_t *base,
                                          vuint8mf2_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat64m1x3_t test_vloxseg3ei8_v_f64m1x3(const float64_t *base,
                                          vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}

vfloat64m2x3_t test_vloxseg3ei8_v_f64m2x3(const float64_t *base,
                                          vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(base, bindex, vl);
}
...
vfloat16m2x3_t test_vloxseg3ei8_v_f16m2x3_m(vbool8_t mask,
                                            const float16_t *base,
                                            vuint8m1_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}

vfloat32mf2x3_t test_vloxseg3ei8_v_f32mf2x3_m(vbool64_t mask,
                                              const float32_t *base,
                                              vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}

vfloat32m1x3_t test_vloxseg3ei8_v_f32m1x3_m(vbool32_t mask,
                                            const float32_t *base,
                                            vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}

vfloat32m2x3_t test_vloxseg3ei8_v_f32m2x3_m(vbool16_t mask,
                                            const float32_t *base,
                                            vuint8mf2_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}

vfloat64m1x3_t test_vloxseg3ei8_v_f64m1x3_m(vbool64_t mask,
                                            const float64_t *base,
                                            vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}

vfloat64m2x3_t test_vloxseg3ei8_v_f64m2x3_m(vbool32_t mask,
                                            const float64_t *base,
                                            vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg3ei8(mask, base, bindex, vl);
}
