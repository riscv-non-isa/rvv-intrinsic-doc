...
void test_vsuxseg7ei8_v_f16mf4x7_ntl_P1(float16_t *base, vuint8mf8_t bindex, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f16mf2x7_ntl_P1(float16_t *base, vuint8mf4_t bindex, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f16m1x7_ntl_P1(float16_t *base, vuint8mf2_t bindex, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f32mf2x7_ntl_P1(float32_t *base, vuint8mf8_t bindex, vfloat32mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f32m1x7_ntl_P1(float32_t *base, vuint8mf4_t bindex, vfloat32m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f64m1x7_ntl_P1(float64_t *base, vuint8mf8_t bindex, vfloat64m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
void test_vsuxseg7ei8_v_f16mf4x7_m_ntl_P1(vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f16mf2x7_m_ntl_P1(vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f16m1x7_m_ntl_P1(vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f32mf2x7_m_ntl_P1(vbool64_t mask, float32_t *base, vuint8mf8_t bindex, vfloat32mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f32m1x7_m_ntl_P1(vbool32_t mask, float32_t *base, vuint8mf4_t bindex, vfloat32m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

void test_vsuxseg7ei8_v_f64m1x7_m_ntl_P1(vbool64_t mask, float64_t *base, vuint8mf8_t bindex, vfloat64m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsuxseg7ei8_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
