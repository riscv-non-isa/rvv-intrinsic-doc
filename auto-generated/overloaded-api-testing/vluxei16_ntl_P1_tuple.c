...
vfloat16mf4_t test_vluxei16_v_f16mf4_ntl_P1(const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vluxei16_v_f16mf2_ntl_P1(const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vluxei16_v_f16m1_ntl_P1(const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vluxei16_v_f16m2_ntl_P1(const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m4_t test_vluxei16_v_f16m4_ntl_P1(const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m8_t test_vluxei16_v_f16m8_ntl_P1(const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vluxei16_v_f32mf2_ntl_P1(const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vluxei16_v_f32m1_ntl_P1(const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vluxei16_v_f32m2_ntl_P1(const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vluxei16_v_f32m4_ntl_P1(const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m8_t test_vluxei16_v_f32m8_ntl_P1(const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vluxei16_v_f64m1_ntl_P1(const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vluxei16_v_f64m2_ntl_P1(const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vluxei16_v_f64m4_ntl_P1(const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vluxei16_v_f64m8_ntl_P1(const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
...
vfloat16mf4_t test_vluxei16_v_f16mf4_m_ntl_P1(vbool64_t mask, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16mf2_t test_vluxei16_v_f16mf2_m_ntl_P1(vbool32_t mask, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m1_t test_vluxei16_v_f16m1_m_ntl_P1(vbool16_t mask, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m2_t test_vluxei16_v_f16m2_m_ntl_P1(vbool8_t mask, const float16_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m4_t test_vluxei16_v_f16m4_m_ntl_P1(vbool4_t mask, const float16_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat16m8_t test_vluxei16_v_f16m8_m_ntl_P1(vbool2_t mask, const float16_t *base, vuint16m8_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32mf2_t test_vluxei16_v_f32mf2_m_ntl_P1(vbool64_t mask, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m1_t test_vluxei16_v_f32m1_m_ntl_P1(vbool32_t mask, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m2_t test_vluxei16_v_f32m2_m_ntl_P1(vbool16_t mask, const float32_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m4_t test_vluxei16_v_f32m4_m_ntl_P1(vbool8_t mask, const float32_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat32m8_t test_vluxei16_v_f32m8_m_ntl_P1(vbool4_t mask, const float32_t *base, vuint16m4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m1_t test_vluxei16_v_f64m1_m_ntl_P1(vbool64_t mask, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m2_t test_vluxei16_v_f64m2_m_ntl_P1(vbool32_t mask, const float64_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m4_t test_vluxei16_v_f64m4_m_ntl_P1(vbool16_t mask, const float64_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}

vfloat64m8_t test_vluxei16_v_f64m8_m_ntl_P1(vbool8_t mask, const float64_t *base, vuint16m2_t bindex, size_t vl, int domain) {
  return __riscv_vluxei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_INNERMOST_PRIVATE);
}
