...
vfloat16mf4x7_t test_vluxseg7ei16_v_f16mf4x7_ntl_PALL(const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x7_t test_vluxseg7ei16_v_f16mf2x7_ntl_PALL(const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x7_t test_vluxseg7ei16_v_f16m1x7_ntl_PALL(const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x7_t test_vluxseg7ei16_v_f32mf2x7_ntl_PALL(const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x7_t test_vluxseg7ei16_v_f32m1x7_ntl_PALL(const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x7_t test_vluxseg7ei16_v_f64m1x7_ntl_PALL(const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
vfloat16mf4x7_t test_vluxseg7ei16_v_f16mf4x7_m_ntl_PALL(vbool64_t mask, const float16_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x7_t test_vluxseg7ei16_v_f16mf2x7_m_ntl_PALL(vbool32_t mask, const float16_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x7_t test_vluxseg7ei16_v_f16m1x7_m_ntl_PALL(vbool16_t mask, const float16_t *base, vuint16m1_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32mf2x7_t test_vluxseg7ei16_v_f32mf2x7_m_ntl_PALL(vbool64_t mask, const float32_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x7_t test_vluxseg7ei16_v_f32m1x7_m_ntl_PALL(vbool32_t mask, const float32_t *base, vuint16mf2_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat64m1x7_t test_vluxseg7ei16_v_f64m1x7_m_ntl_PALL(vbool64_t mask, const float64_t *base, vuint16mf4_t bindex, size_t vl, int domain) {
  return __riscv_vluxseg7ei16_ntl(mask, base, bindex, vl, __RISCV_NTLH_ALL_PRIVATE);
}
