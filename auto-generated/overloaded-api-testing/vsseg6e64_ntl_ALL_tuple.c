...
void test_vsseg6e64_v_f64m1x6_ntl_ALL(float64_t *base, vfloat64m1x6_t v_tuple, size_t vl, int domain) {
...
void test_vsseg6e64_v_f64m1x6_m_ntl_ALL(vbool64_t mask, float64_t *base, vfloat64m1x6_t v_tuple, size_t vl, int domain) {
