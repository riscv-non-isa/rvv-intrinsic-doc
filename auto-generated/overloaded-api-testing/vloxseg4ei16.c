...
vfloat16mf4x4_t test_vloxseg4ei16_v_f16mf4x4(const float16_t *rs1,
                                             vuint16mf4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat16mf2x4_t test_vloxseg4ei16_v_f16mf2x4(const float16_t *rs1,
                                             vuint16mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4(const float16_t *rs1,
                                           vuint16m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4(const float16_t *rs1,
                                           vuint16m2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4(const float32_t *rs1,
                                             vuint16mf4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4(const float32_t *rs1,
                                           vuint16mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4(const float32_t *rs1,
                                           vuint16m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4(const float64_t *rs1,
                                           vuint16mf4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4(const float64_t *rs1,
                                           vuint16mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(rs1, rs2, vl);
}
...
vfloat16m1x4_t test_vloxseg4ei16_v_f16m1x4_m(vbool16_t vm, const float16_t *rs1,
                                             vuint16m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat16m2x4_t test_vloxseg4ei16_v_f16m2x4_m(vbool8_t vm, const float16_t *rs1,
                                             vuint16m2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat32mf2x4_t test_vloxseg4ei16_v_f32mf2x4_m(vbool64_t vm,
                                               const float32_t *rs1,
                                               vuint16mf4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat32m1x4_t test_vloxseg4ei16_v_f32m1x4_m(vbool32_t vm, const float32_t *rs1,
                                             vuint16mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat32m2x4_t test_vloxseg4ei16_v_f32m2x4_m(vbool16_t vm, const float32_t *rs1,
                                             vuint16m1_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat64m1x4_t test_vloxseg4ei16_v_f64m1x4_m(vbool64_t vm, const float64_t *rs1,
                                             vuint16mf4_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}

vfloat64m2x4_t test_vloxseg4ei16_v_f64m2x4_m(vbool32_t vm, const float64_t *rs1,
                                             vuint16mf2_t rs2, size_t vl) {
  return __riscv_vloxseg4ei16(vm, rs1, rs2, vl);
}
