...
void test_vsseg7e64_v_f64m1x7_ntl_S1(float64_t *base, vfloat64m1x7_t v_tuple, size_t vl, int domain) {
...
void test_vsseg7e64_v_f64m1x7_m_ntl_S1(vbool64_t mask, float64_t *base, vfloat64m1x7_t v_tuple, size_t vl, int domain) {
