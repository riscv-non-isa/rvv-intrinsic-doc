...
void test_vsoxseg8ei16_v_f16mf4x8_ntl_ALL(float16_t *base, vuint16mf4_t bindex, vfloat16mf4x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f16mf2x8_ntl_ALL(float16_t *base, vuint16mf2_t bindex, vfloat16mf2x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f16m1x8_ntl_ALL(float16_t *base, vuint16m1_t bindex, vfloat16m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f32mf2x8_ntl_ALL(float32_t *base, vuint16mf4_t bindex, vfloat32mf2x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f32m1x8_ntl_ALL(float32_t *base, vuint16mf2_t bindex, vfloat32m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f64m1x8_ntl_ALL(float64_t *base, vuint16mf4_t bindex, vfloat64m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}
...
void test_vsoxseg8ei16_v_f16mf4x8_m_ntl_ALL(vbool64_t mask, float16_t *base, vuint16mf4_t bindex, vfloat16mf4x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f16mf2x8_m_ntl_ALL(vbool32_t mask, float16_t *base, vuint16mf2_t bindex, vfloat16mf2x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f16m1x8_m_ntl_ALL(vbool16_t mask, float16_t *base, vuint16m1_t bindex, vfloat16m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f32mf2x8_m_ntl_ALL(vbool64_t mask, float32_t *base, vuint16mf4_t bindex, vfloat32mf2x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f32m1x8_m_ntl_ALL(vbool32_t mask, float32_t *base, vuint16mf2_t bindex, vfloat32m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg8ei16_v_f64m1x8_m_ntl_ALL(vbool64_t mask, float64_t *base, vuint16mf4_t bindex, vfloat64m1x8_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg8ei16_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}
