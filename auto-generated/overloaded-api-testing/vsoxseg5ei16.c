...
void test_vsoxseg5ei16_v_f16mf4x5(float16_t *rs1, vuint16mf4_t vs2,
                                  vfloat16mf4x5_t vs3, size_t vl) {
  return __riscv_vsoxseg5ei16(rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f16mf2x5(float16_t *rs1, vuint16mf2_t vs2,
                                  vfloat16mf2x5_t vs3, size_t vl) {
  return __riscv_vsoxseg5ei16(rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f16m1x5(float16_t *rs1, vuint16m1_t vs2,
                                 vfloat16m1x5_t vs3, size_t vl) {
  return __riscv_vsoxseg5ei16(rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f32mf2x5(float32_t *rs1, vuint16mf4_t vs2,
                                  vfloat32mf2x5_t vs3, size_t vl) {
  return __riscv_vsoxseg5ei16(rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f32m1x5(float32_t *rs1, vuint16mf2_t vs2,
                                 vfloat32m1x5_t vs3, size_t vl) {
  return __riscv_vsoxseg5ei16(rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f64m1x5(float64_t *rs1, vuint16mf4_t vs2,
...
void test_vsoxseg5ei16_v_f16mf4x5_m(vbool64_t vm, float16_t *rs1,
                                    vuint16mf4_t vs2, vfloat16mf4x5_t vs3,
                                    size_t vl) {
  return __riscv_vsoxseg5ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f16mf2x5_m(vbool32_t vm, float16_t *rs1,
                                    vuint16mf2_t vs2, vfloat16mf2x5_t vs3,
                                    size_t vl) {
  return __riscv_vsoxseg5ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f16m1x5_m(vbool16_t vm, float16_t *rs1,
                                   vuint16m1_t vs2, vfloat16m1x5_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg5ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f32mf2x5_m(vbool64_t vm, float32_t *rs1,
                                    vuint16mf4_t vs2, vfloat32mf2x5_t vs3,
                                    size_t vl) {
  return __riscv_vsoxseg5ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f32m1x5_m(vbool32_t vm, float32_t *rs1,
                                   vuint16mf2_t vs2, vfloat32m1x5_t vs3,
                                   size_t vl) {
  return __riscv_vsoxseg5ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsoxseg5ei16_v_f64m1x5_m(vbool64_t vm, float64_t *rs1,
