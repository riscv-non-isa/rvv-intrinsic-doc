...
void test_vsuxseg6ei64_v_f16mf4x6(float16_t *base, vuint64m1_t bindex, vfloat16mf4x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f16mf2x6(float16_t *base, vuint64m2_t bindex, vfloat16mf2x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f16m1x6(float16_t *base, vuint64m4_t bindex, vfloat16m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f32mf2x6(float32_t *base, vuint64m1_t bindex, vfloat32mf2x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f32m1x6(float32_t *base, vuint64m2_t bindex, vfloat32m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f64m1x6(float64_t *base, vuint64m1_t bindex, vfloat64m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(base, bindex, v_tuple, vl);
}
...
void test_vsuxseg6ei64_v_f16mf4x6_m(vbool64_t mask, float16_t *base, vuint64m1_t bindex, vfloat16mf4x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f16mf2x6_m(vbool32_t mask, float16_t *base, vuint64m2_t bindex, vfloat16mf2x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f16m1x6_m(vbool16_t mask, float16_t *base, vuint64m4_t bindex, vfloat16m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f32mf2x6_m(vbool64_t mask, float32_t *base, vuint64m1_t bindex, vfloat32mf2x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f32m1x6_m(vbool32_t mask, float32_t *base, vuint64m2_t bindex, vfloat32m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg6ei64_v_f64m1x6_m(vbool64_t mask, float64_t *base, vuint64m1_t bindex, vfloat64m1x6_t v_tuple, size_t vl) {
  return __riscv_vsuxseg6ei64(mask, base, bindex, v_tuple, vl);
}
