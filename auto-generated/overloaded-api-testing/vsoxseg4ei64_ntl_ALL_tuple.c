...
void test_vsoxseg4ei64_v_f16mf4x4_ntl_ALL(float16_t *base, vuint64m1_t bindex, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16mf2x4_ntl_ALL(float16_t *base, vuint64m2_t bindex, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16m1x4_ntl_ALL(float16_t *base, vuint64m4_t bindex, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16m2x4_ntl_ALL(float16_t *base, vuint64m8_t bindex, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32mf2x4_ntl_ALL(float32_t *base, vuint64m1_t bindex, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32m1x4_ntl_ALL(float32_t *base, vuint64m2_t bindex, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32m2x4_ntl_ALL(float32_t *base, vuint64m4_t bindex, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f64m1x4_ntl_ALL(float64_t *base, vuint64m1_t bindex, vfloat64m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f64m2x4_ntl_ALL(float64_t *base, vuint64m2_t bindex, vfloat64m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}
...
void test_vsoxseg4ei64_v_f16mf4x4_m_ntl_ALL(vbool64_t mask, float16_t *base, vuint64m1_t bindex, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16mf2x4_m_ntl_ALL(vbool32_t mask, float16_t *base, vuint64m2_t bindex, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16m1x4_m_ntl_ALL(vbool16_t mask, float16_t *base, vuint64m4_t bindex, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f16m2x4_m_ntl_ALL(vbool8_t mask, float16_t *base, vuint64m8_t bindex, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32mf2x4_m_ntl_ALL(vbool64_t mask, float32_t *base, vuint64m1_t bindex, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32m1x4_m_ntl_ALL(vbool32_t mask, float32_t *base, vuint64m2_t bindex, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f32m2x4_m_ntl_ALL(vbool16_t mask, float32_t *base, vuint64m4_t bindex, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f64m1x4_m_ntl_ALL(vbool64_t mask, float64_t *base, vuint64m1_t bindex, vfloat64m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsoxseg4ei64_v_f64m2x4_m_ntl_ALL(vbool32_t mask, float64_t *base, vuint64m2_t bindex, vfloat64m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei64_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL);
}
