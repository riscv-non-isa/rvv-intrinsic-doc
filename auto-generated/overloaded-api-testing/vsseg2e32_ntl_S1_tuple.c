...
void test_vsseg2e32_v_f32mf2x2_ntl_S1(float32_t *base, vfloat32mf2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m1x2_ntl_S1(float32_t *base, vfloat32m1x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m2x2_ntl_S1(float32_t *base, vfloat32m2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m4x2_ntl_S1(float32_t *base, vfloat32m4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
...
void test_vsseg2e32_v_f32mf2x2_m_ntl_S1(vbool64_t mask, float32_t *base, vfloat32mf2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m1x2_m_ntl_S1(vbool32_t mask, float32_t *base, vfloat32m1x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m2x2_m_ntl_S1(vbool16_t mask, float32_t *base, vfloat32m2x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}

void test_vsseg2e32_v_f32m4x2_m_ntl_S1(vbool8_t mask, float32_t *base, vfloat32m4x2_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg2e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_INNERMOST_SHARED);
}
