...
void test_vsuxseg3ei8_v_f16mf4x3(float16_t *rs1, vuint8mf8_t vs2,
                                 vfloat16mf4x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16mf2x3(float16_t *rs1, vuint8mf4_t vs2,
                                 vfloat16mf2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16m1x3(float16_t *rs1, vuint8mf2_t vs2,
                                vfloat16m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16m2x3(float16_t *rs1, vuint8m1_t vs2,
                                vfloat16m2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32mf2x3(float32_t *rs1, vuint8mf8_t vs2,
                                 vfloat32mf2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32m1x3(float32_t *rs1, vuint8mf4_t vs2,
                                vfloat32m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32m2x3(float32_t *rs1, vuint8mf2_t vs2,
                                vfloat32m2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f64m1x3(float64_t *rs1, vuint8mf8_t vs2,
                                vfloat64m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f64m2x3(float64_t *rs1, vuint8mf4_t vs2,
...
void test_vsuxseg3ei8_v_f16mf4x3_m(vbool64_t vm, float16_t *rs1,
                                   vuint8mf8_t vs2, vfloat16mf4x3_t vs3,
                                   size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16mf2x3_m(vbool32_t vm, float16_t *rs1,
                                   vuint8mf4_t vs2, vfloat16mf2x3_t vs3,
                                   size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16m1x3_m(vbool16_t vm, float16_t *rs1, vuint8mf2_t vs2,
                                  vfloat16m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f16m2x3_m(vbool8_t vm, float16_t *rs1, vuint8m1_t vs2,
                                  vfloat16m2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32mf2x3_m(vbool64_t vm, float32_t *rs1,
                                   vuint8mf8_t vs2, vfloat32mf2x3_t vs3,
                                   size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32m1x3_m(vbool32_t vm, float32_t *rs1, vuint8mf4_t vs2,
                                  vfloat32m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f32m2x3_m(vbool16_t vm, float32_t *rs1, vuint8mf2_t vs2,
                                  vfloat32m2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f64m1x3_m(vbool64_t vm, float64_t *rs1, vuint8mf8_t vs2,
                                  vfloat64m1x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg3ei8_v_f64m2x3_m(vbool32_t vm, float64_t *rs1, vuint8mf4_t vs2,
                                  vfloat64m2x3_t vs3, size_t vl) {
  return __riscv_vsuxseg3ei8(vm, rs1, vs2, vs3, vl);
}
