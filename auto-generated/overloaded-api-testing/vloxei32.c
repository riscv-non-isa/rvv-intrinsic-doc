...
vfloat32mf2_t test_vloxei32_v_f32mf2(const float32_t *rs1, vuint32mf2_t rs2,
                                     size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1(const float32_t *rs1, vuint32m1_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2(const float32_t *rs1, vuint32m2_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4(const float32_t *rs1, vuint32m4_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8(const float32_t *rs1, vuint32m8_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1(const float64_t *rs1, vuint32mf2_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2(const float64_t *rs1, vuint32m1_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4(const float64_t *rs1, vuint32m2_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8(const float64_t *rs1, vuint32m4_t rs2,
                                   size_t vl) {
  return __riscv_vloxei32(rs1, rs2, vl);
}
...
vfloat32mf2_t test_vloxei32_v_f32mf2_m(vbool64_t vm, const float32_t *rs1,
                                       vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_m(vbool32_t vm, const float32_t *rs1,
                                     vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_m(vbool16_t vm, const float32_t *rs1,
                                     vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_m(vbool8_t vm, const float32_t *rs1,
                                     vuint32m4_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_m(vbool4_t vm, const float32_t *rs1,
                                     vuint32m8_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_m(vbool64_t vm, const float64_t *rs1,
                                     vuint32mf2_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_m(vbool32_t vm, const float64_t *rs1,
                                     vuint32m1_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_m(vbool16_t vm, const float64_t *rs1,
                                     vuint32m2_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_m(vbool8_t vm, const float64_t *rs1,
                                     vuint32m4_t rs2, size_t vl) {
  return __riscv_vloxei32(vm, rs1, rs2, vl);
}
