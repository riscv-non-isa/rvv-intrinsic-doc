...
void test_vssseg4e32_v_f32mf2x4_ntl_PALL(float32_t *base, ptrdiff_t bstride, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg4e32_v_f32m1x4_ntl_PALL(float32_t *base, ptrdiff_t bstride, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg4e32_v_f32m2x4_ntl_PALL(float32_t *base, ptrdiff_t bstride, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vssseg4e32_v_f32mf2x4_m_ntl_PALL(vbool64_t mask, float32_t *base, ptrdiff_t bstride, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg4e32_v_f32m1x4_m_ntl_PALL(vbool32_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg4e32_v_f32m2x4_m_ntl_PALL(vbool16_t mask, float32_t *base, ptrdiff_t bstride, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg4e32_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
