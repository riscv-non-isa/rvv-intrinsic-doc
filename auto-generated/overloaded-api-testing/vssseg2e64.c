...
void test_vssseg2e64_v_f64m1x2(float64_t *base, ptrdiff_t bstride,
                               vfloat64m1x2_t v_tuple, size_t vl) {
  return __riscv_vssseg2e64(base, bstride, v_tuple, vl);
}

void test_vssseg2e64_v_f64m2x2(float64_t *base, ptrdiff_t bstride,
                               vfloat64m2x2_t v_tuple, size_t vl) {
  return __riscv_vssseg2e64(base, bstride, v_tuple, vl);
}

void test_vssseg2e64_v_f64m4x2(float64_t *base, ptrdiff_t bstride,
...
void test_vssseg2e64_v_f64m1x2_m(vbool64_t mask, float64_t *base,
                                 ptrdiff_t bstride, vfloat64m1x2_t v_tuple,
                                 size_t vl) {
  return __riscv_vssseg2e64(mask, base, bstride, v_tuple, vl);
}

void test_vssseg2e64_v_f64m2x2_m(vbool32_t mask, float64_t *base,
                                 ptrdiff_t bstride, vfloat64m2x2_t v_tuple,
                                 size_t vl) {
  return __riscv_vssseg2e64(mask, base, bstride, v_tuple, vl);
}

void test_vssseg2e64_v_f64m4x2_m(vbool16_t mask, float64_t *base,
