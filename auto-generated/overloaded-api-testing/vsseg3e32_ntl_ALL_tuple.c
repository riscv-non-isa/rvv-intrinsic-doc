...
void test_vsseg3e32_v_f32mf2x3_ntl_ALL(float32_t *base, vfloat32mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg3e32_v_f32m1x3_ntl_ALL(float32_t *base, vfloat32m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg3e32_v_f32m2x3_ntl_ALL(float32_t *base, vfloat32m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL);
}
...
void test_vsseg3e32_v_f32mf2x3_m_ntl_ALL(vbool64_t mask, float32_t *base, vfloat32mf2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg3e32_v_f32m1x3_m_ntl_ALL(vbool32_t mask, float32_t *base, vfloat32m1x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL);
}

void test_vsseg3e32_v_f32m2x3_m_ntl_ALL(vbool16_t mask, float32_t *base, vfloat32m2x3_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg3e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL);
}
