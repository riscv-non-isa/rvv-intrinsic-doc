...
void test_vsoxseg4ei32_v_f16mf4x4_ntl_PALL(float16_t *base, vuint32mf2_t bindex, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16mf2x4_ntl_PALL(float16_t *base, vuint32m1_t bindex, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16m1x4_ntl_PALL(float16_t *base, vuint32m2_t bindex, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16m2x4_ntl_PALL(float16_t *base, vuint32m4_t bindex, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32mf2x4_ntl_PALL(float32_t *base, vuint32mf2_t bindex, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32m1x4_ntl_PALL(float32_t *base, vuint32m1_t bindex, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32m2x4_ntl_PALL(float32_t *base, vuint32m2_t bindex, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f64m1x4_ntl_PALL(float64_t *base, vuint32mf2_t bindex, vfloat64m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f64m2x4_ntl_PALL(float64_t *base, vuint32m1_t bindex, vfloat64m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vsoxseg4ei32_v_f16mf4x4_m_ntl_PALL(vbool64_t mask, float16_t *base, vuint32mf2_t bindex, vfloat16mf4x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16mf2x4_m_ntl_PALL(vbool32_t mask, float16_t *base, vuint32m1_t bindex, vfloat16mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16m1x4_m_ntl_PALL(vbool16_t mask, float16_t *base, vuint32m2_t bindex, vfloat16m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f16m2x4_m_ntl_PALL(vbool8_t mask, float16_t *base, vuint32m4_t bindex, vfloat16m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32mf2x4_m_ntl_PALL(vbool64_t mask, float32_t *base, vuint32mf2_t bindex, vfloat32mf2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32m1x4_m_ntl_PALL(vbool32_t mask, float32_t *base, vuint32m1_t bindex, vfloat32m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f32m2x4_m_ntl_PALL(vbool16_t mask, float32_t *base, vuint32m2_t bindex, vfloat32m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f64m1x4_m_ntl_PALL(vbool64_t mask, float64_t *base, vuint32mf2_t bindex, vfloat64m1x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsoxseg4ei32_v_f64m2x4_m_ntl_PALL(vbool32_t mask, float64_t *base, vuint32m1_t bindex, vfloat64m2x4_t v_tuple, size_t vl, int domain) {
  return __riscv_vsoxseg4ei32_ntl(mask, base, bindex, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
