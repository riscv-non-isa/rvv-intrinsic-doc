...
void test_vssseg7e16_v_f16mf4x7_ntl_PALL(float16_t *base, ptrdiff_t bstride, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg7e16_v_f16mf2x7_ntl_PALL(float16_t *base, ptrdiff_t bstride, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg7e16_v_f16m1x7_ntl_PALL(float16_t *base, ptrdiff_t bstride, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vssseg7e16_v_f16mf4x7_m_ntl_PALL(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg7e16_v_f16mf2x7_m_ntl_PALL(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vssseg7e16_v_f16m1x7_m_ntl_PALL(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vssseg7e16_ntl(mask, base, bstride, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
