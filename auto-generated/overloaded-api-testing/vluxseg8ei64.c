...
vfloat16mf4x8_t test_vluxseg8ei64_v_f16mf4x8(const float16_t *rs1,
                                             vuint64m1_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}

vfloat16mf2x8_t test_vluxseg8ei64_v_f16mf2x8(const float16_t *rs1,
                                             vuint64m2_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}

vfloat16m1x8_t test_vluxseg8ei64_v_f16m1x8(const float16_t *rs1,
                                           vuint64m4_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}

vfloat32mf2x8_t test_vluxseg8ei64_v_f32mf2x8(const float32_t *rs1,
                                             vuint64m1_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}

vfloat32m1x8_t test_vluxseg8ei64_v_f32m1x8(const float32_t *rs1,
                                           vuint64m2_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}

vfloat64m1x8_t test_vluxseg8ei64_v_f64m1x8(const float64_t *rs1,
                                           vuint64m1_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(rs1, rs2, vl);
}
...
vfloat16m1x8_t test_vluxseg8ei64_v_f16m1x8_m(vbool16_t vm, const float16_t *rs1,
                                             vuint64m4_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(vm, rs1, rs2, vl);
}

vfloat32mf2x8_t test_vluxseg8ei64_v_f32mf2x8_m(vbool64_t vm,
                                               const float32_t *rs1,
                                               vuint64m1_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(vm, rs1, rs2, vl);
}

vfloat32m1x8_t test_vluxseg8ei64_v_f32m1x8_m(vbool32_t vm, const float32_t *rs1,
                                             vuint64m2_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(vm, rs1, rs2, vl);
}

vfloat64m1x8_t test_vluxseg8ei64_v_f64m1x8_m(vbool64_t vm, const float64_t *rs1,
                                             vuint64m1_t rs2, size_t vl) {
  return __riscv_vluxseg8ei64(vm, rs1, rs2, vl);
}
