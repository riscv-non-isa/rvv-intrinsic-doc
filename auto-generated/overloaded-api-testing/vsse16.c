...
void test_vsse16_v_f16mf4(float16_t *base, ptrdiff_t bstride,
                          vfloat16mf4_t value, size_t vl) {
  return __riscv_vsse16(base, bstride, value, vl);
}

void test_vsse16_v_f16mf2(float16_t *base, ptrdiff_t bstride,
...
void test_vsse16_v_f16mf4_m(vbool64_t mask, float16_t *base, ptrdiff_t bstride,
                            vfloat16mf4_t value, size_t vl) {
  return __riscv_vsse16(mask, base, bstride, value, vl);
}

void test_vsse16_v_f16mf2_m(vbool32_t mask, float16_t *base, ptrdiff_t bstride,
                            vfloat16mf2_t value, size_t vl) {
  return __riscv_vsse16(mask, base, bstride, value, vl);
}

void test_vsse16_v_f16m1_m(vbool16_t mask, float16_t *base, ptrdiff_t bstride,
                           vfloat16m1_t value, size_t vl) {
  return __riscv_vsse16(mask, base, bstride, value, vl);
}

void test_vsse16_v_f16m2_m(vbool8_t mask, float16_t *base, ptrdiff_t bstride,
                           vfloat16m2_t value, size_t vl) {
  return __riscv_vsse16(mask, base, bstride, value, vl);
}

void test_vsse16_v_f16m4_m(vbool4_t mask, float16_t *base, ptrdiff_t bstride,
                           vfloat16m4_t value, size_t vl) {
  return __riscv_vsse16(mask, base, bstride, value, vl);
}

void test_vsse16_v_f16m8_m(vbool2_t mask, float16_t *base, ptrdiff_t bstride,
