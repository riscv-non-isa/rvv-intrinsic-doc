...
void test_vsseg7e32_v_f32mf2x7_ntl_PALL(float32_t *base, vfloat32mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e32_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsseg7e32_v_f32m1x7_ntl_PALL(float32_t *base, vfloat32m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e32_ntl(base, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
...
void test_vsseg7e32_v_f32mf2x7_m_ntl_PALL(vbool64_t mask, float32_t *base, vfloat32mf2x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}

void test_vsseg7e32_v_f32m1x7_m_ntl_PALL(vbool32_t mask, float32_t *base, vfloat32m1x7_t v_tuple, size_t vl, int domain) {
  return __riscv_vsseg7e32_ntl(mask, base, v_tuple, vl, __RISCV_NTLH_ALL_PRIVATE);
}
