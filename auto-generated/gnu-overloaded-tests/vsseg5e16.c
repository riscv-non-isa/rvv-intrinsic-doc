...
void test_vsseg5e16_v_f16mf4x5_m(vbool64_t vm, _Float16 *rs1, vfloat16mf4x5_t vs3, size_t vl) {
  return __riscv_vsseg5e16(vm, rs1, vs3, vl);
}

void test_vsseg5e16_v_f16mf2x5_m(vbool32_t vm, _Float16 *rs1, vfloat16mf2x5_t vs3, size_t vl) {
  return __riscv_vsseg5e16(vm, rs1, vs3, vl);
}

void test_vsseg5e16_v_f16m1x5_m(vbool16_t vm, _Float16 *rs1, vfloat16m1x5_t vs3, size_t vl) {
  return __riscv_vsseg5e16(vm, rs1, vs3, vl);
}
