...
vfloat16mf4x5_t test_vluxseg5ei64_v_f16mf4x5(const float16_t *base, vuint64m1_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(base, bindex, vl);
}

vfloat16mf2x5_t test_vluxseg5ei64_v_f16mf2x5(const float16_t *base, vuint64m2_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(base, bindex, vl);
}

vfloat16m1x5_t test_vluxseg5ei64_v_f16m1x5(const float16_t *base, vuint64m4_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(base, bindex, vl);
}
...
vfloat16mf4x5_t test_vluxseg5ei64_v_f16mf4x5_m(vbool64_t mask, const float16_t *base, vuint64m1_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(mask, base, bindex, vl);
}

vfloat16mf2x5_t test_vluxseg5ei64_v_f16mf2x5_m(vbool32_t mask, const float16_t *base, vuint64m2_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(mask, base, bindex, vl);
}

vfloat16m1x5_t test_vluxseg5ei64_v_f16m1x5_m(vbool16_t mask, const float16_t *base, vuint64m4_t bindex, size_t vl) {
  return __riscv_vluxseg5ei64(mask, base, bindex, vl);
}
