...
void test_vssseg3e32_v_f32mf2x3(float32_t *rs1, ptrdiff_t rs2, vfloat32mf2x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(rs1, rs2, vs3, vl);
}

void test_vssseg3e32_v_f32m1x3(float32_t *rs1, ptrdiff_t rs2, vfloat32m1x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(rs1, rs2, vs3, vl);
}

void test_vssseg3e32_v_f32m2x3(float32_t *rs1, ptrdiff_t rs2, vfloat32m2x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(rs1, rs2, vs3, vl);
}
...
void test_vssseg3e32_v_f32mf2x3_m(vbool64_t vm, float32_t *rs1, ptrdiff_t rs2, vfloat32mf2x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(vm, rs1, rs2, vs3, vl);
}

void test_vssseg3e32_v_f32m1x3_m(vbool32_t vm, float32_t *rs1, ptrdiff_t rs2, vfloat32m1x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(vm, rs1, rs2, vs3, vl);
}

void test_vssseg3e32_v_f32m2x3_m(vbool16_t vm, float32_t *rs1, ptrdiff_t rs2, vfloat32m2x3_t vs3, size_t vl) {
  return __riscv_vssseg3e32(vm, rs1, rs2, vs3, vl);
}
