...
void test_vssseg5e16_v_f16mf4x5(float16_t *base, ptrdiff_t bstride, vfloat16mf4x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(base, bstride, v_tuple, vl);
}

void test_vssseg5e16_v_f16mf2x5(float16_t *base, ptrdiff_t bstride, vfloat16mf2x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(base, bstride, v_tuple, vl);
}

void test_vssseg5e16_v_f16m1x5(float16_t *base, ptrdiff_t bstride, vfloat16m1x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(base, bstride, v_tuple, vl);
}
...
void test_vssseg5e16_v_f16mf4x5_m(vbool64_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf4x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(mask, base, bstride, v_tuple, vl);
}

void test_vssseg5e16_v_f16mf2x5_m(vbool32_t mask, float16_t *base, ptrdiff_t bstride, vfloat16mf2x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(mask, base, bstride, v_tuple, vl);
}

void test_vssseg5e16_v_f16m1x5_m(vbool16_t mask, float16_t *base, ptrdiff_t bstride, vfloat16m1x5_t v_tuple, size_t vl) {
  return __riscv_vssseg5e16(mask, base, bstride, v_tuple, vl);
}
