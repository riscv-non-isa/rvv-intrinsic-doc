...
vfloat32mf2_t test_vfmax_vf_f32mf2(vfloat32mf2_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat32m1_t test_vfmax_vf_f32m1(vfloat32m1_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat32m2_t test_vfmax_vf_f32m2(vfloat32m2_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat32m4_t test_vfmax_vf_f32m4(vfloat32m4_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat32m8_t test_vfmax_vf_f32m8(vfloat32m8_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat64m1_t test_vfmax_vf_f64m1(vfloat64m1_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat64m2_t test_vfmax_vf_f64m2(vfloat64m2_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat64m4_t test_vfmax_vf_f64m4(vfloat64m4_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat64m8_t test_vfmax_vf_f64m8(vfloat64m8_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vs2, rs1, vl);
}
...
vfloat32mf2_t test_vfmax_vf_f32mf2_m(vbool64_t vm, vfloat32mf2_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat32m1_t test_vfmax_vf_f32m1_m(vbool32_t vm, vfloat32m1_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat32m2_t test_vfmax_vf_f32m2_m(vbool16_t vm, vfloat32m2_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat32m4_t test_vfmax_vf_f32m4_m(vbool8_t vm, vfloat32m4_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat32m8_t test_vfmax_vf_f32m8_m(vbool4_t vm, vfloat32m8_t vs2, float32_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat64m1_t test_vfmax_vf_f64m1_m(vbool64_t vm, vfloat64m1_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat64m2_t test_vfmax_vf_f64m2_m(vbool32_t vm, vfloat64m2_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat64m4_t test_vfmax_vf_f64m4_m(vbool16_t vm, vfloat64m4_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
...
vfloat64m8_t test_vfmax_vf_f64m8_m(vbool8_t vm, vfloat64m8_t vs2, float64_t rs1, size_t vl) {
  return __riscv_vfmax(vm, vs2, rs1, vl);
}
