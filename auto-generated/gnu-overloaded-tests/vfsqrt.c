...
vfloat32m1_t test_vfsqrt_v_f32m1_rm_m(vbool32_t vm, vfloat32m1_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m2_t test_vfsqrt_v_f32m2_rm_m(vbool16_t vm, vfloat32m2_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m4_t test_vfsqrt_v_f32m4_rm_m(vbool8_t vm, vfloat32m4_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat32m8_t test_vfsqrt_v_f32m8_rm_m(vbool4_t vm, vfloat32m8_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m1_t test_vfsqrt_v_f64m1_rm_m(vbool64_t vm, vfloat64m1_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m2_t test_vfsqrt_v_f64m2_rm_m(vbool32_t vm, vfloat64m2_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}

vfloat64m4_t test_vfsqrt_v_f64m4_rm_m(vbool16_t vm, vfloat64m4_t vs2, size_t vl) {
  return __riscv_vfsqrt(vm, vs2, __RISCV_FRM_RNE, vl);
}
