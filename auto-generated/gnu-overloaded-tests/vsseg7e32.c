...
void test_vsseg7e32_v_f32mf2x7_m(vbool64_t vm, float32_t *rs1, vfloat32mf2x7_t vs3, size_t vl) {
  return __riscv_vsseg7e32(vm, rs1, vs3, vl);
}

void test_vsseg7e32_v_f32m1x7_m(vbool32_t vm, float32_t *rs1, vfloat32m1x7_t vs3, size_t vl) {
  return __riscv_vsseg7e32(vm, rs1, vs3, vl);
}
