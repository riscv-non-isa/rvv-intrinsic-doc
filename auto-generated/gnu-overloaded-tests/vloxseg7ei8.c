...
vfloat16mf4x7_t test_vloxseg7ei8_v_f16mf4x7(const _Float16 *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}

vfloat16mf2x7_t test_vloxseg7ei8_v_f16mf2x7(const _Float16 *rs1, vuint8mf4_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}

vfloat16m1x7_t test_vloxseg7ei8_v_f16m1x7(const _Float16 *rs1, vuint8mf2_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}

vfloat32mf2x7_t test_vloxseg7ei8_v_f32mf2x7(const float *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}

vfloat32m1x7_t test_vloxseg7ei8_v_f32m1x7(const float *rs1, vuint8mf4_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}

vfloat64m1x7_t test_vloxseg7ei8_v_f64m1x7(const double *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(rs1, rs2, vl);
}
...
vfloat16mf4x7_t test_vloxseg7ei8_v_f16mf4x7_m(vbool64_t vm, const _Float16 *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}

vfloat16mf2x7_t test_vloxseg7ei8_v_f16mf2x7_m(vbool32_t vm, const _Float16 *rs1, vuint8mf4_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}

vfloat16m1x7_t test_vloxseg7ei8_v_f16m1x7_m(vbool16_t vm, const _Float16 *rs1, vuint8mf2_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}

vfloat32mf2x7_t test_vloxseg7ei8_v_f32mf2x7_m(vbool64_t vm, const float *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}

vfloat32m1x7_t test_vloxseg7ei8_v_f32m1x7_m(vbool32_t vm, const float *rs1, vuint8mf4_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}

vfloat64m1x7_t test_vloxseg7ei8_v_f64m1x7_m(vbool64_t vm, const double *rs1, vuint8mf8_t rs2, size_t vl) {
  return __riscv_vloxseg7ei8(vm, rs1, rs2, vl);
}
