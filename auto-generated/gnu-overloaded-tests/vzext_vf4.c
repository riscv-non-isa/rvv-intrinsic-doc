...
vuint32mf2_t test_vzext_vf4_u32mf2(vuint8mf8_t vs2, size_t vl) {
  return __riscv_vzext_vf4(vs2, vl);
}
...
vuint32mf2_t test_vzext_vf4_u32mf2_m(vbool64_t vm, vuint8mf8_t vs2, size_t vl) {
  return __riscv_vzext_vf4(vm, vs2, vl);
}
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vzext\.vf4[ivxfswum.]*\s+} 18 } } */
