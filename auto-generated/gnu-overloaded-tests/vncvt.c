...
vint8mf8_t test_vncvt_x_x_w_i8mf8_m(vbool64_t vm, vint16mf4_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}
...
vuint8mf8_t test_vncvt_x_x_w_u8mf8_m(vbool64_t vm, vuint16mf4_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}

vuint8mf4_t test_vncvt_x_x_w_u8mf4_m(vbool32_t vm, vuint16mf2_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}
...
vint16mf4_t test_vncvt_x_x_w_i16mf4_m(vbool64_t vm, vint32mf2_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}
...
vuint16mf4_t test_vncvt_x_x_w_u16mf4_m(vbool64_t vm, vuint32mf2_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}

vuint16mf2_t test_vncvt_x_x_w_u16mf2_m(vbool32_t vm, vuint32m1_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}
...
vuint32mf2_t test_vncvt_x_x_w_u32mf2_m(vbool64_t vm, vuint64m1_t vs2, size_t vl) {
  return __riscv_vncvt_x(vm, vs2, vl);
}
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vncvt\.[ivxfswum.]+\s+} 60 } } */
