...
void test_vse64_v_f64m1_m(vbool64_t vm, float64_t *rs1, vfloat64m1_t vs3, size_t vl) {
  return __riscv_vse64(vm, rs1, vs3, vl);
}

void test_vse64_v_f64m2_m(vbool32_t vm, float64_t *rs1, vfloat64m2_t vs3, size_t vl) {
  return __riscv_vse64(vm, rs1, vs3, vl);
}

void test_vse64_v_f64m4_m(vbool16_t vm, float64_t *rs1, vfloat64m4_t vs3, size_t vl) {
  return __riscv_vse64(vm, rs1, vs3, vl);
}

void test_vse64_v_f64m8_m(vbool8_t vm, float64_t *rs1, vfloat64m8_t vs3, size_t vl) {
  return __riscv_vse64(vm, rs1, vs3, vl);
}
