...
void test_vsseg8e32_v_f32mf2x8(float32_t *rs1, vfloat32mf2x8_t vs3, size_t vl) {
  return __riscv_vsseg8e32(rs1, vs3, vl);
}

void test_vsseg8e32_v_f32m1x8(float32_t *rs1, vfloat32m1x8_t vs3, size_t vl) {
  return __riscv_vsseg8e32(rs1, vs3, vl);
}
...
void test_vsseg8e32_v_f32mf2x8_m(vbool64_t vm, float32_t *rs1, vfloat32mf2x8_t vs3, size_t vl) {
  return __riscv_vsseg8e32(vm, rs1, vs3, vl);
}

void test_vsseg8e32_v_f32m1x8_m(vbool32_t vm, float32_t *rs1, vfloat32m1x8_t vs3, size_t vl) {
  return __riscv_vsseg8e32(vm, rs1, vs3, vl);
}
