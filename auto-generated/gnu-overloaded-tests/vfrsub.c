...
vfloat16mf4_t test_vfrsub_vf_f16mf4_rm(vfloat16mf4_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16mf2_t test_vfrsub_vf_f16mf2_rm(vfloat16mf2_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m1_t test_vfrsub_vf_f16m1_rm(vfloat16m1_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m2_t test_vfrsub_vf_f16m2_rm(vfloat16m2_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m4_t test_vfrsub_vf_f16m4_rm(vfloat16m4_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m8_t test_vfrsub_vf_f16m8_rm(vfloat16m8_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}
...
vfloat64m1_t test_vfrsub_vf_f64m1_rm(vfloat64m1_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m2_t test_vfrsub_vf_f64m2_rm(vfloat64m2_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m4_t test_vfrsub_vf_f64m4_rm(vfloat64m4_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m8_t test_vfrsub_vf_f64m8_rm(vfloat64m8_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16mf4_t test_vfrsub_vf_f16mf4_rm_m(vbool64_t mask, vfloat16mf4_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16mf2_t test_vfrsub_vf_f16mf2_rm_m(vbool32_t mask, vfloat16mf2_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m1_t test_vfrsub_vf_f16m1_rm_m(vbool16_t mask, vfloat16m1_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m2_t test_vfrsub_vf_f16m2_rm_m(vbool8_t mask, vfloat16m2_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m4_t test_vfrsub_vf_f16m4_rm_m(vbool4_t mask, vfloat16m4_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat16m8_t test_vfrsub_vf_f16m8_rm_m(vbool2_t mask, vfloat16m8_t op1, float16_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}
...
vfloat64m1_t test_vfrsub_vf_f64m1_rm_m(vbool64_t mask, vfloat64m1_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m2_t test_vfrsub_vf_f64m2_rm_m(vbool32_t mask, vfloat64m2_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m4_t test_vfrsub_vf_f64m4_rm_m(vbool16_t mask, vfloat64m4_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}

vfloat64m8_t test_vfrsub_vf_f64m8_rm_m(vbool8_t mask, vfloat64m8_t op1, float64_t op2, size_t vl) {
  return __riscv_vfrsub(mask, op1, op2, __RISCV_FRM_RNE, vl);
}
