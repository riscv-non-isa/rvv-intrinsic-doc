...
void test_vsuxseg8ei32_v_f16mf4x8(_Float16 *rs1, vuint32mf2_t vs2, vfloat16mf4x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f16mf2x8(_Float16 *rs1, vuint32m1_t vs2, vfloat16mf2x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f16m1x8(_Float16 *rs1, vuint32m2_t vs2, vfloat16m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f32mf2x8(float *rs1, vuint32mf2_t vs2, vfloat32mf2x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f32m1x8(float *rs1, vuint32m1_t vs2, vfloat32m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f64m1x8(double *rs1, vuint32mf2_t vs2, vfloat64m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(rs1, vs2, vs3, vl);
}
...
void test_vsuxseg8ei32_v_f16mf4x8_m(vbool64_t vm, _Float16 *rs1, vuint32mf2_t vs2, vfloat16mf4x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f16mf2x8_m(vbool32_t vm, _Float16 *rs1, vuint32m1_t vs2, vfloat16mf2x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f16m1x8_m(vbool16_t vm, _Float16 *rs1, vuint32m2_t vs2, vfloat16m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f32mf2x8_m(vbool64_t vm, float *rs1, vuint32mf2_t vs2, vfloat32mf2x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f32m1x8_m(vbool32_t vm, float *rs1, vuint32m1_t vs2, vfloat32m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg8ei32_v_f64m1x8_m(vbool64_t vm, double *rs1, vuint32mf2_t vs2, vfloat64m1x8_t vs3, size_t vl) {
  return __riscv_vsuxseg8ei32(vm, rs1, vs2, vs3, vl);
}
