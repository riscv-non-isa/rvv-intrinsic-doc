...
void test_vsuxseg2ei8_v_f16mf4x2(float16_t *base, vuint8mf8_t bindex, vfloat16mf4x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16mf2x2(float16_t *base, vuint8mf4_t bindex, vfloat16mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m1x2(float16_t *base, vuint8mf2_t bindex, vfloat16m1x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m2x2(float16_t *base, vuint8m1_t bindex, vfloat16m2x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m4x2(float16_t *base, vuint8m2_t bindex, vfloat16m4x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(base, bindex, v_tuple, vl);
}
...
void test_vsuxseg2ei8_v_f16mf4x2_m(vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16mf2x2_m(vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m1x2_m(vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m2x2_m(vbool8_t mask, float16_t *base, vuint8m1_t bindex, vfloat16m2x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg2ei8_v_f16m4x2_m(vbool4_t mask, float16_t *base, vuint8m2_t bindex, vfloat16m4x2_t v_tuple, size_t vl) {
  return __riscv_vsuxseg2ei8(mask, base, bindex, v_tuple, vl);
}
