...
void test_vsuxseg7ei16_v_f16mf4x7(_Float16 *rs1, vuint16mf4_t vs2, vfloat16mf4x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f16mf2x7(_Float16 *rs1, vuint16mf2_t vs2, vfloat16mf2x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f16m1x7(_Float16 *rs1, vuint16m1_t vs2, vfloat16m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f32mf2x7(float *rs1, vuint16mf4_t vs2, vfloat32mf2x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f32m1x7(float *rs1, vuint16mf2_t vs2, vfloat32m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f64m1x7(double *rs1, vuint16mf4_t vs2, vfloat64m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(rs1, vs2, vs3, vl);
}
...
void test_vsuxseg7ei16_v_f16mf4x7_m(vbool64_t vm, _Float16 *rs1, vuint16mf4_t vs2, vfloat16mf4x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f16mf2x7_m(vbool32_t vm, _Float16 *rs1, vuint16mf2_t vs2, vfloat16mf2x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f16m1x7_m(vbool16_t vm, _Float16 *rs1, vuint16m1_t vs2, vfloat16m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f32mf2x7_m(vbool64_t vm, float *rs1, vuint16mf4_t vs2, vfloat32mf2x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f32m1x7_m(vbool32_t vm, float *rs1, vuint16mf2_t vs2, vfloat32m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}

void test_vsuxseg7ei16_v_f64m1x7_m(vbool64_t vm, double *rs1, vuint16mf4_t vs2, vfloat64m1x7_t vs3, size_t vl) {
  return __riscv_vsuxseg7ei16(vm, rs1, vs2, vs3, vl);
}
