...
void test_vsseg6e32_v_f32mf2x6_m(vbool64_t vm, float *rs1, vfloat32mf2x6_t vs3, size_t vl) {
  return __riscv_vsseg6e32(vm, rs1, vs3, vl);
}

void test_vsseg6e32_v_f32m1x6_m(vbool32_t vm, float *rs1, vfloat32m1x6_t vs3, size_t vl) {
  return __riscv_vsseg6e32(vm, rs1, vs3, vl);
}
