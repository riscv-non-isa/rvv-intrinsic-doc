...
void test_vsuxseg7ei16_v_f16mf4x7(float16_t *base, vuint16mf4_t bindex, vfloat16mf4x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f16mf2x7(float16_t *base, vuint16mf2_t bindex, vfloat16mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f16m1x7(float16_t *base, vuint16m1_t bindex, vfloat16m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f32mf2x7(float32_t *base, vuint16mf4_t bindex, vfloat32mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f32m1x7(float32_t *base, vuint16mf2_t bindex, vfloat32m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f64m1x7(float64_t *base, vuint16mf4_t bindex, vfloat64m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(base, bindex, v_tuple, vl);
}
...
void test_vsuxseg7ei16_v_f16mf4x7_m(vbool64_t mask, float16_t *base, vuint16mf4_t bindex, vfloat16mf4x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f16mf2x7_m(vbool32_t mask, float16_t *base, vuint16mf2_t bindex, vfloat16mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f16m1x7_m(vbool16_t mask, float16_t *base, vuint16m1_t bindex, vfloat16m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f32mf2x7_m(vbool64_t mask, float32_t *base, vuint16mf4_t bindex, vfloat32mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f32m1x7_m(vbool32_t mask, float32_t *base, vuint16mf2_t bindex, vfloat32m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg7ei16_v_f64m1x7_m(vbool64_t mask, float64_t *base, vuint16mf4_t bindex, vfloat64m1x7_t v_tuple, size_t vl) {
  return __riscv_vsuxseg7ei16(mask, base, bindex, v_tuple, vl);
}
