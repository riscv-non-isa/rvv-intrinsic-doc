...
void test_vse8_v_u8mf8_m(vbool64_t vm, uint8_t *rs1, vuint8mf8_t vs3, size_t vl) {
  return __riscv_vse8(vm, rs1, vs3, vl);
}

void test_vse8_v_u8mf4_m(vbool32_t vm, uint8_t *rs1, vuint8mf4_t vs3, size_t vl) {
  return __riscv_vse8(vm, rs1, vs3, vl);
}

void test_vse8_v_u8mf2_m(vbool16_t vm, uint8_t *rs1, vuint8mf2_t vs3, size_t vl) {
  return __riscv_vse8(vm, rs1, vs3, vl);
}
