...
void test_vsseg2e32_v_f32mf2x2_m(vbool64_t vm, float32_t *rs1, vfloat32mf2x2_t vs3, size_t vl) {
  return __riscv_vsseg2e32(vm, rs1, vs3, vl);
}

void test_vsseg2e32_v_f32m1x2_m(vbool32_t vm, float32_t *rs1, vfloat32m1x2_t vs3, size_t vl) {
  return __riscv_vsseg2e32(vm, rs1, vs3, vl);
}

void test_vsseg2e32_v_f32m2x2_m(vbool16_t vm, float32_t *rs1, vfloat32m2x2_t vs3, size_t vl) {
  return __riscv_vsseg2e32(vm, rs1, vs3, vl);
}

void test_vsseg2e32_v_f32m4x2_m(vbool8_t vm, float32_t *rs1, vfloat32m4x2_t vs3, size_t vl) {
  return __riscv_vsseg2e32(vm, rs1, vs3, vl);
}
