...
vfloat16mf4_t test_vluxei16_v_f16mf4(const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat16mf2_t test_vluxei16_v_f16mf2(const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat16m1_t test_vluxei16_v_f16m1(const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat16m2_t test_vluxei16_v_f16m2(const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat16m4_t test_vluxei16_v_f16m4(const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat16m8_t test_vluxei16_v_f16m8(const _Float16 *rs1, vuint16m8_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat32mf2_t test_vluxei16_v_f32mf2(const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat32m1_t test_vluxei16_v_f32m1(const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat32m2_t test_vluxei16_v_f32m2(const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat32m4_t test_vluxei16_v_f32m4(const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat32m8_t test_vluxei16_v_f32m8(const float *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat64m1_t test_vluxei16_v_f64m1(const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat64m2_t test_vluxei16_v_f64m2(const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat64m4_t test_vluxei16_v_f64m4(const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}

vfloat64m8_t test_vluxei16_v_f64m8(const double *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(rs1, rs2, vl);
}
...
vfloat16mf4_t test_vluxei16_v_f16mf4_m(vbool64_t vm, const _Float16 *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat16mf2_t test_vluxei16_v_f16mf2_m(vbool32_t vm, const _Float16 *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat16m1_t test_vluxei16_v_f16m1_m(vbool16_t vm, const _Float16 *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat16m2_t test_vluxei16_v_f16m2_m(vbool8_t vm, const _Float16 *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat16m4_t test_vluxei16_v_f16m4_m(vbool4_t vm, const _Float16 *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat16m8_t test_vluxei16_v_f16m8_m(vbool2_t vm, const _Float16 *rs1, vuint16m8_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat32mf2_t test_vluxei16_v_f32mf2_m(vbool64_t vm, const float *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat32m1_t test_vluxei16_v_f32m1_m(vbool32_t vm, const float *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat32m2_t test_vluxei16_v_f32m2_m(vbool16_t vm, const float *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat32m4_t test_vluxei16_v_f32m4_m(vbool8_t vm, const float *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat32m8_t test_vluxei16_v_f32m8_m(vbool4_t vm, const float *rs1, vuint16m4_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat64m1_t test_vluxei16_v_f64m1_m(vbool64_t vm, const double *rs1, vuint16mf4_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat64m2_t test_vluxei16_v_f64m2_m(vbool32_t vm, const double *rs1, vuint16mf2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat64m4_t test_vluxei16_v_f64m4_m(vbool16_t vm, const double *rs1, vuint16m1_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}

vfloat64m8_t test_vluxei16_v_f64m8_m(vbool8_t vm, const double *rs1, vuint16m2_t rs2, size_t vl) {
  return __riscv_vluxei16(vm, rs1, rs2, vl);
}
