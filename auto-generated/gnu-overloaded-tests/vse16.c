...
void test_vse16_v_f16mf4_m(vbool64_t vm, _Float16 *rs1, vfloat16mf4_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}

void test_vse16_v_f16mf2_m(vbool32_t vm, _Float16 *rs1, vfloat16mf2_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m1_m(vbool16_t vm, _Float16 *rs1, vfloat16m1_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m2_m(vbool8_t vm, _Float16 *rs1, vfloat16m2_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m4_m(vbool4_t vm, _Float16 *rs1, vfloat16m4_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}

void test_vse16_v_f16m8_m(vbool2_t vm, _Float16 *rs1, vfloat16m8_t vs3, size_t vl) {
  return __riscv_vse16(vm, rs1, vs3, vl);
}
