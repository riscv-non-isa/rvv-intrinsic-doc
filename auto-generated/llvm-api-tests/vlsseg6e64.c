...
vfloat64m1x6_t test_vlsseg6e64_v_f64m1x6(const double *base, ptrdiff_t bstride,
                                         size_t vl) {
  return __riscv_vlsseg6e64_v_f64m1x6(base, bstride, vl);
}

vint64m1x6_t test_vlsseg6e64_v_i64m1x6(const int64_t *base, ptrdiff_t bstride,
                                       size_t vl) {
  return __riscv_vlsseg6e64_v_i64m1x6(base, bstride, vl);
}

vuint64m1x6_t test_vlsseg6e64_v_u64m1x6(const uint64_t *base, ptrdiff_t bstride,
                                        size_t vl) {
  return __riscv_vlsseg6e64_v_u64m1x6(base, bstride, vl);
}

vfloat64m1x6_t test_vlsseg6e64_v_f64m1x6_m(vbool64_t mask, const double *base,
