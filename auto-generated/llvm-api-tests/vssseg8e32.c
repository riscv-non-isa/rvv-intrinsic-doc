...
void test_vssseg8e32_v_f32mf2x8(float *base, ptrdiff_t bstride,
                                vfloat32mf2x8_t v_tuple, size_t vl) {
  return __riscv_vssseg8e32_v_f32mf2x8(base, bstride, v_tuple, vl);
}

void test_vssseg8e32_v_f32m1x8(float *base, ptrdiff_t bstride,
...
void test_vssseg8e32_v_f32mf2x8_m(vbool64_t mask, float *base,
                                  ptrdiff_t bstride, vfloat32mf2x8_t v_tuple,
                                  size_t vl) {
  return __riscv_vssseg8e32_v_f32mf2x8_m(mask, base, bstride, v_tuple, vl);
}

void test_vssseg8e32_v_f32m1x8_m(vbool32_t mask, float *base, ptrdiff_t bstride,
                                 vfloat32m1x8_t v_tuple, size_t vl) {
