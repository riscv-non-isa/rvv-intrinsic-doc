...
vfloat32mf2x7_t test_vlseg7e32_v_f32mf2x7_ntl_PALL(const float *base, size_t vl, int domain) {
  return __riscv_vlseg7e32_v_f32mf2x7_ntl(base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x7_t test_vlseg7e32_v_f32m1x7_ntl_PALL(const float *base, size_t vl, int domain) {
...
vfloat32mf2x7_t test_vlseg7e32_v_f32mf2x7_m_ntl_PALL(vbool64_t mask, const float *base, size_t vl, int domain) {
  return __riscv_vlseg7e32_v_f32mf2x7_m_ntl(mask, base, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat32m1x7_t test_vlseg7e32_v_f32m1x7_m_ntl_PALL(vbool32_t mask, const float *base, size_t vl, int domain) {
