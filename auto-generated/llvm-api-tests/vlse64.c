...
vfloat64m1_t test_vlse64_v_f64m1_m(vbool64_t mask, const double *base,
                                   ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse64_v_f64m1_m(mask, base, bstride, vl);
}

vfloat64m2_t test_vlse64_v_f64m2_m(vbool32_t mask, const double *base,
                                   ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse64_v_f64m2_m(mask, base, bstride, vl);
}

vfloat64m4_t test_vlse64_v_f64m4_m(vbool16_t mask, const double *base,
                                   ptrdiff_t bstride, size_t vl) {
  return __riscv_vlse64_v_f64m4_m(mask, base, bstride, vl);
}

vfloat64m8_t test_vlse64_v_f64m8_m(vbool8_t mask, const double *base,
                                   ptrdiff_t bstride, size_t vl) {
