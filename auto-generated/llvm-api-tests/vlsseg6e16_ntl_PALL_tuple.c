...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_ntl_PALL(const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e16_v_f16mf4x6_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_ntl_PALL(const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e16_v_f16mf2x6_ntl(base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_ntl_PALL(const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat16mf4x6_t test_vlsseg6e16_v_f16mf4x6_m_ntl_PALL(vbool64_t mask, const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e16_v_f16mf4x6_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16mf2x6_t test_vlsseg6e16_v_f16mf2x6_m_ntl_PALL(vbool32_t mask, const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
  return __riscv_vlsseg6e16_v_f16mf2x6_m_ntl(mask, base, bstride, vl, __RISCV_NTLH_ALL_PRIVATE);
}

vfloat16m1x6_t test_vlsseg6e16_v_f16m1x6_m_ntl_PALL(vbool16_t mask, const _Float16 *base, ptrdiff_t bstride, size_t vl, int domain) {
