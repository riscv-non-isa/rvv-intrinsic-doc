...
vfloat64m1x2_t test_vlseg2e64_v_f64m1x2_m(vbool64_t mask, const double *base,
                                          size_t vl) {
  return __riscv_vlseg2e64_v_f64m1x2_m(mask, base, vl);
}

vfloat64m2x2_t test_vlseg2e64_v_f64m2x2_m(vbool32_t mask, const double *base,
                                          size_t vl) {
  return __riscv_vlseg2e64_v_f64m2x2_m(mask, base, vl);
}

vfloat64m4x2_t test_vlseg2e64_v_f64m4x2_m(vbool16_t mask, const double *base,
                                          size_t vl) {
