...
void test_vsseg2e16_v_f16mf4x2(_Float16 *base, vfloat16mf4x2_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg2e16_v_f16mf4x2(base, v_tuple, vl);
}

void test_vsseg2e16_v_f16mf2x2(_Float16 *base, vfloat16mf2x2_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg2e16_v_f16mf2x2(base, v_tuple, vl);
}

void test_vsseg2e16_v_f16m1x2(_Float16 *base, vfloat16m1x2_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg2e16_v_f16m1x2(base, v_tuple, vl);
}

void test_vsseg2e16_v_f16m2x2(_Float16 *base, vfloat16m2x2_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg2e16_v_f16m2x2(base, v_tuple, vl);
}

void test_vsseg2e16_v_f16m4x2(_Float16 *base, vfloat16m4x2_t v_tuple,
                              size_t vl) {
