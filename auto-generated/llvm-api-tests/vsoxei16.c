...
void test_vsoxei16_v_f16mf4_m(vbool64_t mask, _Float16 *base,
                              vuint16mf4_t bindex, vfloat16mf4_t value,
                              size_t vl) {
  return __riscv_vsoxei16_v_f16mf4_m(mask, base, bindex, value, vl);
}

void test_vsoxei16_v_f16mf2_m(vbool32_t mask, _Float16 *base,
                              vuint16mf2_t bindex, vfloat16mf2_t value,
                              size_t vl) {
  return __riscv_vsoxei16_v_f16mf2_m(mask, base, bindex, value, vl);
}

void test_vsoxei16_v_f16m1_m(vbool16_t mask, _Float16 *base, vuint16m1_t bindex,
                             vfloat16m1_t value, size_t vl) {
  return __riscv_vsoxei16_v_f16m1_m(mask, base, bindex, value, vl);
}

void test_vsoxei16_v_f16m2_m(vbool8_t mask, _Float16 *base, vuint16m2_t bindex,
                             vfloat16m2_t value, size_t vl) {
  return __riscv_vsoxei16_v_f16m2_m(mask, base, bindex, value, vl);
}

void test_vsoxei16_v_f16m4_m(vbool4_t mask, _Float16 *base, vuint16m4_t bindex,
                             vfloat16m4_t value, size_t vl) {
  return __riscv_vsoxei16_v_f16m4_m(mask, base, bindex, value, vl);
}

void test_vsoxei16_v_f16m8_m(vbool2_t mask, _Float16 *base, vuint16m8_t bindex,
                             vfloat16m8_t value, size_t vl) {
