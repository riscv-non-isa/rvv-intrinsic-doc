...
vfloat16mf4_t test_vle16ff_v_f16mf4(const _Float16 *base, size_t *new_vl,
                                    size_t vl) {
  return __riscv_vle16ff_v_f16mf4(base, new_vl, vl);
}

vfloat16mf2_t test_vle16ff_v_f16mf2(const _Float16 *base, size_t *new_vl,
                                    size_t vl) {
  return __riscv_vle16ff_v_f16mf2(base, new_vl, vl);
}

vfloat16m1_t test_vle16ff_v_f16m1(const _Float16 *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle16ff_v_f16m1(base, new_vl, vl);
}

vfloat16m2_t test_vle16ff_v_f16m2(const _Float16 *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle16ff_v_f16m2(base, new_vl, vl);
}

vfloat16m4_t test_vle16ff_v_f16m4(const _Float16 *base, size_t *new_vl,
                                  size_t vl) {
  return __riscv_vle16ff_v_f16m4(base, new_vl, vl);
}

vfloat16m8_t test_vle16ff_v_f16m8(const _Float16 *base, size_t *new_vl,
                                  size_t vl) {
