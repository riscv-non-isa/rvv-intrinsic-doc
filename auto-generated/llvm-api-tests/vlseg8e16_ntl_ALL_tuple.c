...
vfloat16mf4x8_t test_vlseg8e16_v_f16mf4x8_ntl_ALL(const _Float16 *base, size_t vl, int domain) {
  return __riscv_vlseg8e16_v_f16mf4x8_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x8_t test_vlseg8e16_v_f16mf2x8_ntl_ALL(const _Float16 *base, size_t vl, int domain) {
  return __riscv_vlseg8e16_v_f16mf2x8_ntl(base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x8_t test_vlseg8e16_v_f16m1x8_ntl_ALL(const _Float16 *base, size_t vl, int domain) {
...
vfloat16mf4x8_t test_vlseg8e16_v_f16mf4x8_m_ntl_ALL(vbool64_t mask, const _Float16 *base, size_t vl, int domain) {
  return __riscv_vlseg8e16_v_f16mf4x8_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat16mf2x8_t test_vlseg8e16_v_f16mf2x8_m_ntl_ALL(vbool32_t mask, const _Float16 *base, size_t vl, int domain) {
  return __riscv_vlseg8e16_v_f16mf2x8_m_ntl(mask, base, vl, __RISCV_NTLH_ALL);
}

vfloat16m1x8_t test_vlseg8e16_v_f16m1x8_m_ntl_ALL(vbool16_t mask, const _Float16 *base, size_t vl, int domain) {
