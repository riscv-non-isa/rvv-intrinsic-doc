...
vfloat16m1x2_t test_vlseg2e16_v_f16m1x2_m(vbool16_t mask, const _Float16 *base,
                                          size_t vl) {
  return __riscv_vlseg2e16_v_f16m1x2_m(mask, base, vl);
}

vfloat16m2x2_t test_vlseg2e16_v_f16m2x2_m(vbool8_t mask, const _Float16 *base,
                                          size_t vl) {
  return __riscv_vlseg2e16_v_f16m2x2_m(mask, base, vl);
}

vfloat16m4x2_t test_vlseg2e16_v_f16m4x2_m(vbool4_t mask, const _Float16 *base,
                                          size_t vl) {
