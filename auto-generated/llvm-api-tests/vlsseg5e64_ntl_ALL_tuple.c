...
vfloat64m1x5_t test_vlsseg5e64_v_f64m1x5_ntl_ALL(const double *base, ptrdiff_t bstride, size_t vl, int domain) {
...
vfloat64m1x5_t test_vlsseg5e64_v_f64m1x5_m_ntl_ALL(vbool64_t mask, const double *base, ptrdiff_t bstride, size_t vl, int domain) {
