...
void test_vsseg4e16_v_f16mf4x4(_Float16 *base, vfloat16mf4x4_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg4e16_v_f16mf4x4(base, v_tuple, vl);
}

void test_vsseg4e16_v_f16mf2x4(_Float16 *base, vfloat16mf2x4_t v_tuple,
                               size_t vl) {
  return __riscv_vsseg4e16_v_f16mf2x4(base, v_tuple, vl);
}

void test_vsseg4e16_v_f16m1x4(_Float16 *base, vfloat16m1x4_t v_tuple,
                              size_t vl) {
  return __riscv_vsseg4e16_v_f16m1x4(base, v_tuple, vl);
}

void test_vsseg4e16_v_f16m2x4(_Float16 *base, vfloat16m2x4_t v_tuple,
                              size_t vl) {
