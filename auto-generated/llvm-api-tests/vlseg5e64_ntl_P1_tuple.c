...
vfloat64m1x5_t test_vlseg5e64_v_f64m1x5_ntl_P1(const double *base, size_t vl, int domain) {
...
vfloat64m1x5_t test_vlseg5e64_v_f64m1x5_m_ntl_P1(vbool64_t mask, const double *base, size_t vl, int domain) {
