...
vfloat16mf4_t test_vfabs_v_f16mf4_m(vbool64_t mask, vfloat16mf4_t op1,
                                    size_t vl) {
  return __riscv_vfabs_v_f16mf4_m(mask, op1, vl);
}

vfloat16mf2_t test_vfabs_v_f16mf2_m(vbool32_t mask, vfloat16mf2_t op1,
                                    size_t vl) {
...
vfloat32mf2_t test_vfabs_v_f32mf2_m(vbool64_t mask, vfloat32mf2_t op1,
                                    size_t vl) {
