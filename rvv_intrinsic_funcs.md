...
### [RVV C extension types](#31-vector-types):
...
vfloat64m8_t
```
### [RVV C extension mask types](#32-mask-types):
...
### [Set `vl` and `vtype` Functions](#411-set-vl-and-vtype):
...
```
### [Set the vl to VLMAX with specific vtype](#414-set-the-vl-to-vlmax-with-specific-vtype):
...
```
### [Read the vl](#414-set-the-vl-to-vlmax-with-specific-vtype):
...
### [Vector Unit-Stride Load Functions](#421-vector-unit-stride-load-functions):
...
```
### [Vector Unit-Stride Store Functions](#424-vector-unit-strided-store-functions):
...
```
### [Vector Strided Load Functions](#422-vector-strided-load-functions):
...
```
### [Vector Strided Store Functions](#425-vector-strided-store-functions):
...
```
### [Vector Indexed Load Functions](#423-vector-indexed-load-functions):
...
```
### [Vector Indexed Store Functions](#426-vector-indexed-store-functions):
...
```
### [Unit-stride Fault-Only-First Loads Functions](#427-unit-stride-fault-only-first-loads-functions):
...
### [Vector Single-Width Integer Add and Subtract Functions](#441-single-width-integer-add-and-subtract):
...
```
### [Vector Widening Integer Add/Subtract Functions](#442-vector-widening-integer-addsubtract):
...
```
### [Vector Integer Add-with-Carry / Subtract-with-Borrow Functions](#443-vector-integer-add-with-carry--subtract-with-borrow-functions):
...
```
### [Vector Bitwise Logical Functions](#444-vector-bit-wise-logical-functions):
...
```
### [Vector Single-Width Bit Shift Functions](#445-vector-single-width-bit-shift-functions):
...
```
### [Vector Narrowing Integer Right Shift Functions](#446-vector-narrowing-integer-right-shift-functions):
...
```
### [Vector Integer Comparison Functions](#447-vector-integer-comparison-functions):
...
```
### [Vector Integer Min/Max Functions](#448-vector-integer-minmax-functions):
...
```
### [Vector Single-Width Integer Multiply Functions](#449-vector-single-width-integer-multiply-functions):
...
```
### [Vector Integer Divide Functions](#4410-vector-integer-divide-functions):
...
```
### [Vector Widening Integer Multiply Functions](#4411-vector-widening-integer-multiply-functions):
...
```
### [Vector Single-Width Integer Multiply-Add Functions](#4412-vector-single-width-integer-multiply-add-functions):
...
```
### [Vector Widening Integer Multiply-Add Functions](#4413-vector-widening-integer-multiply-add-functions):
...
```
### [Vector Quad-Widening Integer Multiply-Add Functions](#4414-vector-quad-widening-integer-multiply-add-functions):
...
```
### [Vector Integer Merge Functions](#4415-vector-integer-merge-functions):
...
```
### [Vector Integer Move Functions](#4416-vector-integer-move-functions):
...
### [Vector Single-Width Saturating Add and Subtract Functions](#451-vector-single-width-saturating-add-and-subtract-functions):
...
```
### [Vector Single-Width Averaging Add and Subtract Functions](#452-vector-single-width-averaging-add-and-subtract-functions):
...
```
### [Vector Single-Width Fractional Multiply with Rounding and Saturation Functions](#453-vector-single-width-fractional-multiply-with-rounding-and-saturation-functions):
...
```
### [Vector Single-Width Scaling Shift Functions](#455-vector-single-width-scaling-shift-functions):
...
```
### [Vector Narrowing Fixed-Point Clip Functions](#456-vector-narrowing-fixed-point-clip-functions):
...
### [Vector Single-Width Floating-Point Add/Subtract Functions](#461-vector-single-width-floating-point-addsubtract-functions):
...
```
### [Vector Widening Floating-Point Add/Subtract Functions](#462-vector-widening-floating-point-addsubtract-functions):
...
```
### [Vector Single-Width Floating-Point Multiply/Divide Functions](#463-vector-single-width-floating-point-multiplydivide-functions):
...
```
### [Vector Widening Floating-Point Multiply Functions](#464-vector-widening-floating-point-multiply-functions):
...
```
### [Vector Single-Width Floating-Point Fused Multiply-Add Functions](#465-vector-single-width-floating-point-fused-multiply-add-functions):
...
```
### [Vector Widening Floating-Point Fused Multiply-Add Functions](#466-vector-widening-floating-point-fused-multiply-add-functions):
...
```
### [Vector Floating-Point Square-Root Functions](#467-vector-floating-point-square-root-functions):
...
```
### [Vector Floating-Point MIN/MAX Functions](#468-vector-floating-point-minmax-functions):
...
```
### [Vector Floating-Point Sign-Injection Functions](#469-vector-floating-point-sign-injection-functions):
...
```
### [Vector Floating-Point Compare Functions](#4610-vector-floating-point-compare-functions):
...
```
### [Vector Floating-Point Classify Functions](#4611-vector-floating-point-classify-functions):
...
```
### [Vector Floating-Point Merge Functions](#4612-vector-floating-point-merge-functions):
...
```
### [Vector Floating-Point Move Functions](#4613-vector-floating-point-move-functions):
...
```
### [Single-Width Floating-Point/Integer Type-Convert Functions](#4614-single-width-floating-pointinteger-type-convert-functions):
...
```
### [Widening Floating-Point/Integer Type-Convert Functions](#4615-widening-floating-pointinteger-type-convert-functions):
...
```
### [Narrowing Floating-Point/Integer Type-Convert Functions](#4616-narrowing-floating-pointinteger-type-convert-functions):
...
### [Vector Single-Width Integer Reduction Functions](#471-vector-single-width-integer-reduction-functions):
...
```
### [Vector Single-Width Floating-Point Reduction Functions](#473-vector-single-width-floating-point-reduction-functions):
...
```
### [Vector Widening Floating-Point Reduction Functions](#474-vector-widening-floating-point-reduction-functions):
...
### [Vector Mask-Register Logical Functions](#481-vector-mask-register-logical-functions):
...
```
### [Vector mask population count Functions](#482-vector-mask-population-count-functions):
...
```
### [Find-first-set mask bit Functions](#483-find-first-set-mask-bit-functions):
...
```
### [Set-before-first mask bit Functions](#484-set-before-first-mask-bit-functions):
...
```
### [Set-including-first mask bit Functions](#485-set-including-first-mask-bit-functions):
...
```
### [Set-only-first mask bit Functions](#486-set-only-first-mask-bit-functions):
...
```
### [Vector Iota Functions](#487-vector-iota-functions):
...
```
### [Vector Element Index Functions](#488-vector-element-index-functions):
...
### [Integer and Floating-Point Scalar Move Functions](#491-integer-and-floating-point-scalar-move-functions):
...
```
### [Vector Slideup and Slidedown Functions](#494-vector-slide1up-and-slide1down-functions):
...
```
### [Vector Slide1up and Slide1down Functions](#494-vector-slide1up-and-slide1down-functions):
...
```
### [Vector Register Gather Functions](#496-vector-register-gather-functions):
...
```
### [Vector Compress Functions](#497-vector-compress-functions):
...
### [Reinterpret Cast Conversion Functions](#411-reinterpret-cast-conversion-functions):
