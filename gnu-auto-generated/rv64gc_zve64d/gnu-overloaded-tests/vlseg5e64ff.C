...
vfloat64m1x5_t test_vlseg5e64ff_v_f64m1x5_m(vbool64_t mask, const float64_t *base, size_t *new_vl, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vlseg5e64ff\.[ivxfswum.]+\s+} 3 } } */
