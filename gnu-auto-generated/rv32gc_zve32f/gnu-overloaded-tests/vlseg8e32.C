...
vfloat32m1x8_t test_vlseg8e32_v_f32m1x8_m(vbool32_t mask, const float32_t *base, size_t vl) {
...
/* { dg-final { scan-assembler-times {vseti?vli\s+[a-z0-9]+,\s*[a-z0-9]+,\s*e[0-9]+,\s*mf?[1248],\s*t[au],\s*m[au]\s+vlseg8e32\.[ivxfswum.]+\s+} 3 } } */
