...
vfloat64m1x2_t test_vlsseg2e64_v_f64m1x2(const float64_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m1x2(base, bstride, vl);
}

vfloat64m2x2_t test_vlsseg2e64_v_f64m2x2(const float64_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m2x2(base, bstride, vl);
}

vfloat64m4x2_t test_vlsseg2e64_v_f64m4x2(const float64_t *base, ptrdiff_t bstride, size_t vl) {
...
vfloat64m1x2_t test_vlsseg2e64_v_f64m1x2_m(vbool64_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m1x2_m(mask, base, bstride, vl);
}

vfloat64m2x2_t test_vlsseg2e64_v_f64m2x2_m(vbool32_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg2e64_v_f64m2x2_m(mask, base, bstride, vl);
}

vfloat64m4x2_t test_vlsseg2e64_v_f64m4x2_m(vbool16_t mask, const float64_t *base, ptrdiff_t bstride, size_t vl) {
