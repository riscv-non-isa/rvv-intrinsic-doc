...
vfloat16mf4x7_t test_vlsseg7e16_v_f16mf4x7(const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf4x7(base, bstride, vl);
}

vfloat16mf2x7_t test_vlsseg7e16_v_f16mf2x7(const float16_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg7e16_v_f16mf2x7(base, bstride, vl);
}

vfloat16m1x7_t test_vlsseg7e16_v_f16m1x7(const float16_t *base, ptrdiff_t bstride, size_t vl) {
