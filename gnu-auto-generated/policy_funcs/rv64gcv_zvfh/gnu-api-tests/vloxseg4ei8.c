...
vfloat16mf4x4_t test_vloxseg4ei8_v_f16mf4x4(const float16_t *base, vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16mf4x4(base, bindex, vl);
}

vfloat16mf2x4_t test_vloxseg4ei8_v_f16mf2x4(const float16_t *base, vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16mf2x4(base, bindex, vl);
}

vfloat16m1x4_t test_vloxseg4ei8_v_f16m1x4(const float16_t *base, vuint8mf2_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16m1x4(base, bindex, vl);
}

vfloat16m2x4_t test_vloxseg4ei8_v_f16m2x4(const float16_t *base, vuint8m1_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16m2x4(base, bindex, vl);
}

vfloat32mf2x4_t test_vloxseg4ei8_v_f32mf2x4(const float32_t *base, vuint8mf8_t bindex, size_t vl) {
...
vfloat64m1x4_t test_vloxseg4ei8_v_f64m1x4(const float64_t *base, vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f64m1x4(base, bindex, vl);
}

vfloat64m2x4_t test_vloxseg4ei8_v_f64m2x4(const float64_t *base, vuint8mf4_t bindex, size_t vl) {
...
vfloat16mf4x4_t test_vloxseg4ei8_v_f16mf4x4_m(vbool64_t mask, const float16_t *base, vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16mf4x4_m(mask, base, bindex, vl);
}

vfloat16mf2x4_t test_vloxseg4ei8_v_f16mf2x4_m(vbool32_t mask, const float16_t *base, vuint8mf4_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16mf2x4_m(mask, base, bindex, vl);
}

vfloat16m1x4_t test_vloxseg4ei8_v_f16m1x4_m(vbool16_t mask, const float16_t *base, vuint8mf2_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16m1x4_m(mask, base, bindex, vl);
}

vfloat16m2x4_t test_vloxseg4ei8_v_f16m2x4_m(vbool8_t mask, const float16_t *base, vuint8m1_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f16m2x4_m(mask, base, bindex, vl);
}

vfloat32mf2x4_t test_vloxseg4ei8_v_f32mf2x4_m(vbool64_t mask, const float32_t *base, vuint8mf8_t bindex, size_t vl) {
...
vfloat64m1x4_t test_vloxseg4ei8_v_f64m1x4_m(vbool64_t mask, const float64_t *base, vuint8mf8_t bindex, size_t vl) {
  return __riscv_vloxseg4ei8_v_f64m1x4_m(mask, base, bindex, vl);
}

vfloat64m2x4_t test_vloxseg4ei8_v_f64m2x4_m(vbool32_t mask, const float64_t *base, vuint8mf4_t bindex, size_t vl) {
