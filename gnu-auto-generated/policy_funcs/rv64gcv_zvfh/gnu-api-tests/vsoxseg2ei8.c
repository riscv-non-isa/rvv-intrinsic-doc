...
void test_vsoxseg2ei8_v_f16mf4x2(float16_t *base, vuint8mf8_t bindex, vfloat16mf4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16mf4x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16mf2x2(float16_t *base, vuint8mf4_t bindex, vfloat16mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16mf2x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m1x2(float16_t *base, vuint8mf2_t bindex, vfloat16m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m1x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m2x2(float16_t *base, vuint8m1_t bindex, vfloat16m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m2x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m4x2(float16_t *base, vuint8m2_t bindex, vfloat16m4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m4x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32mf2x2(float32_t *base, vuint8mf8_t bindex, vfloat32mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32mf2x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m1x2(float32_t *base, vuint8mf4_t bindex, vfloat32m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m1x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m2x2(float32_t *base, vuint8mf2_t bindex, vfloat32m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m2x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m4x2(float32_t *base, vuint8m1_t bindex, vfloat32m4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m4x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m1x2(float64_t *base, vuint8mf8_t bindex, vfloat64m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f64m1x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m2x2(float64_t *base, vuint8mf4_t bindex, vfloat64m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f64m2x2(base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m4x2(float64_t *base, vuint8mf2_t bindex, vfloat64m4x2_t v_tuple, size_t vl) {
...
void test_vsoxseg2ei8_v_f16mf4x2_m(vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16mf4x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16mf2x2_m(vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16mf2x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m1x2_m(vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m1x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m2x2_m(vbool8_t mask, float16_t *base, vuint8m1_t bindex, vfloat16m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m2x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f16m4x2_m(vbool4_t mask, float16_t *base, vuint8m2_t bindex, vfloat16m4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f16m4x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32mf2x2_m(vbool64_t mask, float32_t *base, vuint8mf8_t bindex, vfloat32mf2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32mf2x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m1x2_m(vbool32_t mask, float32_t *base, vuint8mf4_t bindex, vfloat32m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m1x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m2x2_m(vbool16_t mask, float32_t *base, vuint8mf2_t bindex, vfloat32m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m2x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f32m4x2_m(vbool8_t mask, float32_t *base, vuint8m1_t bindex, vfloat32m4x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f32m4x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m1x2_m(vbool64_t mask, float64_t *base, vuint8mf8_t bindex, vfloat64m1x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f64m1x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m2x2_m(vbool32_t mask, float64_t *base, vuint8mf4_t bindex, vfloat64m2x2_t v_tuple, size_t vl) {
  return __riscv_vsoxseg2ei8_v_f64m2x2_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg2ei8_v_f64m4x2_m(vbool16_t mask, float64_t *base, vuint8mf2_t bindex, vfloat64m4x2_t v_tuple, size_t vl) {
