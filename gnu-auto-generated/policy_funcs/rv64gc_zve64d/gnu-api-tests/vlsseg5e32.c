...
vfloat32mf2x5_t test_vlsseg5e32_v_f32mf2x5(const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg5e32_v_f32mf2x5(base, bstride, vl);
}

vfloat32m1x5_t test_vlsseg5e32_v_f32m1x5(const float32_t *base, ptrdiff_t bstride, size_t vl) {
...
vfloat32mf2x5_t test_vlsseg5e32_v_f32mf2x5_m(vbool64_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg5e32_v_f32mf2x5_m(mask, base, bstride, vl);
}

vfloat32m1x5_t test_vlsseg5e32_v_f32m1x5_m(vbool32_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
