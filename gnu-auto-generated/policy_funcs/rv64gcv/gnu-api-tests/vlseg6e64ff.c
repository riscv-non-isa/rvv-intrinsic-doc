...
vfloat64m1x6_t test_vlseg6e64ff_v_f64m1x6(const float64_t *base, size_t *new_vl, size_t vl) {
...
vfloat64m1x6_t test_vlseg6e64ff_v_f64m1x6_m(vbool64_t mask, const float64_t *base, size_t *new_vl, size_t vl) {
