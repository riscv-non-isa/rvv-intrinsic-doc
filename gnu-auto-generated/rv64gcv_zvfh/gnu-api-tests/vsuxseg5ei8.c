...
void test_vsuxseg5ei8_v_f16mf4x5(float16_t *base, vuint8mf8_t bindex, vfloat16mf4x5_t v_tuple, size_t vl) {
  return __riscv_vsuxseg5ei8_v_f16mf4x5(base, bindex, v_tuple, vl);
}

void test_vsuxseg5ei8_v_f16mf2x5(float16_t *base, vuint8mf4_t bindex, vfloat16mf2x5_t v_tuple, size_t vl) {
  return __riscv_vsuxseg5ei8_v_f16mf2x5(base, bindex, v_tuple, vl);
}

void test_vsuxseg5ei8_v_f16m1x5(float16_t *base, vuint8mf2_t bindex, vfloat16m1x5_t v_tuple, size_t vl) {
...
void test_vsuxseg5ei8_v_f16mf4x5_m(vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4x5_t v_tuple, size_t vl) {
  return __riscv_vsuxseg5ei8_v_f16mf4x5_m(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg5ei8_v_f16mf2x5_m(vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2x5_t v_tuple, size_t vl) {
  return __riscv_vsuxseg5ei8_v_f16mf2x5_m(mask, base, bindex, v_tuple, vl);
}

void test_vsuxseg5ei8_v_f16m1x5_m(vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1x5_t v_tuple, size_t vl) {
