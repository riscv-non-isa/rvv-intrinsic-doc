...
void test_vsoxseg7ei8_v_f16mf4x7(float16_t *base, vuint8mf8_t bindex, vfloat16mf4x7_t v_tuple, size_t vl) {
  return __riscv_vsoxseg7ei8_v_f16mf4x7(base, bindex, v_tuple, vl);
}

void test_vsoxseg7ei8_v_f16mf2x7(float16_t *base, vuint8mf4_t bindex, vfloat16mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsoxseg7ei8_v_f16mf2x7(base, bindex, v_tuple, vl);
}

void test_vsoxseg7ei8_v_f16m1x7(float16_t *base, vuint8mf2_t bindex, vfloat16m1x7_t v_tuple, size_t vl) {
...
void test_vsoxseg7ei8_v_f64m1x7(float64_t *base, vuint8mf8_t bindex, vfloat64m1x7_t v_tuple, size_t vl) {
...
void test_vsoxseg7ei8_v_f16mf4x7_m(vbool64_t mask, float16_t *base, vuint8mf8_t bindex, vfloat16mf4x7_t v_tuple, size_t vl) {
  return __riscv_vsoxseg7ei8_v_f16mf4x7_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg7ei8_v_f16mf2x7_m(vbool32_t mask, float16_t *base, vuint8mf4_t bindex, vfloat16mf2x7_t v_tuple, size_t vl) {
  return __riscv_vsoxseg7ei8_v_f16mf2x7_m(mask, base, bindex, v_tuple, vl);
}

void test_vsoxseg7ei8_v_f16m1x7_m(vbool16_t mask, float16_t *base, vuint8mf2_t bindex, vfloat16m1x7_t v_tuple, size_t vl) {
...
void test_vsoxseg7ei8_v_f64m1x7_m(vbool64_t mask, float64_t *base, vuint8mf8_t bindex, vfloat64m1x7_t v_tuple, size_t vl) {
