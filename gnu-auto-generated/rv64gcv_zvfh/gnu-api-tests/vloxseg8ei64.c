...
vfloat16mf4x8_t test_vloxseg8ei64_v_f16mf4x8(const float16_t *base, vuint64m1_t bindex, size_t vl) {
  return __riscv_vloxseg8ei64_v_f16mf4x8(base, bindex, vl);
}

vfloat16mf2x8_t test_vloxseg8ei64_v_f16mf2x8(const float16_t *base, vuint64m2_t bindex, size_t vl) {
  return __riscv_vloxseg8ei64_v_f16mf2x8(base, bindex, vl);
}

vfloat16m1x8_t test_vloxseg8ei64_v_f16m1x8(const float16_t *base, vuint64m4_t bindex, size_t vl) {
...
vfloat16mf4x8_t test_vloxseg8ei64_v_f16mf4x8_m(vbool64_t mask, const float16_t *base, vuint64m1_t bindex, size_t vl) {
  return __riscv_vloxseg8ei64_v_f16mf4x8_m(mask, base, bindex, vl);
}

vfloat16mf2x8_t test_vloxseg8ei64_v_f16mf2x8_m(vbool32_t mask, const float16_t *base, vuint64m2_t bindex, size_t vl) {
  return __riscv_vloxseg8ei64_v_f16mf2x8_m(mask, base, bindex, vl);
}

vfloat16m1x8_t test_vloxseg8ei64_v_f16m1x8_m(vbool16_t mask, const float16_t *base, vuint64m4_t bindex, size_t vl) {
