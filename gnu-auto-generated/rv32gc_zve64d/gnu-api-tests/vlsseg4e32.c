...
vfloat32mf2x4_t test_vlsseg4e32_v_f32mf2x4(const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e32_v_f32mf2x4(base, bstride, vl);
}

vfloat32m1x4_t test_vlsseg4e32_v_f32m1x4(const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return __riscv_vlsseg4e32_v_f32m1x4(base, bstride, vl);
}

vfloat32m2x4_t test_vlsseg4e32_v_f32m2x4(const float32_t *base, ptrdiff_t bstride, size_t vl) {
