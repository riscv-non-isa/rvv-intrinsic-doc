...
vfloat16mf4_t test_vluxei64_v_f16mf4_m(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint64m1_t bindex, size_t vl) {
  return vluxei64_v_f16mf4_m(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vluxei64_v_f16mf2_m(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint64m2_t bindex, size_t vl) {
  return vluxei64_v_f16mf2_m(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vluxei64_v_f16m1_m(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint64m4_t bindex, size_t vl) {
  return vluxei64_v_f16m1_m(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vluxei64_v_f16m2_m(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint64m8_t bindex, size_t vl) {
  return vluxei64_v_f16m2_m(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vluxei64_v_f32mf2_m(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint64m1_t bindex, size_t vl) {
  return vluxei64_v_f32mf2_m(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vluxei64_v_f32m1_m(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint64m2_t bindex, size_t vl) {
  return vluxei64_v_f32m1_m(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vluxei64_v_f32m2_m(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint64m4_t bindex, size_t vl) {
  return vluxei64_v_f32m2_m(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vluxei64_v_f32m4_m(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint64m8_t bindex, size_t vl) {
  return vluxei64_v_f32m4_m(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vluxei64_v_f64m1_m(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint64m1_t bindex, size_t vl) {
  return vluxei64_v_f64m1_m(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vluxei64_v_f64m2_m(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint64m2_t bindex, size_t vl) {
  return vluxei64_v_f64m2_m(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vluxei64_v_f64m4_m(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint64m4_t bindex, size_t vl) {
  return vluxei64_v_f64m4_m(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vluxei64_v_f64m8_m(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint64m8_t bindex, size_t vl) {
