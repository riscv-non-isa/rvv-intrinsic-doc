...
void test_vlseg2e64_v_f64m1_ta(vfloat64m1_t *v0, vfloat64m1_t *v1, const float64_t *base, size_t vl) {
  return vlseg2e64_v_f64m1_ta(v0, v1, base, vl);
}

void test_vlseg2e64_v_f64m2_ta(vfloat64m2_t *v0, vfloat64m2_t *v1, const float64_t *base, size_t vl) {
  return vlseg2e64_v_f64m2_ta(v0, v1, base, vl);
}

void test_vlseg2e64_v_f64m4_ta(vfloat64m4_t *v0, vfloat64m4_t *v1, const float64_t *base, size_t vl) {
...
void test_vlseg2e64_v_f64m1_tama(vfloat64m1_t *v0, vfloat64m1_t *v1, vbool64_t mask, const float64_t *base, size_t vl) {
  return vlseg2e64_v_f64m1_tama(v0, v1, mask, base, vl);
}

void test_vlseg2e64_v_f64m2_tama(vfloat64m2_t *v0, vfloat64m2_t *v1, vbool32_t mask, const float64_t *base, size_t vl) {
  return vlseg2e64_v_f64m2_tama(v0, v1, mask, base, vl);
}

void test_vlseg2e64_v_f64m4_tama(vfloat64m4_t *v0, vfloat64m4_t *v1, vbool16_t mask, const float64_t *base, size_t vl) {
