...
vfloat16mf4_t test_vle16ff_v_f16mf4_ta(const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16mf4_ta(base, new_vl, vl);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_ta(const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16mf2_ta(base, new_vl, vl);
}

vfloat16m1_t test_vle16ff_v_f16m1_ta(const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m1_ta(base, new_vl, vl);
}

vfloat16m2_t test_vle16ff_v_f16m2_ta(const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m2_ta(base, new_vl, vl);
}

vfloat16m4_t test_vle16ff_v_f16m4_ta(const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m4_ta(base, new_vl, vl);
}

vfloat16m8_t test_vle16ff_v_f16m8_ta(const float16_t *base, size_t *new_vl, size_t vl) {
...
vfloat16mf4_t test_vle16ff_v_f16mf4_tama(vbool64_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16mf4_tama(mask, base, new_vl, vl);
}

vfloat16mf2_t test_vle16ff_v_f16mf2_tama(vbool32_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16mf2_tama(mask, base, new_vl, vl);
}

vfloat16m1_t test_vle16ff_v_f16m1_tama(vbool16_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m1_tama(mask, base, new_vl, vl);
}

vfloat16m2_t test_vle16ff_v_f16m2_tama(vbool8_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m2_tama(mask, base, new_vl, vl);
}

vfloat16m4_t test_vle16ff_v_f16m4_tama(vbool4_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vle16ff_v_f16m4_tama(mask, base, new_vl, vl);
}

vfloat16m8_t test_vle16ff_v_f16m8_tama(vbool2_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
