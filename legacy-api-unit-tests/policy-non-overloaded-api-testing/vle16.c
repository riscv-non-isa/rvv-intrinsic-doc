...
vfloat16mf4_t test_vle16_v_f16mf4_tu(vfloat16mf4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_tu(maskedoff, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_tu(vfloat16mf2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_tu(maskedoff, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_tu(vfloat16m1_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m1_tu(maskedoff, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_tu(vfloat16m2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m2_tu(maskedoff, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_tu(vfloat16m4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m4_tu(maskedoff, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_tu(vfloat16m8_t maskedoff, const float16_t *base, size_t vl) {
...
vfloat16mf4_t test_vle16_v_f16mf4_ta(const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_ta(base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_ta(const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_ta(base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_ta(const float16_t *base, size_t vl) {
  return vle16_v_f16m1_ta(base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_ta(const float16_t *base, size_t vl) {
  return vle16_v_f16m2_ta(base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_ta(const float16_t *base, size_t vl) {
  return vle16_v_f16m4_ta(base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_ta(const float16_t *base, size_t vl) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tuma(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_tuma(mask, maskedoff, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_tuma(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_tuma(mask, maskedoff, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_tuma(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m1_tuma(mask, maskedoff, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_tuma(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m2_tuma(mask, maskedoff, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_tuma(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m4_tuma(mask, maskedoff, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_tuma(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tumu(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_tumu(mask, maskedoff, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_tumu(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_tumu(mask, maskedoff, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_tumu(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m1_tumu(mask, maskedoff, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_tumu(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m2_tumu(mask, maskedoff, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_tumu(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m4_tumu(mask, maskedoff, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_tumu(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tama(vbool64_t mask, const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_tama(mask, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_tama(vbool32_t mask, const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_tama(mask, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_tama(vbool16_t mask, const float16_t *base, size_t vl) {
  return vle16_v_f16m1_tama(mask, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_tama(vbool8_t mask, const float16_t *base, size_t vl) {
  return vle16_v_f16m2_tama(mask, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_tama(vbool4_t mask, const float16_t *base, size_t vl) {
  return vle16_v_f16m4_tama(mask, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_tama(vbool2_t mask, const float16_t *base, size_t vl) {
...
vfloat16mf4_t test_vle16_v_f16mf4_tamu(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf4_tamu(mask, maskedoff, base, vl);
}

vfloat16mf2_t test_vle16_v_f16mf2_tamu(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16mf2_tamu(mask, maskedoff, base, vl);
}

vfloat16m1_t test_vle16_v_f16m1_tamu(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m1_tamu(mask, maskedoff, base, vl);
}

vfloat16m2_t test_vle16_v_f16m2_tamu(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m2_tamu(mask, maskedoff, base, vl);
}

vfloat16m4_t test_vle16_v_f16m4_tamu(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, size_t vl) {
  return vle16_v_f16m4_tamu(mask, maskedoff, base, vl);
}

vfloat16m8_t test_vle16_v_f16m8_tamu(vbool2_t mask, vfloat16m8_t maskedoff, const float16_t *base, size_t vl) {
