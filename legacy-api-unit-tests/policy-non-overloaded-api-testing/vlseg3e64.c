...
void test_vlseg3e64_v_f64m1_ta(vfloat64m1_t *v0, vfloat64m1_t *v1, vfloat64m1_t *v2, const float64_t *base, size_t vl) {
  return vlseg3e64_v_f64m1_ta(v0, v1, v2, base, vl);
}

void test_vlseg3e64_v_f64m2_ta(vfloat64m2_t *v0, vfloat64m2_t *v1, vfloat64m2_t *v2, const float64_t *base, size_t vl) {
...
void test_vlseg3e64_v_f64m1_tama(vfloat64m1_t *v0, vfloat64m1_t *v1, vfloat64m1_t *v2, vbool64_t mask, const float64_t *base, size_t vl) {
  return vlseg3e64_v_f64m1_tama(v0, v1, v2, mask, base, vl);
}

void test_vlseg3e64_v_f64m2_tama(vfloat64m2_t *v0, vfloat64m2_t *v1, vfloat64m2_t *v2, vbool32_t mask, const float64_t *base, size_t vl) {
