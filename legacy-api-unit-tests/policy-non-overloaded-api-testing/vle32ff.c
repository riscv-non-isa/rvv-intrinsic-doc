...
vfloat32mf2_t test_vle32ff_v_f32mf2_tu(vfloat32mf2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_tu(maskedoff, base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_tu(vfloat32m1_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_tu(maskedoff, base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_tu(vfloat32m2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_tu(maskedoff, base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_tu(vfloat32m4_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_tu(maskedoff, base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_tu(vfloat32m8_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_ta(const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_ta(base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_ta(const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_ta(base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_ta(const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_ta(base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_ta(const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_ta(base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_ta(const float32_t *base, size_t *new_vl, size_t vl) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_tuma(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_tuma(mask, maskedoff, base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_tuma(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_tuma(mask, maskedoff, base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_tuma(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_tuma(mask, maskedoff, base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_tuma(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_tuma(mask, maskedoff, base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_tuma(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_tumu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_tumu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_tumu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_tumu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_tumu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_tumu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_tumu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_tumu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_tumu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_tama(vbool64_t mask, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_tama(mask, base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_tama(vbool32_t mask, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_tama(mask, base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_tama(vbool16_t mask, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_tama(mask, base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_tama(vbool8_t mask, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_tama(mask, base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_tama(vbool4_t mask, const float32_t *base, size_t *new_vl, size_t vl) {
...
vfloat32mf2_t test_vle32ff_v_f32mf2_tamu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32mf2_tamu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m1_t test_vle32ff_v_f32m1_tamu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m1_tamu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m2_t test_vle32ff_v_f32m2_tamu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m2_tamu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m4_t test_vle32ff_v_f32m4_tamu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
  return vle32ff_v_f32m4_tamu(mask, maskedoff, base, new_vl, vl);
}

vfloat32m8_t test_vle32ff_v_f32m8_tamu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, size_t *new_vl, size_t vl) {
