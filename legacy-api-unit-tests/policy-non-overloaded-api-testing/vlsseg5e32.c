...
void test_vlsseg5e32_v_f32mf2_ta(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vfloat32mf2_t *v2, vfloat32mf2_t *v3, vfloat32mf2_t *v4, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg5e32_v_f32mf2_ta(v0, v1, v2, v3, v4, base, bstride, vl);
}

void test_vlsseg5e32_v_f32m1_ta(vfloat32m1_t *v0, vfloat32m1_t *v1, vfloat32m1_t *v2, vfloat32m1_t *v3, vfloat32m1_t *v4, const float32_t *base, ptrdiff_t bstride, size_t vl) {
...
void test_vlsseg5e32_v_f32mf2_tama(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vfloat32mf2_t *v2, vfloat32mf2_t *v3, vfloat32mf2_t *v4, vbool64_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg5e32_v_f32mf2_tama(v0, v1, v2, v3, v4, mask, base, bstride, vl);
}

void test_vlsseg5e32_v_f32m1_tama(vfloat32m1_t *v0, vfloat32m1_t *v1, vfloat32m1_t *v2, vfloat32m1_t *v3, vfloat32m1_t *v4, vbool32_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
