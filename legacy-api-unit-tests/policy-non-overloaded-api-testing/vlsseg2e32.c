...
void test_vlsseg2e32_v_f32mf2_ta(vfloat32mf2_t *v0, vfloat32mf2_t *v1, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32mf2_ta(v0, v1, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m1_ta(vfloat32m1_t *v0, vfloat32m1_t *v1, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32m1_ta(v0, v1, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m2_ta(vfloat32m2_t *v0, vfloat32m2_t *v1, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32m2_ta(v0, v1, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m4_ta(vfloat32m4_t *v0, vfloat32m4_t *v1, const float32_t *base, ptrdiff_t bstride, size_t vl) {
...
void test_vlsseg2e32_v_f32mf2_tama(vfloat32mf2_t *v0, vfloat32mf2_t *v1, vbool64_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32mf2_tama(v0, v1, mask, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m1_tama(vfloat32m1_t *v0, vfloat32m1_t *v1, vbool32_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32m1_tama(v0, v1, mask, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m2_tama(vfloat32m2_t *v0, vfloat32m2_t *v1, vbool16_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
  return vlsseg2e32_v_f32m2_tama(v0, v1, mask, base, bstride, vl);
}

void test_vlsseg2e32_v_f32m4_tama(vfloat32m4_t *v0, vfloat32m4_t *v1, vbool8_t mask, const float32_t *base, ptrdiff_t bstride, size_t vl) {
