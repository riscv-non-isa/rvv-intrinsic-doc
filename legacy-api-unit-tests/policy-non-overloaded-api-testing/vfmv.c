...
vfloat16mf4_t test_vfmv_v_f_f16mf4_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16mf4_ta(src, vl);
}

vfloat16mf2_t test_vfmv_v_f_f16mf2_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16mf2_ta(src, vl);
}

vfloat16m1_t test_vfmv_v_f_f16m1_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16m1_ta(src, vl);
}

vfloat16m2_t test_vfmv_v_f_f16m2_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16m2_ta(src, vl);
}

vfloat16m4_t test_vfmv_v_f_f16m4_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16m4_ta(src, vl);
}

vfloat16m8_t test_vfmv_v_f_f16m8_ta(float16_t src, size_t vl) {
  return vfmv_v_f_f16m8_ta(src, vl);
}

vfloat32mf2_t test_vfmv_v_f_f32mf2_ta(float32_t src, size_t vl) {
  return vfmv_v_f_f32mf2_ta(src, vl);
}

vfloat32m1_t test_vfmv_v_f_f32m1_ta(float32_t src, size_t vl) {
  return vfmv_v_f_f32m1_ta(src, vl);
}

vfloat32m2_t test_vfmv_v_f_f32m2_ta(float32_t src, size_t vl) {
  return vfmv_v_f_f32m2_ta(src, vl);
}

vfloat32m4_t test_vfmv_v_f_f32m4_ta(float32_t src, size_t vl) {
  return vfmv_v_f_f32m4_ta(src, vl);
}

vfloat32m8_t test_vfmv_v_f_f32m8_ta(float32_t src, size_t vl) {
  return vfmv_v_f_f32m8_ta(src, vl);
}

vfloat64m1_t test_vfmv_v_f_f64m1_ta(float64_t src, size_t vl) {
  return vfmv_v_f_f64m1_ta(src, vl);
}

vfloat64m2_t test_vfmv_v_f_f64m2_ta(float64_t src, size_t vl) {
  return vfmv_v_f_f64m2_ta(src, vl);
}

vfloat64m4_t test_vfmv_v_f_f64m4_ta(float64_t src, size_t vl) {
  return vfmv_v_f_f64m4_ta(src, vl);
}

vfloat64m8_t test_vfmv_v_f_f64m8_ta(float64_t src, size_t vl) {
...
vfloat16mf4_t test_vfmv_s_f_f16mf4_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16mf4_ta(src, vl);
}

vfloat16mf2_t test_vfmv_s_f_f16mf2_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16mf2_ta(src, vl);
}

vfloat16m1_t test_vfmv_s_f_f16m1_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16m1_ta(src, vl);
}

vfloat16m2_t test_vfmv_s_f_f16m2_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16m2_ta(src, vl);
}

vfloat16m4_t test_vfmv_s_f_f16m4_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16m4_ta(src, vl);
}

vfloat16m8_t test_vfmv_s_f_f16m8_ta(float16_t src, size_t vl) {
  return vfmv_s_f_f16m8_ta(src, vl);
}

vfloat32mf2_t test_vfmv_s_f_f32mf2_ta(float32_t src, size_t vl) {
  return vfmv_s_f_f32mf2_ta(src, vl);
}

vfloat32m1_t test_vfmv_s_f_f32m1_ta(float32_t src, size_t vl) {
  return vfmv_s_f_f32m1_ta(src, vl);
}

vfloat32m2_t test_vfmv_s_f_f32m2_ta(float32_t src, size_t vl) {
  return vfmv_s_f_f32m2_ta(src, vl);
}

vfloat32m4_t test_vfmv_s_f_f32m4_ta(float32_t src, size_t vl) {
  return vfmv_s_f_f32m4_ta(src, vl);
}

vfloat32m8_t test_vfmv_s_f_f32m8_ta(float32_t src, size_t vl) {
  return vfmv_s_f_f32m8_ta(src, vl);
}

vfloat64m1_t test_vfmv_s_f_f64m1_ta(float64_t src, size_t vl) {
  return vfmv_s_f_f64m1_ta(src, vl);
}

vfloat64m2_t test_vfmv_s_f_f64m2_ta(float64_t src, size_t vl) {
  return vfmv_s_f_f64m2_ta(src, vl);
}

vfloat64m4_t test_vfmv_s_f_f64m4_ta(float64_t src, size_t vl) {
  return vfmv_s_f_f64m4_ta(src, vl);
}

vfloat64m8_t test_vfmv_s_f_f64m8_ta(float64_t src, size_t vl) {
