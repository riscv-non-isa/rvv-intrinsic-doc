...
void test_vlseg3e16ff_v_f16mf4_ta(vfloat16mf4_t *v0, vfloat16mf4_t *v1, vfloat16mf4_t *v2, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16mf4_ta(v0, v1, v2, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16mf2_ta(vfloat16mf2_t *v0, vfloat16mf2_t *v1, vfloat16mf2_t *v2, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16mf2_ta(v0, v1, v2, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16m1_ta(vfloat16m1_t *v0, vfloat16m1_t *v1, vfloat16m1_t *v2, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16m1_ta(v0, v1, v2, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16m2_ta(vfloat16m2_t *v0, vfloat16m2_t *v1, vfloat16m2_t *v2, const float16_t *base, size_t *new_vl, size_t vl) {
...
void test_vlseg3e16ff_v_f16mf4_tama(vfloat16mf4_t *v0, vfloat16mf4_t *v1, vfloat16mf4_t *v2, vbool64_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16mf4_tama(v0, v1, v2, mask, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16mf2_tama(vfloat16mf2_t *v0, vfloat16mf2_t *v1, vfloat16mf2_t *v2, vbool32_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16mf2_tama(v0, v1, v2, mask, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16m1_tama(vfloat16m1_t *v0, vfloat16m1_t *v1, vfloat16m1_t *v2, vbool16_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
  return vlseg3e16ff_v_f16m1_tama(v0, v1, v2, mask, base, new_vl, vl);
}

void test_vlseg3e16ff_v_f16m2_tama(vfloat16m2_t *v0, vfloat16m2_t *v1, vfloat16m2_t *v2, vbool8_t mask, const float16_t *base, size_t *new_vl, size_t vl) {
