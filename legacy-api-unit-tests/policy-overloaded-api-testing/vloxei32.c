...
vfloat16mf4_t test_vloxei32_v_f16mf4_tu(vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tu(vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tu(vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tu(vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tu(vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tu(vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tu(vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tu(vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tu(vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tu(vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tu(vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tu(vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tu(vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tu(vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tu(maskedoff, base, bindex, vl);
}
...
vfloat16mf4_t test_vloxei32_v_f16mf4_ta(const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_ta(const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_ta(const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_ta(const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_ta(const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_ta(const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_ta(const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_ta(const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_ta(const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_ta(const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_ta(const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_ta(const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_ta(const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_ta(const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_ta(base, bindex, vl);
}
...
vfloat16mf4_t test_vloxei32_v_f16mf4_tuma(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tuma(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tuma(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tuma(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tuma(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tuma(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tuma(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tuma(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tuma(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tuma(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tuma(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tuma(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tuma(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tuma(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tuma(mask, maskedoff, base, bindex, vl);
}
...
vfloat16mf4_t test_vloxei32_v_f16mf4_tumu(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tumu(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tumu(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tumu(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tumu(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tumu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tumu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tumu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tumu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tumu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tumu(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tumu(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tumu(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tumu(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tumu(mask, maskedoff, base, bindex, vl);
}
...
vfloat16mf4_t test_vloxei32_v_f16mf4_tama(vbool64_t mask, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tama(vbool32_t mask, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tama(vbool16_t mask, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tama(vbool8_t mask, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tama(vbool4_t mask, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tama(vbool64_t mask, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tama(vbool32_t mask, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tama(vbool16_t mask, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tama(vbool8_t mask, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tama(vbool4_t mask, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tama(vbool64_t mask, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tama(vbool32_t mask, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tama(vbool16_t mask, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tama(vbool8_t mask, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tama(mask, base, bindex, vl);
}
...
vfloat16mf4_t test_vloxei32_v_f16mf4_tamu(vbool64_t mask, vfloat16mf4_t maskedoff, const float16_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat16mf2_t test_vloxei32_v_f16mf2_tamu(vbool32_t mask, vfloat16mf2_t maskedoff, const float16_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat16m1_t test_vloxei32_v_f16m1_tamu(vbool16_t mask, vfloat16m1_t maskedoff, const float16_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat16m2_t test_vloxei32_v_f16m2_tamu(vbool8_t mask, vfloat16m2_t maskedoff, const float16_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat16m4_t test_vloxei32_v_f16m4_tamu(vbool4_t mask, vfloat16m4_t maskedoff, const float16_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat32mf2_t test_vloxei32_v_f32mf2_tamu(vbool64_t mask, vfloat32mf2_t maskedoff, const float32_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat32m1_t test_vloxei32_v_f32m1_tamu(vbool32_t mask, vfloat32m1_t maskedoff, const float32_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat32m2_t test_vloxei32_v_f32m2_tamu(vbool16_t mask, vfloat32m2_t maskedoff, const float32_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat32m4_t test_vloxei32_v_f32m4_tamu(vbool8_t mask, vfloat32m4_t maskedoff, const float32_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat32m8_t test_vloxei32_v_f32m8_tamu(vbool4_t mask, vfloat32m8_t maskedoff, const float32_t *base, vuint32m8_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat64m1_t test_vloxei32_v_f64m1_tamu(vbool64_t mask, vfloat64m1_t maskedoff, const float64_t *base, vuint32mf2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat64m2_t test_vloxei32_v_f64m2_tamu(vbool32_t mask, vfloat64m2_t maskedoff, const float64_t *base, vuint32m1_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat64m4_t test_vloxei32_v_f64m4_tamu(vbool16_t mask, vfloat64m4_t maskedoff, const float64_t *base, vuint32m2_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}

vfloat64m8_t test_vloxei32_v_f64m8_tamu(vbool8_t mask, vfloat64m8_t maskedoff, const float64_t *base, vuint32m4_t bindex, size_t vl) {
  return vloxei32_tamu(mask, maskedoff, base, bindex, vl);
}
