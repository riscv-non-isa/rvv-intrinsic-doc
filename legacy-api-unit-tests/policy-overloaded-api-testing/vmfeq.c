...
vbool64_t test_vmfeq_vf_f16mf4_b64_ma(vbool64_t mask, vfloat16mf4_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool32_t test_vmfeq_vf_f16mf2_b32_ma(vbool32_t mask, vfloat16mf2_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool16_t test_vmfeq_vf_f16m1_b16_ma(vbool16_t mask, vfloat16m1_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool8_t test_vmfeq_vf_f16m2_b8_ma(vbool8_t mask, vfloat16m2_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool4_t test_vmfeq_vf_f16m4_b4_ma(vbool4_t mask, vfloat16m4_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool2_t test_vmfeq_vf_f16m8_b2_ma(vbool2_t mask, vfloat16m8_t op1, float16_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool64_t test_vmfeq_vf_f32mf2_b64_ma(vbool64_t mask, vfloat32mf2_t op1, float32_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool32_t test_vmfeq_vf_f32m1_b32_ma(vbool32_t mask, vfloat32m1_t op1, float32_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool16_t test_vmfeq_vf_f32m2_b16_ma(vbool16_t mask, vfloat32m2_t op1, float32_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool8_t test_vmfeq_vf_f32m4_b8_ma(vbool8_t mask, vfloat32m4_t op1, float32_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool4_t test_vmfeq_vf_f32m8_b4_ma(vbool4_t mask, vfloat32m8_t op1, float32_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool64_t test_vmfeq_vf_f64m1_b64_ma(vbool64_t mask, vfloat64m1_t op1, float64_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool32_t test_vmfeq_vf_f64m2_b32_ma(vbool32_t mask, vfloat64m2_t op1, float64_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool16_t test_vmfeq_vf_f64m4_b16_ma(vbool16_t mask, vfloat64m4_t op1, float64_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
...
vbool8_t test_vmfeq_vf_f64m8_b8_ma(vbool8_t mask, vfloat64m8_t op1, float64_t op2, size_t vl) {
  return vmfeq_ma(mask, op1, op2, vl);
}
